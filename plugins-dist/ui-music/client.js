// ui-music — client 半：注册「音乐」插件面板并注入 bundle
//
...
//
// 与 ui-voice 同样走通用 ui.registerPanel（不动壳、纯加法，卸载插件即消失）。
(ui) => {
  const GLOBAL = 'MusicPanel'
  const JS = 'plugins-assets/ui-music/assets/music-panel.js'
  const CSS = 'plugins-assets/ui-music/assets/music-panel.css'
