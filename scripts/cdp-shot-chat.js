...
;(async () => {
  ...
  if (mode === 'open') {
    await ev(`(async () => { const t = document.querySelectorAll('.chat-input-area .sp-trigger')[0]; if (t) t.click(); await new Promise(r => setTimeout(r, 600)); return !!document.querySelector('.sp-sheet') })()`)
  }
