...
`], ...formatTraceEntry(entry));
  ...
  **/
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(plugins.value, (p2) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", {
                  ...
                  p2.hasClient ? (openBlock(), createElementBlock("span", _hoisted_47$1, "UI")) : createCommentVNode("", true),
  ...
  const _hoisted_47 = { class: "tp-sheet-actions" };
          ...
          createBaseVNode("section", _hoisted_41, [
            ...
            createBaseVNode("div", _hoisted_44, [
              (openBlock(), createElementBlock(Fragment, null, renderList(SEG_ORDER, (k) => {
                ...
                }, toDisplayString(SEG_LABELS[k]) + " " + toDisplayString(fmt(parts.value[k])), 9, _hoisted_45);
              }), 64))
            ]),
            ctxMax.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_46, "剩余 " + toDisplayString(fmt(remainTokens.value)) + "（" + toDisplayString(remainPct.value) + "%）", 1)) : createCommentVNode("", true)
          ]),
  ...
  const StatsRail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1d2b3161"]]);
  const _hoisted_1 = {
    key: 0,
  ...
  const ShellApp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-19660edb"]]);
