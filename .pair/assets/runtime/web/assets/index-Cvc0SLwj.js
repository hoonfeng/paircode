(function() {
  ...
  __vite_style__.textContent = "\n@keyframes stopPulse-4492abde {\n0%, 100% { opacity: 0.6;\n}\n50% { opacity: 1;\n}\n}\n@keyframes stopRingPulse-4492abde {\n0%, 100% { opacity: 0.3; transform: scale(1);\n}\n50% { opacity: 0.15; transform: scale(1.15);\n}\n}\n.stop-pulse[data-v-4492abde] {\n  animation: stopPulse-4492abde 1.2s ease-in-out infinite;\n}\n.stop-pulse-ring[data-v-4492abde] {\n  animation: stopRingPulse-4492abde 1.2s ease-in-out infinite;\n  fill: none;\n  transform-origin: center;\n}\n.svg-icon[data-v-4492abde] {\n  display: inline-block;\n  vertical-align: middle;\n  flex-shrink: 0;\n}\n\n.plugin-panel[data-v-08bc13a6] {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  font-size: 13px;\n}\n.pp-header[data-v-08bc13a6] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 8px 10px;\n  border-bottom: 1px solid var(--border-color);\n  flex-shrink: 0;\n}\n.pp-title[data-v-08bc13a6] {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-weight: 600;\n  font-size: 12px;\n  color: var(--text-primary);\n}\n.pp-actions[data-v-08bc13a6] { display: flex; gap: 4px;\n}\n.pp-icon-btn[data-v-08bc13a6] {\n  background: none; border: none; cursor: pointer;\n  color: var(--text-muted); padding: 2px 4px; border-radius: 3px;\n  display: flex; align-items: center;\n}\n.pp-icon-btn[data-v-08bc13a6]:hover { background: var(--bg-hover); color: var(--text-primary);\n}\n\n/* 新建表单 */\n.pp-new[data-v-08bc13a6] {\n  padding: 10px;\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  background: var(--bg-tertiary);\n  flex-shrink: 0;\n  max-height: 45%;\n  overflow: auto;\n}\n.pp-new-title[data-v-08bc13a6] { font-size: 12px; font-weight: 600; color: var(--text-secondary);\n}\n.pp-input[data-v-08bc13a6], .pp-textarea[data-v-08bc13a6] {\n  background: var(--bg-primary);\n  border: 1px solid var(--border-color);\n  color: var(--text-primary);\n  border-radius: 4px;\n  padding: 5px 8px;\n  font-size: 12px;\n  width: 100%;\n  box-sizing: border-box;\n}\n.pp-textarea.code[data-v-08bc13a6] {\n  font-family: var(--font-code);\n  font-size: 11px;\n  line-height: 1.5;\n  resize: vertical;\n}\n.pp-new-foot[data-v-08bc13a6] { display: flex; align-items: center; gap: 8px;\n}\n.pp-lang[data-v-08bc13a6] { width: auto; flex-shrink: 0;\n}\n.pp-check[data-v-08bc13a6] { display: flex; align-items: center; gap: 4px; font-size: 11px; color: var(--text-secondary); white-space: nowrap;\n}\n.pp-new-msg[data-v-08bc13a6] { font-size: 11px; color: var(--accent-light); word-break: break-all;\n}\n.pp-new-msg.err[data-v-08bc13a6] { color: var(--error);\n}\n\n/* client 面板区 */\n.pp-client[data-v-08bc13a6] {\n  border-bottom: 1px solid var(--border-color);\n  flex-shrink: 0;\n  display: flex;\n  flex-direction: column;\n  max-height: 40%;\n}\n/* UI 槽位区（Slot 系统） */\n.pp-slots[data-v-08bc13a6] {\n  border-bottom: 1px solid var(--border-color);\n  flex-shrink: 0;\n  padding: 6px 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 5px;\n  max-height: 30%;\n  overflow-y: auto;\n}\n.pp-slots-head[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 6px;\n  font-size: 11px; color: var(--text-primary); font-weight: 600;\n}\n.pp-slots-head svg[data-v-08bc13a6] { color: var(--accent);\n}\n.pp-slots-sub[data-v-08bc13a6] { font-weight: 400; font-size: 10px; color: var(--text-muted);\n}\n.pp-slot-row[data-v-08bc13a6] {\n  display: flex; align-items: center; justify-content: space-between; gap: 8px;\n  background: var(--bg-primary);\n  border: 1px solid var(--border-color);\n  border-left: 2px solid var(--accent);\n  border-radius: 6px; padding: 5px 8px;\n  transition: border-color .12s, background .12s;\n}\n.pp-slot-row[data-v-08bc13a6]:hover {\n  border-color: color-mix(in srgb, var(--accent) 45%, var(--border-color));\n  background: var(--bg-hover);\n}\n.pp-slot-info[data-v-08bc13a6] { display: flex; flex-direction: column; gap: 2px; min-width: 0;\n}\n.pp-slot-title-row[data-v-08bc13a6] { display: flex; align-items: center; gap: 6px; min-width: 0;\n}\n.pp-slot-id[data-v-08bc13a6] {\n  font-family: var(--font-mono, monospace); font-size: 11px; color: var(--accent-light);\n  text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;\n}\n.pp-slot-owner[data-v-08bc13a6] { font-size: 10px; color: var(--accent); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 180px;\n}\n.pp-slot-owner.builtin[data-v-08bc13a6] { color: var(--text-muted);\n}\n.pp-slot-kind[data-v-08bc13a6] {\n  font-size: 9px; border-radius: 4px; padding: 0 5px; align-self: flex-start;\n  line-height: 15px; flex-shrink: 0; font-weight: 600; letter-spacing: .3px;\n}\n.pp-slot-kind.kind-single[data-v-08bc13a6] { color: var(--accent-light); background: color-mix(in srgb, var(--accent) 14%, transparent); border: 1px solid color-mix(in srgb, var(--accent) 35%, transparent);\n}\n.pp-slot-kind.kind-list[data-v-08bc13a6] { color: var(--color-cat-green); background: var(--color-cat-green-bg); border: 1px solid var(--color-cat-green-bg);\n}\n.pp-slot-list[data-v-08bc13a6] { display: flex; flex-direction: column; gap: 3px; align-items: flex-end; flex-shrink: 0;\n}\n.pp-slot-list-item[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 4px; font-size: 10px; color: var(--text-secondary);\n  cursor: pointer; max-width: 220px; padding: 1px 4px; border-radius: 4px;\n  transition: background .1s, color .1s;\n}\n.pp-slot-list-item[data-v-08bc13a6]:hover { color: var(--text-primary); background: var(--bg-hover);\n}\n.pp-slot-list-item input[type='checkbox'][data-v-08bc13a6] { accent-color: var(--accent); margin: 0;\n}\n.pp-slot-list-item span[data-v-08bc13a6] { overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n.pp-slot-empty[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted);\n}\n.pp-slot-select[data-v-08bc13a6] {\n  width: 170px; font-size: 11px; padding: 3px 6px;\n  background: var(--bg-secondary); color: var(--text-primary);\n  border: 1px solid var(--border-color); border-radius: 5px; flex-shrink: 0;\n  cursor: pointer; transition: border-color .12s, box-shadow .12s;\n}\n.pp-slot-select[data-v-08bc13a6]:hover { border-color: var(--accent);\n}\n.pp-slot-select[data-v-08bc13a6]:focus { outline: none; border-color: var(--accent); box-shadow: 0 0 0 2px var(--focus-ring);\n}\n.pp-client-tabs[data-v-08bc13a6] {\n  display: flex;\n  gap: 2px;\n  padding: 4px 8px 0;\n  border-bottom: 1px solid var(--border-color);\n  overflow-x: auto;\n}\n.pp-client-tab[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 4px;\n  padding: 4px 10px;\n  font-size: 11px;\n  color: var(--text-secondary);\n  cursor: pointer;\n  border: 1px solid transparent;\n  border-bottom: none;\n  border-radius: 4px 4px 0 0;\n  white-space: nowrap;\n}\n.pp-client-tab.active[data-v-08bc13a6] {\n  background: var(--bg-primary);\n  color: var(--text-primary);\n  border-color: var(--border-color);\n}\n.pp-client-tab-title[data-v-08bc13a6] { max-width: 120px; overflow: hidden; text-overflow: ellipsis;\n}\n.pp-client-body[data-v-08bc13a6] {\n  min-height: 80px;\n  max-height: 200px;\n  overflow: auto;\n  padding: 6px 8px;\n  font-size: 12px;\n}\n\n/* 列表 */\n.pp-list[data-v-08bc13a6] { flex: 1; overflow: auto; padding: 4px 0;\n}\n.pp-loading[data-v-08bc13a6], .pp-empty[data-v-08bc13a6] {\n  display: flex; flex-direction: column; align-items: center; gap: 6px;\n  padding: 24px 12px; color: var(--text-muted); font-size: 12px;\n}\n.pp-empty-sub[data-v-08bc13a6] { font-size: 11px; color: var(--text-muted); text-align: center;\n}\n.pp-item[data-v-08bc13a6] { border-bottom: 1px solid var(--border-color);\n}\n.pp-item-row[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 6px;\n  padding: 7px 10px;\n  cursor: pointer;\n}\n.pp-item-row[data-v-08bc13a6]:hover { background: var(--bg-hover);\n}\n.pp-state[data-v-08bc13a6] {\n  width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0;\n}\n.pp-state.on[data-v-08bc13a6] { background: var(--color-success); box-shadow: 0 0 4px var(--color-success);\n}\n.pp-state.off[data-v-08bc13a6] { background: var(--text-muted); opacity: .4;\n}\n.pp-name[data-v-08bc13a6] {\n  flex: 1; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n.pp-src[data-v-08bc13a6] {\n  font-size: 9px; padding: 1px 5px; border-radius: 3px;\n  font-family: var(--font-code); text-transform: uppercase;\n}\n.pp-src.js[data-v-08bc13a6] { background: var(--color-cat-amber-bg); color: var(--color-cat-amber);\n}\n.pp-src.go[data-v-08bc13a6] { background: var(--color-cat-blue-bg); color: var(--color-cat-blue);\n}\n/* ★ Node 桥插件（npm 包，真实 node 进程装载）：与 goja 插件区分来源 */\n.pp-src.node-bridge[data-v-08bc13a6] { background: var(--color-cat-teal-bg); color: var(--color-cat-teal);\n}\n.pp-badge[data-v-08bc13a6] {\n  font-size: 9px; padding: 1px 5px; border-radius: 3px;\n  background: var(--color-cat-purple-bg); color: var(--color-cat-purple);\n  flex-shrink: 0;\n}\n.pp-badge-warn[data-v-08bc13a6] {\n  background: var(--color-warning-bg); color: var(--color-warning);\n  cursor: help;\n}\n.pp-count[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted); flex-shrink: 0;\n}\n.pp-ui-label[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted); flex-shrink: 0;\n}\n.pp-ui-label.on[data-v-08bc13a6] { color: var(--accent);\n}\n.pp-chevron[data-v-08bc13a6] { transition: transform .15s; flex-shrink: 0;\n}\n.pp-chevron.open[data-v-08bc13a6] { transform: rotate(90deg);\n}\n.pp-detail[data-v-08bc13a6] { padding: 4px 10px 10px 24px; background: var(--bg-tertiary);\n}\n.pp-d-purpose[data-v-08bc13a6] { font-size: 12px; color: var(--text-secondary); margin-bottom: 4px;\n}\n.pp-d-line[data-v-08bc13a6] { font-size: 11px; color: var(--text-muted); margin: 2px 0; word-break: break-all;\n}\n.pp-d-error[data-v-08bc13a6] { color: var(--color-danger);\n}\n.pp-d-hint[data-v-08bc13a6] { font-size: 11px; color: var(--text-muted);\n}\n/* ★ 同名工具并存（repo 移植版 ↔ npm 桥插件）：标注生效方并提供切换 */\n.pp-d-conflict[data-v-08bc13a6] {\n  margin: 6px 0;\n  padding: 5px 6px;\n  border: 1px solid var(--color-warning-bg);\n  border-radius: 4px;\n  background: var(--color-warning-bg);\n}\n.pp-d-conflict-title[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 5px;\n  font-size: 10px; color: var(--color-warning); margin-bottom: 4px;\n}\n.pp-d-conflict-row[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 6px;\n  padding: 2px 0;\n}\n.pp-d-conflict-row .pp-d-tname[data-v-08bc13a6] { flex: 1; min-width: 60px;\n}\n.pp-d-side[data-v-08bc13a6] {\n  font-size: 10px; padding: 1px 5px; border-radius: 3px;\n  border: 1px solid var(--border-color);\n  color: var(--text-muted); white-space: nowrap;\n}\n.pp-d-side.on[data-v-08bc13a6] {\n  border-color: var(--color-success);\n  background: var(--color-success-bg);\n  color: var(--color-success);\n}\n/* 生效方切换结果提示（插件列表上方） */\n.pp-prefer-msg[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 5px;\n  margin: 4px 10px; padding: 4px 6px;\n  font-size: 11px; border-radius: 4px;\n  color: var(--color-success); background: var(--color-success-bg);\n  border: 1px solid var(--color-success-bg);\n}\n.pp-prefer-msg.err[data-v-08bc13a6] {\n  color: var(--color-danger); background: var(--color-danger-bg);\n  border-color: var(--color-danger-bg);\n}\n.pp-d-tools[data-v-08bc13a6] { display: flex; flex-direction: column; gap: 1px; margin: 4px 0; padding: 4px 6px; border: 1px solid var(--border-color); border-radius: 4px; background: var(--bg-primary);\n}\n.pp-d-tools-title[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted); margin-bottom: 2px;\n}\n.pp-d-tool[data-v-08bc13a6] { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 1px 2px; border-radius: 3px;\n}\n.pp-d-tool[data-v-08bc13a6]:hover { background: var(--bg-secondary);\n}\n.pp-d-tname[data-v-08bc13a6] { font-family: var(--font-code); font-size: 11px; color: var(--text-primary); overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n.pp-d-code[data-v-08bc13a6] {\n  margin-top: 6px;\n  border: 1px solid var(--border-color);\n  border-radius: 4px;\n  overflow: hidden;\n}\n.pp-d-code-head[data-v-08bc13a6] {\n  display: flex; align-items: center; justify-content: space-between;\n  padding: 3px 8px;\n  background: var(--bg-primary);\n  font-size: 10px; color: var(--text-secondary);\n  border-bottom: 1px solid var(--border-color);\n}\n.pp-d-code pre[data-v-08bc13a6] {\n  margin: 0; padding: 6px 8px;\n  font-family: var(--font-code); font-size: 10px;\n  line-height: 1.5;\n  color: var(--text-secondary);\n  overflow: auto;\n  max-height: 160px;\n  white-space: pre-wrap;\n  word-break: break-all;\n}\n.pp-d-actions[data-v-08bc13a6] { display: flex; gap: 6px; margin-top: 8px;\n}\n.pp-btn[data-v-08bc13a6] {\n  background: var(--bg-primary);\n  border: 1px solid var(--border-color);\n  color: var(--text-secondary);\n  border-radius: 4px;\n  padding: 3px 10px;\n  font-size: 11px;\n  cursor: pointer;\n}\n.pp-btn[data-v-08bc13a6]:hover { background: var(--bg-hover); color: var(--text-primary);\n}\n.pp-btn.primary[data-v-08bc13a6] { border-color: var(--accent); color: var(--accent-light);\n}\n.pp-btn.danger[data-v-08bc13a6] { border-color: var(--color-danger); color: var(--color-danger);\n}\n.pp-btn[data-v-08bc13a6]:disabled { opacity: .5; cursor: not-allowed;\n}\n.spinner[data-v-08bc13a6] { animation: pp-spin-08bc13a6 1s linear infinite;\n}\n@keyframes pp-spin-08bc13a6 {\nto { transform: rotate(360deg);\n}\n}\n.pp-builtin[data-v-08bc13a6] {\n  display: flex; flex-direction: column; gap: 6px;\n  margin: 4px 6px 10px; padding: 8px 10px;\n  border: 1px solid var(--color-cat-amber-bg); border-radius: 8px;\n  background: var(--color-cat-amber-bg);\n}\n.pp-builtin-head[data-v-08bc13a6] { display: flex; align-items: center; gap: 8px;\n}\n.pp-builtin-head[data-v-08bc13a6]:hover { background: var(--color-cat-amber-bg);\n}\n.pp-builtin-title[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 5px;\n  font-size: 12px; font-weight: 700; color: var(--color-cat-amber); letter-spacing: .3px;\n}\n.pp-builtin-sub[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted); flex: 1;\n}\n.pp-builtin-group[data-v-08bc13a6] {\n  display: flex; flex-direction: column; gap: 4px;\n  border: 1px solid var(--border-color); border-radius: 6px;\n  background: var(--bg-tertiary); padding: 6px 8px;\n}\n.pp-builtin-grow[data-v-08bc13a6] {\n  display: flex; align-items: center; gap: 6px; flex-wrap: wrap;\n}\n.pp-builtin-gname[data-v-08bc13a6] { font-size: 12px; font-weight: 600; color: var(--text-primary);\n}\n.pp-builtin-gdesc[data-v-08bc13a6] { font-size: 10px; color: var(--text-muted); flex: 1; min-width: 80px;\n}\n.pp-builtin-gcount[data-v-08bc13a6] { font-size: 10px; color: var(--text-secondary);\n}\n.pp-builtin-tools[data-v-08bc13a6] {\n  display: flex; flex-direction: column; gap: 2px;\n  max-height: 220px; overflow-y: auto;\n}\n.pp-btn.mini[data-v-08bc13a6] { padding: 2px 8px; font-size: 10px; border-radius: 4px;\n}\n\n.tp-panel[data-v-d09e78dd] {\r\n  display: flex;\r\n  flex-direction: column;\r\n  height: 100%;\r\n  min-height: 0;\r\n  padding: 8px;\r\n  gap: 8px;\n}\r\n\r\n/* ── 头部 ── */\n.tp-header[data-v-d09e78dd] {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  padding: 2px 2px 6px;\r\n  border-bottom: 1px solid var(--border-color);\n}\n.tp-title[data-v-d09e78dd] {\r\n  display: inline-flex;\r\n  align-items: center;\r\n  gap: 6px;\r\n  font-size: 13px;\r\n  font-weight: 600;\r\n  color: var(--text-primary);\n}\n.tp-actions[data-v-d09e78dd] { display: inline-flex; gap: 4px;\n}\n.tp-icon-btn[data-v-d09e78dd] {\r\n  width: 26px; height: 26px;\r\n  display: inline-flex; align-items: center; justify-content: center;\r\n  background: none; border: none; border-radius: 6px;\r\n  color: var(--text-muted);\r\n  cursor: pointer;\n}\n.tp-icon-btn[data-v-d09e78dd]:hover { color: var(--text-primary); background: var(--bg-hover);\n}\r\n\r\n/* ── 主体（左栏列表 + 右栏详情） ── */\n.tp-body[data-v-d09e78dd] {\r\n  flex: 1;\r\n  min-height: 0;\r\n  display: flex;\r\n  gap: 8px;\n}\r\n\r\n/* ── 列表（左栏） ── */\n.tp-list[data-v-d09e78dd] {\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 4px;\r\n  width: 200px;\r\n  flex-shrink: 0;\r\n  overflow-y: auto;\r\n  padding-right: 6px;\r\n  border-right: 1px solid var(--border-color);\n}\n.tp-item[data-v-d09e78dd] {\r\n  padding: 6px 8px;\r\n  border-radius: 8px;\r\n  border: 1px solid transparent;\r\n  cursor: pointer;\r\n  transition: background 0.12s, border-color 0.12s;\n}\n.tp-item[data-v-d09e78dd]:hover { background: var(--bg-hover);\n}\n.tp-item.active[data-v-d09e78dd] {\r\n  background: var(--bg-tertiary);\r\n  border-color: var(--accent);\r\n  box-shadow: inset 2px 0 0 var(--accent);\n}\n.tp-item-main[data-v-d09e78dd] { display: flex; align-items: center; gap: 6px;\n}\n.tp-item-name[data-v-d09e78dd] { font-size: 12.5px; font-weight: 600; color: var(--text-primary);\n}\n.tp-item-count[data-v-d09e78dd] {\r\n  font-size: 10px; color: var(--text-muted);\r\n  background: var(--bg-tertiary);\r\n  padding: 1px 6px; border-radius: 999px;\n}\n.tp-item-desc[data-v-d09e78dd] {\r\n  font-size: 11px; color: var(--text-muted);\r\n  margin-top: 2px;\r\n  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\r\n\r\n/* ── 详情（右栏） ── */\n.tp-detail[data-v-d09e78dd] {\r\n  flex: 1;\r\n  min-width: 0;\r\n  min-height: 0;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 8px;\r\n  overflow: hidden;\r\n  padding-left: 4px;\n}\n.tp-dhead[data-v-d09e78dd] { padding: 0 2px;\n}\n.tp-dtitle[data-v-d09e78dd] {\r\n  display: flex; align-items: center; gap: 6px;\r\n  font-size: 13px; font-weight: 600; color: var(--text-primary);\n}\n.tp-badge[data-v-d09e78dd] {\r\n  font-size: 9.5px; padding: 1px 6px; border-radius: 999px;\r\n  background: var(--accent); color: var(--color-accent-fg); font-weight: 500;\n}\n.tp-badge.proj[data-v-d09e78dd] { background: var(--color-accent-bg); color: var(--color-accent);\n}\n.tp-dactions[data-v-d09e78dd] { display: flex; gap: 6px; margin-top: 6px;\n}\n.tp-ddesc[data-v-d09e78dd] { font-size: 11px; color: var(--text-muted); margin-top: 4px;\n}\n.tp-section-title[data-v-d09e78dd] {\r\n  font-size: 10px; color: var(--text-muted);\r\n  text-transform: uppercase; letter-spacing: 0.5px; font-weight: 500;\r\n  margin: 2px 0 4px;\n}\n.tp-plugins[data-v-d09e78dd] {\r\n  flex: 1;\r\n  min-height: 0;\r\n  overflow-y: auto;\r\n  display: flex;\r\n  flex-direction: column;\r\n  gap: 8px;\r\n  padding: 0 2px;\n}\n.tp-plugin[data-v-d09e78dd] {\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 8px;\r\n  padding: 6px 8px;\r\n  background: var(--bg-secondary);\n}\n.tp-prow[data-v-d09e78dd] { display: flex; align-items: center; justify-content: space-between; gap: 6px;\n}\n.tp-pname[data-v-d09e78dd] { font-size: 12px; font-weight: 600; color: var(--text-primary); font-family: var(--font-code, monospace);\n}\n.tp-ppurpose[data-v-d09e78dd] { font-size: 11px; color: var(--text-muted); margin-top: 2px;\n}\n.tp-tools[data-v-d09e78dd] {\r\n  display: flex; flex-wrap: wrap; gap: 4px; margin-top: 5px;\n}\n.tp-tool[data-v-d09e78dd] {\r\n  display: inline-flex; align-items: center; gap: 4px;\r\n  font-size: 11px;\r\n  color: var(--text-secondary);\r\n  background: var(--bg-tertiary);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 999px;\r\n  padding: 2px 9px;\r\n  cursor: pointer;\r\n  user-select: none;\r\n  font-family: inherit;\r\n  line-height: 1.5;\r\n  transition: border-color 0.12s, color 0.12s, opacity 0.12s;\n}\n.tp-tool[data-v-d09e78dd]:hover { border-color: var(--accent); color: var(--text-primary);\n}\n.tp-tool.off[data-v-d09e78dd] { text-decoration: line-through; opacity: 0.45; border-color: transparent;\n}\n.tp-muted[data-v-d09e78dd] { font-size: 11px; color: var(--text-muted);\n}\r\n\r\n/* ── 按钮 ── */\n.tp-btn[data-v-d09e78dd] {\r\n  display: inline-flex; align-items: center; gap: 4px;\r\n  font-size: 11.5px; font-family: inherit;\r\n  color: var(--text-primary);\r\n  background: var(--bg-tertiary);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 6px;\r\n  padding: 4px 10px;\r\n  cursor: pointer;\r\n  transition: border-color 0.15s, background 0.15s;\n}\n.tp-btn[data-v-d09e78dd]:hover { border-color: var(--accent);\n}\n.tp-btn.tiny[data-v-d09e78dd] { padding: 2px 7px; font-size: 10.5px;\n}\n.tp-btn.primary[data-v-d09e78dd] { background: var(--accent); border-color: var(--accent); color: var(--color-accent-fg);\n}\n.tp-btn.primary[data-v-d09e78dd]:disabled { opacity: 0.5; cursor: not-allowed;\n}\n.tp-btn.danger[data-v-d09e78dd] { color: var(--color-danger);\n}\n.tp-btn.danger[data-v-d09e78dd]:hover { border-color: var(--color-danger);\n}\r\n\r\n/* ── 添加插件 ── */\n.tp-add[data-v-d09e78dd] { padding: 2px; flex-shrink: 0;\n}\n.tp-add-btn[data-v-d09e78dd] {\r\n  width: 100%; justify-content: center;\r\n  border-style: dashed; color: var(--accent);\n}\n.tp-add-btn[data-v-d09e78dd]:hover { background: var(--color-accent-bg);\n}\r\n\r\n/* ── 添加插件浮层（卡片 grid） ── */\r\n/* 双 class 提高优先级，覆盖 .tp-sheet 的 480px（浮层更宽以容纳卡片墙） */\n.tp-sheet.tp-add-sheet[data-v-d09e78dd] { width: min(680px, 92vw);\n}\n.tp-add-search[data-v-d09e78dd] { position: relative; margin: 0 16px 10px;\n}\n.tp-add-search-icon[data-v-d09e78dd] {\r\n  position: absolute; left: 10px; top: 50%; transform: translateY(-50%);\r\n  color: var(--text-muted); pointer-events: none;\n}\n.tp-add-search-input[data-v-d09e78dd] { width: 100%; padding-left: 30px;\n}\n.tp-add-grid[data-v-d09e78dd] {\r\n  display: grid;\r\n  grid-template-columns: repeat(auto-fill, minmax(180px, 1fr));\r\n  gap: 8px;\r\n  padding: 4px 16px 16px;\r\n  overflow-y: auto;\r\n  max-height: 60vh;\n}\n.tp-pcard[data-v-d09e78dd] {\r\n  display: flex; flex-direction: column; gap: 5px;\r\n  text-align: left;\r\n  padding: 9px 10px;\r\n  background: var(--bg-tertiary);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 9px;\r\n  cursor: pointer;\r\n  font-family: inherit;\r\n  transition: border-color 0.13s, background 0.13s, box-shadow 0.13s;\n}\n.tp-pcard[data-v-d09e78dd]:hover {\r\n  border-color: var(--accent);\r\n  background: var(--color-accent-bg);\r\n  box-shadow: 0 0 0 3px var(--color-accent-ring);\n}\n.tp-pcard-head[data-v-d09e78dd] { display: flex; align-items: center; justify-content: space-between; gap: 6px;\n}\n.tp-pcard-name[data-v-d09e78dd] {\r\n  font-size: 12px; font-weight: 600; color: var(--text-primary);\r\n  font-family: var(--font-code, monospace);\r\n  overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n.tp-pcard-count[data-v-d09e78dd] {\r\n  font-size: 9.5px; color: var(--text-muted);\r\n  background: var(--bg-secondary);\r\n  padding: 1px 6px; border-radius: 999px; flex-shrink: 0;\n}\n.tp-pcard-desc[data-v-d09e78dd] {\r\n  font-size: 11px; color: var(--text-muted); line-height: 1.45;\r\n  display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;\r\n  min-height: 32px;\n}\n.tp-pcard-add[data-v-d09e78dd] {\r\n  display: inline-flex; align-items: center; gap: 3px;\r\n  font-size: 10.5px; color: var(--accent);\r\n  margin-top: 2px;\n}\r\n\r\n/* ── 空态 ── */\n.tp-empty[data-v-d09e78dd] {\r\n  font-size: 11.5px; color: var(--text-muted);\r\n  padding: 16px 8px; text-align: center; line-height: 1.7;\n}\n.tp-side-empty[data-v-d09e78dd] {\r\n  flex: 1;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\n}\r\n\r\n/* ── 弹层（居中 modal，桌面端更合理；2026-09-05 从 bottom-sheet 改造） ── */\n.tp-overlay[data-v-d09e78dd] {\r\n  position: fixed; inset: 0;\r\n  background: var(--color-scrim);\r\n  z-index: 10050;\r\n  display: flex; align-items: center; justify-content: center;\r\n  padding: 16px;\n}\n.tp-sheet[data-v-d09e78dd] {\r\n  width: min(480px, 94vw);\r\n  max-height: 84vh;\r\n  display: flex; flex-direction: column;\r\n  background: var(--bg-secondary);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 14px;\r\n  box-shadow: var(--shadow-lg);\r\n  animation: tp-sheet-in-d09e78dd 0.18s ease-out;\n}\n@keyframes tp-sheet-in-d09e78dd {\nfrom { transform: translateY(10px) scale(0.98); opacity: 0.6;\n}\nto { transform: translateY(0) scale(1); opacity: 1;\n}\n}\n.tp-sheet-head[data-v-d09e78dd] {\r\n  display: flex; align-items: center; justify-content: space-between;\r\n  padding: 10px 16px 8px;\n}\n.tp-sheet-title[data-v-d09e78dd] { font-size: 14px; font-weight: 600; color: var(--text-primary);\n}\n.tp-cancel[data-v-d09e78dd] { background: none; border: none; color: var(--accent); font-size: 13px; cursor: pointer; font-family: inherit;\n}\n.tp-sheet-body[data-v-d09e78dd] { padding: 4px 16px 16px; display: flex; flex-direction: column; gap: 10px; overflow-y: auto;\n}\n.tp-field[data-v-d09e78dd] { display: flex; flex-direction: column; gap: 4px;\n}\n.tp-field-label[data-v-d09e78dd] { font-size: 11px; color: var(--text-muted);\n}\n.tp-input[data-v-d09e78dd] {\r\n  font-size: 12.5px; font-family: inherit;\r\n  color: var(--text-primary);\r\n  background: var(--bg-tertiary);\r\n  border: 1px solid var(--border-color);\r\n  border-radius: 8px;\r\n  padding: 7px 10px;\r\n  outline: none;\n}\n.tp-input[data-v-d09e78dd]:focus { border-color: var(--accent);\n}\n.tp-textarea[data-v-d09e78dd] { resize: vertical; min-height: 40px;\n}\n.tp-textarea.code[data-v-d09e78dd] { font-family: var(--font-code, monospace); font-size: 11.5px;\n}\n.tp-hint[data-v-d09e78dd] { font-size: 11px; color: var(--color-warning);\n}\n.tp-sheet-actions[data-v-d09e78dd] { display: flex; justify-content: flex-end; gap: 8px; margin-top: 4px;\n}\n.tp-file-row[data-v-d09e78dd] { display: flex; align-items: center; gap: 8px;\n}\n.tp-hidden-input[data-v-d09e78dd] { display: none;\n}\n.tp-fade-enter-active[data-v-d09e78dd], .tp-fade-leave-active[data-v-d09e78dd] { transition: opacity 0.18s;\n}\n.tp-fade-enter-from[data-v-d09e78dd], .tp-fade-leave-to[data-v-d09e78dd] { opacity: 0;\n}\n.spinning[data-v-d09e78dd] { animation: tp-spin-d09e78dd 0.8s linear infinite;\n}\n@keyframes tp-spin-d09e78dd {\nfrom { transform: rotate(0deg);\n}\nto { transform: rotate(360deg);\n}\n}\r\n\n/* ═══ 设计稿 th178：col w=288, bg=color.bg, pad=space.md(12), gap=space.sm(8) ═══ */\n.stats-rail[data-v-2c44dfd0] {\n  width: 288px; height: 100%;\n  display: flex; flex-direction: column; gap: 8px;\n  padding: 12px;\n  background: var(--bg-primary);\n  border-left: 1px solid var(--border-color);\n  overflow-y: auto; overflow-x: hidden;\n  box-sizing: border-box;\n}\n/* 设计稿 th148/th164/th173：bg=surface, radius=8, border, pad=12, gap=4 */\n.sr-card[data-v-2c44dfd0] {\n  background: var(--bg-secondary);\n  border: 1px solid var(--border-color);\n  border-radius: 8px;\n  padding: 12px;\n  display: flex; flex-direction: column; gap: 4px;\n  flex: 0 0 auto;\n}\n.sr-head[data-v-2c44dfd0] { display: flex; align-items: center; justify-content: space-between; height: 24px;\n}\n/* 设计稿 th131/th151/th165：字号 sm(12) + 字重 600 + fg */\n.sr-title[data-v-2c44dfd0] { font-size: 12px; font-weight: 600; color: var(--text-primary);\n}\n/* 设计稿 th150（任务进度「4 / 7」）与 th77/th85（主区结果徽章）：\n   64×24 居中胶囊 —— radius=full、bg=surface-3(→ --bg-active)、accent 文字、等宽数字。\n   本类同时供「Token 统计」卡的「命中 NN%」使用，两处形态统一。 */\n.sr-badge[data-v-2c44dfd0] {\n  display: inline-flex; align-items: center; justify-content: center;\n  min-width: 64px; height: 24px; padding: 0 10px;\n  border-radius: 999px; background: var(--bg-active);\n  font-size: 11px; color: var(--accent); font-variant-numeric: tabular-nums;\n}\n.sr-icon-btn[data-v-2c44dfd0] {\n  border: none; background: none; color: var(--text-muted); cursor: pointer;\n  display: inline-flex; align-items: center; padding: 0; opacity: .75;\n}\n.sr-icon-btn[data-v-2c44dfd0]:hover { opacity: 1; color: var(--text-primary);\n}\n/* 设计稿 th134：accent 色摘要行 */\n.sr-summary[data-v-2c44dfd0] { font-size: 11px; color: var(--accent); line-height: 1.5;\n}\n.sr-divider[data-v-2c44dfd0] { height: 1px; background: var(--border-color); margin: 2px 0;\n}\n/* 设计稿 th138/th141/…：行高 24，左 muted 右 fg */\n.sr-row[data-v-2c44dfd0] { display: flex; align-items: center; justify-content: space-between; height: 24px; gap: 8px;\n}\n.sr-k[data-v-2c44dfd0] { font-size: 11px; color: var(--text-muted); min-width: 0;\n}\n.sr-v[data-v-2c44dfd0] { font-size: 11px; color: var(--text-primary); white-space: nowrap;\n}\n.sr-v-ok[data-v-2c44dfd0] { color: var(--success, #4FD8A4);\n}\n.sr-v-run[data-v-2c44dfd0] { color: var(--accent);\n}\n.sr-v-dim[data-v-2c44dfd0] { color: var(--text-muted);\n}\n.sr-empty[data-v-2c44dfd0] { font-size: 11px; color: var(--text-muted); padding: 4px 0;\n}\n.sr-note[data-v-2c44dfd0] { font-size: 11px; color: var(--text-muted); line-height: 1.5;\n}\n/* 上下文构成·六项明细网格：2 列 × 3 行，每项独占一格（nowrap，不跨行拆断）。\n   minmax(0,1fr) 允许列内收缩，配合 ellipsis 保证超长数值不撑破卡片。\n   列数 3→2 的原因见模板注释（3 列零余量，放不下图例色点）。 */\n.sr-legend[data-v-2c44dfd0] {\n  display: grid; grid-template-columns: repeat(2, minmax(0, 1fr));\n  gap: 2px 8px;\n  font-size: 11px; color: var(--text-muted); line-height: 1.5;\n}\n/* 明细项 = 图例色点 + 文本（flex 行）；文本承担 ellipsis，色点永不压缩、永不被裁。 */\n.sr-legend-item[data-v-2c44dfd0] { display: flex; align-items: center; gap: 5px; min-width: 0;\n}\n/* 图例色点：8px 方块（对齐分段条 h=8 / r=4 的视觉分量，小尺寸用 r=2），\n   颜色由模板 inline 注入 SEG_COLORS[k] —— 与分段条同源，杜绝两套配色漂移。 */\n.sr-legend-dot[data-v-2c44dfd0] { flex: 0 0 auto; width: 8px; height: 8px; border-radius: 2px;\n}\n.sr-legend-txt[data-v-2c44dfd0] { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;\n}\n/* 设计稿 th154/th153：h=8、圆角 4 的进度条（底 = surface-2 → --bg-hover；填充 = accent） */\n.sr-bar[data-v-2c44dfd0] { height: 8px; border-radius: 4px; background: var(--bg-hover); overflow: hidden;\n}\n.sr-bar-fill[data-v-2c44dfd0] { height: 100%; border-radius: 4px; background: var(--accent); transition: width .25s;\n}\n/* ── ★ 任务进度列表（2026-09-25 用户指令）：**完整可滚动列表** ──\n   全部任务逐条列出；行数超出时在卡内 max-height 内滚动（细滚动条），\n   任务文本换行显示完整内容 —— 不裁剪行数、不加省略号、不显示「还有 N 项…」。 */\n.sr-tasks[data-v-2c44dfd0] {\n  flex: 1 1 auto; min-height: 0;\n  max-height: 240px;\n  overflow-y: auto; overflow-x: hidden;\n  display: flex; flex-direction: column; gap: 2px;\n  scrollbar-gutter: stable;\n  /* ★ 必须显式置 auto：见下方滚动条注释（全局继承的 scrollbar-color 会废掉 webkit 伪元素） */\n  scrollbar-color: auto;\n}\n/* 细滚动条（与 GitPanel 同口径：4px + --scrollbar-thumb）。\n   ★★ 两个实测坑（否则滚动条根本不是 4px）：\n     ① index.html 全局给 html 设了 scrollbar-color，而**该属性可继承** —— 只要继承到\n        非 auto 的 scrollbar-color，Chromium 就忽略 ::-webkit-scrollbar 伪元素，\n        滚动条回退平台默认粗度（实测 17px）⇒ 必须在本元素显式 scrollbar-color: auto；\n     ② 一旦设了标准 scrollbar-width（如 thin），同样会让 ::-webkit-scrollbar 失效\n        （实测 thin = 11px）⇒ 本元素刻意不写 scrollbar-width。 */\n.sr-tasks[data-v-2c44dfd0]::-webkit-scrollbar { width: 4px;\n}\n.sr-tasks[data-v-2c44dfd0]::-webkit-scrollbar-track { background: transparent;\n}\n.sr-tasks[data-v-2c44dfd0]::-webkit-scrollbar-thumb { background: var(--scrollbar-thumb); border-radius: 2px;\n}\n.sr-tasks[data-v-2c44dfd0]::-webkit-scrollbar-thumb:hover { background: var(--scrollbar-thumb-hover);\n}\n/* 单条任务：左＝文本（换行完整显示）｜右＝状态（不换行、不被压缩） */\n.sr-task[data-v-2c44dfd0] { display: flex; align-items: flex-start; justify-content: space-between; gap: 8px; padding: 2px 0;\n}\n.sr-task-text[data-v-2c44dfd0] {\n  flex: 1 1 auto; min-width: 0;\n  font-size: 11px; line-height: 1.45; color: var(--text-muted);\n  word-break: break-word;\n}\n.sr-task-st[data-v-2c44dfd0] { flex: 0 0 auto; font-size: 11px; line-height: 1.45; white-space: nowrap;\n}\n/* 设计稿 th170：h=8, gap=4, 圆角 4 的水平分段条（非圆环） */\n.sr-segbar[data-v-2c44dfd0] { display: flex; gap: 4px; height: 8px; margin: 4px 0;\n}\n.sr-seg[data-v-2c44dfd0] { height: 8px; border-radius: 4px; min-width: 2px; transition: width .25s;\n}\n/* ── ★ Token 统计（卡 ①b）：环形缓存图 + 数字明细 ── */\n.sr-tokens[data-v-2c44dfd0] { display: flex; align-items: center; gap: 10px; padding-top: 2px;\n}\n.cache-ring-wrap[data-v-2c44dfd0] {\n  position: relative; flex: 0 0 auto;\n  width: 72px; height: 72px;\n  display: flex; align-items: center; justify-content: center;\n}\n.cache-ring[data-v-2c44dfd0] { display: block;\n}\n.cache-ring-label[data-v-2c44dfd0] {\n  position: absolute;\n  display: flex; flex-direction: column; align-items: center;\n  line-height: 1.25;\n}\n.cache-ring-pct[data-v-2c44dfd0] {\n  font-size: 14px; font-weight: 700;\n  color: var(--accent); font-family: var(--font-code);\n}\n.cache-ring-text[data-v-2c44dfd0] { font-size: 9px; color: var(--text-muted);\n}\n.sr-token-detail[data-v-2c44dfd0] { flex: 1 1 auto; min-width: 0; display: flex; flex-direction: column; gap: 2px;\n}\n.sr-token-detail .sr-row[data-v-2c44dfd0] { height: 20px;\n}\n.sr-token-total .sr-k[data-v-2c44dfd0], .sr-token-total .sr-v[data-v-2c44dfd0] { font-weight: 600; color: var(--text-primary);\n}\n.sr-filler[data-v-2c44dfd0] { flex: 1 1 auto; min-height: 0;\n}\n/* 设计稿 th177：bg=surface-2 */\n.sr-card-tip[data-v-2c44dfd0] { background: var(--bg-hover);\n}\n.sr-tip-main[data-v-2c44dfd0] { font-size: 11px; color: var(--text-primary); line-height: 1.5;\n}\n.sr-tip-sub[data-v-2c44dfd0] { font-size: 11px; color: var(--text-muted); line-height: 1.5;\n}\n\n.app-root[data-v-4ef64614] {\r\n  display: grid;\r\n  /* ★ chat 优先薄壳（替换原 4 列 IDE 网格）：conversation 为 minmax(0,1fr) 主列，\r\n     editor 为 details 辅助列（--editor-w），折叠=0px 不占空间但 DOM 保持挂载。\r\n     gridStyle computed 会覆盖此默认值（聚焦/折叠时动态调整列宽）。 */\r\n  /* ★ 2026-09-25 对齐设计稿：活动栏 48 ｜ 会话 264 ｜ 主区 1fr ｜ 右栏 288。 */\r\n  grid-template-columns: 48px var(--sidebar-w, 264px) minmax(0, 1fr) var(--rail-w, 288px);\r\n  /* ★ 2026-09-25：顶栏为整条（titlebar 跨全部列，见 UiTitlebar）；原 main-tabs 已移除。 */\r\n  /* ★ 2026-09-25 对齐设计稿：底栏 28px（th219）；顶栏 titlebar 跨全部列（整条 40px）。 */\r\n  grid-template-rows: 40px 1fr 28px;\r\n  width: 100%; height: 100%;\r\n  background: var(--bg-primary);\r\n  color: var(--text-primary);\r\n  overflow: hidden;\r\n  font-family: var(--font-ui);\n}\r\n/* ★ 桌面端面板独立模式：只渲染右侧对话面板，占满整个窗口 */\n.app-root.panel-only[data-v-4ef64614] {\r\n  grid-template-columns: 1fr;\r\n  grid-template-rows: 1fr;\n}\n.app-root.panel-only .main-area[data-v-4ef64614] {\r\n  grid-column: 1; grid-row: 1;\r\n  width: 100% !important;\r\n  height: 100%;\n}\r\n/* 整区替换槽位（single）宿主：与内置区域同 grid 位置/尺寸\r\n   ★ 2026-09-25：设计稿顶栏是【整条】(th206 w=1440)，故 titlebar 跨全部列；\r\n   main-tabs 改为浮在顶栏行右侧的导航胶囊组（见下方 justify-self:end）。 */\n.plugin-area-titlebar[data-v-4ef64614] { grid-column: 1 / -1; grid-row: 1; height: 40px;\n}\n.slot-empty.plugin-area-titlebar[data-v-4ef64614] { grid-column: 1 / -1; grid-row: 1; height: 40px;\n}\n.plugin-area-activitybar[data-v-4ef64614] { grid-column: 1; grid-row: 2; width: 48px;\n}\n.plugin-area-sidebar[data-v-4ef64614] { grid-column: 2; grid-row: 2; height: 100%; overflow: hidden;\n}\r\n/* ★ 右栏（设计稿第 4 列）：288px 常驻信息栏 */\n.right-rail-host[data-v-4ef64614] { grid-column: 4; grid-row: 2; min-width: 0; height: 100%; overflow: hidden;\n}\r\n/* ★ main 区（col 3）：对话 / 编辑器 tab 切换（chat 优先薄壳主视图） */\n.main-area[data-v-4ef64614] {\r\n  grid-column: 3; grid-row: 2;\r\n  display: flex; flex-direction: column; min-width: 0; overflow: hidden; position: relative;\n}\r\n/* tab 栏：对话 / 编辑器 */\r\n/* ★ 内容区（2026-09）：单栏（tab 互斥切换）或并排两栏（对话 + 当前视图） */\n.main-views[data-v-4ef64614] {\r\n  flex: 1; min-width: 0; min-height: 0;\r\n  display: flex; flex-direction: column; overflow: hidden; position: relative;\n}\r\n/* 并排：横排两栏；split-chat-right 用 row-reverse 把对话栏换到右侧\r\n   （对话 pane 始终是 DOM 首个子元素：换边只改方向，不动挂载顺序） */\n.main-views.split[data-v-4ef64614] { flex-direction: row;\n}\n.main-views.split.split-chat-right[data-v-4ef64614] { flex-direction: row-reverse;\n}\n.view-pane[data-v-4ef64614] {\r\n  flex: 1 1 auto; min-width: 0; min-height: 0;\r\n  display: flex; flex-direction: column; overflow: hidden; position: relative;\n}\r\n/* 并排时对话栏固定比例（当前视图栏占剩余空间） */\n.main-views.split .view-pane-chat[data-v-4ef64614] {\r\n  flex: 0 0 var(--split-chat-w, 42%);\r\n  border-right: 1px solid var(--border-color);\n}\n.main-views.split.split-chat-right .view-pane-chat[data-v-4ef64614] {\r\n  border-right: none; border-left: 1px solid var(--border-color);\n}\r\n/* 插件中间区域视图容器（registerView）：bundle 挂载点，撑满所在栏 */\n.view-pane-plugin[data-v-4ef64614] { background: var(--bg-primary);\n}\r\n/* tab 栏右侧工具区（视图列表 + 并排开关） */\r\n/* 视图列表浮层（勾选 = tab 打开；后台打开，不抢对话主视图） */\r\n/* 菜单外点关闭背板（仅菜单打开时存在，点一下就关） */\r\n/* conversation（对话）宿主：常驻挂载，v-show 切换；填满 main 区（tab 栏下方） */\n.conversation-container[data-v-4ef64614] {\r\n  flex: 1; min-width: 0; min-height: 0;\r\n  display: flex; flex-direction: row; overflow: hidden; position: relative;\n}\r\n/* editor（编辑器）宿主：常驻挂载，v-show 切换；填满 main 区（tab 栏下方），永不 unmount */\n.editor-container[data-v-4ef64614] {\r\n  flex: 1; min-width: 0; min-height: 0;\r\n  display: flex; flex-direction: column; overflow: hidden;\n}\r\n/* market（市场面板）宿主：主区第三视图，v-show 切换；bundle 动态挂载 */\n.market-container[data-v-4ef64614] {\r\n  flex: 1; min-width: 0; min-height: 0;\r\n  display: flex; flex-direction: column; overflow: hidden;\n}\r\n/* 主区 tab 内嵌关闭按钮（编辑器 / 市场）× */\r\n/* ★ 2026-09-25 对齐设计稿 th219（row h=28）。 */\n.app-statusbar-host[data-v-4ef64614] { grid-column: 1 / -1; grid-row: 3; z-index: 30; height: 28px;\n}\n.plugin-slot-host[data-v-4ef64614] { height: 100%; overflow: hidden;\n}\r\n/* ★ 插件渲染的子元素必须撑满宿主（bundle 根 auto 宽度不随宿主 grid 拉伸）。\r\n   以 <conversation> 主列为例：宿主占列 3 → 子元素撑满，避免右侧空余。 */\n.plugin-slot-host.conversation-container[data-v-4ef64614] > * { width: 100%; min-width: 0;\n}\r\n/* modals 槽位：fixed 全屏浮层容器（不占 grid 格） */\n.modals-host[data-v-4ef64614] { position: fixed; inset: 0; z-index: 200; pointer-events: none;\n}\n.modals-host[data-v-4ef64614] > * { pointer-events: auto;\n}\n.modals-empty[data-v-4ef64614] { display: none;\n}\r\n/* 空态占位（区域插件未装配时显示） */\n.slot-empty[data-v-4ef64614] {\r\n  display: flex; flex-direction: row; gap: 8px;\r\n  align-items: center; justify-content: center;\r\n  color: var(--text-muted); font-size: 12px;\r\n  background: var(--bg-primary);\r\n  border: 1px dashed var(--border-color);\r\n  min-height: 0;\n}\r\n/* activitybar 是竖条（~48px 宽）：空态改纵向排列 */\n.plugin-area-activitybar.slot-empty[data-v-4ef64614] { flex-direction: column; gap: 4px; padding: 4px;\n}\n.plugin-area-activitybar.slot-empty .escape-link[data-v-4ef64614] { font-size: 11px; padding: 2px 8px;\n}\r\n/* 空态内的「打开插件面板」恢复入口（上下文感知注入：只在区域未装配时出现，\r\n   插件全正常时零干扰；与常驻逃生按钮互为双保险） */\n.escape-link[data-v-4ef64614] {\r\n  background: none; border: 1px solid var(--border-color);\r\n  color: var(--accent); font-size: 12px;\r\n  padding: 3px 12px; border-radius: 4px; cursor: pointer;\r\n  opacity: .85; transition: opacity .15s;\n}\n.escape-link[data-v-4ef64614]:hover { opacity: 1; background: var(--color-accent-bg);\n}\r\n/* ─── 壳级逃生口：插件面板浮动入口 ───\r\n   常驻极小按钮位于左下角（状态栏上方）；半透明弱化，hover 全显。\r\n   点击打开浮动插件面板（Fixed 560px 居中）。 */\n.plugin-escape-btn[data-v-4ef64614] {\r\n  position: fixed; left: 6px; bottom: 26px; z-index: 300;\r\n  width: 22px; height: 22px; border-radius: 5px;\r\n  display: flex; align-items: center; justify-content: center;\r\n  background: var(--bg-elevated); color: var(--text-muted);\r\n  border: 1px solid var(--border-color); cursor: pointer;\r\n  opacity: .3; transition: opacity .15s;\n}\n.plugin-escape-btn[data-v-4ef64614]:hover { opacity: 1; color: var(--accent);\n}\n.plugin-escape-overlay[data-v-4ef64614] {\r\n  position: fixed; inset: 0; z-index: 400;\r\n  background: var(--color-scrim);\r\n  display: flex; align-items: center; justify-content: center;\n}\n.plugin-escape-panel[data-v-4ef64614] {\r\n  width: 560px; max-width: 92vw; height: 70vh; max-height: 640px;\r\n  background: var(--bg-primary); border: 1px solid var(--border-color);\r\n  border-radius: 10px; box-shadow: var(--shadow-lg);\r\n  display: flex; flex-direction: column; overflow: hidden;\n}\n.plugin-escape-head[data-v-4ef64614] {\r\n  display: flex; align-items: center; justify-content: space-between;\r\n  padding: 6px 10px; font-size: 12px; color: var(--text-muted);\r\n  border-bottom: 1px solid var(--border-color);\r\n  background: var(--bg-elevated);\n}\n.plugin-escape-close[data-v-4ef64614] {\r\n  border: none; background: none; color: var(--text-muted);\r\n  cursor: pointer; font-size: 13px; padding: 2px 6px; border-radius: 4px;\n}\n.plugin-escape-close[data-v-4ef64614]:hover { background: var(--bg-hover); color: var(--text-primary);\n}\n.plugin-escape-body[data-v-4ef64614] { flex: 1; overflow: auto;\n}\n.plugin-escape-body .plugin-panel[data-v-4ef64614] { height: 100%; border: none;\n}\r\n/*$vite$:1*/";
...
`], ...formatTraceEntry(entry));
  ...
  **/
  ...
  const _getInflight = /* @__PURE__ */ new Map();
  ...
  async function builtinPlugins(data, workspaceRoot) {
    ...
    return apiGet("/plugins/builtin", ws ? { workspaceRoot: ws } : void 0);
  }
  ...
  async function pluginInvoke(plugin, method, args) {
    return apiPost("/plugins/invoke", { plugin, method, args: args === void 0 ? null : args }, {}, { timeout: 0 });
  }
  ...
  function makeUI(inst) {
    const ui = {
      ...
      registerView(spec) {
        ...
        const regions = Array.isArray(spec.regions) ? [...new Set(spec.regions.filter((r) => typeof r === "string" && REGION_KEYS.includes(r)))] : [...REGION_KEYS];
        if (!regions.includes("mainTab")) {
          regions.push("mainTab");
          console.warn("[plugin] registerView：视图「" + spec.title + "」声明不含 mainTab —— 主区内容出口是渲染的必要条件，已自动补回");
        }
        const view = {
          id: spec.id,
          title: spec.title,
          ...
          open: spec.open === true,
          regions,
          // ★ 入驻区域（'titlebar' 顶栏胶囊 / 'mainTab' 主区内容出口）
          render: typeof spec.render === "function" ? spec.render : null,
          pluginName: inst.name,
          defId: inst.defId
        };
  ...
  async function syncClientHalves(plugins) {
    ...
    for (const p2 of plugins) {
      if (p2.hasClient && p2.state === "running" && p2.clientCode) {
        active.add(p2.name);
  ...
  async function loadClientHalvesFromManifest(entries) {
  ...
  const showUpdate = /* @__PURE__ */ ref(false);
  ...
  const sidebarWidth = /* @__PURE__ */ ref(264);
  ...
  const DARK_THEME_NAMES = /* @__PURE__ */ new Set([
    "midnight",
    "graphite",
    "obsidian",
    "aurora",
  ...
  const unconsumedEventWarned = /* @__PURE__ */ new Set();
  ...
  function getUnconsumedEventTypes() {
    return { ...unconsumedEventTypes };
  }
    ...
    const handlers = {
      ...
      "open-conversation": (e) => {
        ...
        if ((_a = e.detail) == null ? void 0 : _a.id) {
          state.currentConvId = e.detail.id;
        }
      }
    };
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("svg", {
          ...
          __props.name === "folder" ? (openBlock(), createElementBlock("path", _hoisted_2$4)) : __props.name === "folder-open" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            _cache[4] || (_cache[4] = createStaticVNode('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" data-v-4492abde></path><polyline points="14 2 14 8 20 8" data-v-4492abde></polyline><line x1="10" y1="12" x2="8" y2="14" data-v-4492abde></line><line x1="10" y1="16" x2="8" y2="18" data-v-4492abde></line><line x1="14" y1="12" x2="16" y2="14" data-v-4492abde></line><line x1="14" y1="16" x2="16" y2="18" data-v-4492abde></line>', 6))
          ...
          ], 64)) : __props.name === "chat" ? (openBlock(), createElementBlock("path", _hoisted_3$4)) : __props.name === "settings" ? (openBlock(), createElementBlock(Fragment, { key: 8 }, [
          ...
          ], 64)) : __props.name === "chevron-right" ? (openBlock(), createElementBlock("polyline", _hoisted_4$4)) : __props.name === "chevron-down" ? (openBlock(), createElementBlock("polyline", _hoisted_5$4)) : __props.name === "plus" ? (openBlock(), createElementBlock(Fragment, { key: 12 }, [
            ...
            _cache[35] || (_cache[35] = createStaticVNode('<circle cx="18" cy="18" r="3" data-v-4492abde></circle><circle cx="6" cy="6" r="3" data-v-4492abde></circle><path d="M13 6h3a2 2 0 0 1 2 2v7" data-v-4492abde></path><line x1="6" y1="18" x2="6" y2="9" data-v-4492abde></line><polyline points="9 9 6 6 3 9" data-v-4492abde></polyline>', 5))
          ], 64)) : __props.name === "git-push" ? (openBlock(), createElementBlock(Fragment, { key: 19 }, [
            _cache[36] || (_cache[36] = createStaticVNode('<circle cx="18" cy="6" r="3" data-v-4492abde></circle><circle cx="6" cy="18" r="3" data-v-4492abde></circle><path d="M13 18h-2a2 2 0 0 1-2-2V9" data-v-4492abde></path><line x1="6" y1="6" x2="6" y2="15" data-v-4492abde></line><polyline points="9 15 6 18 3 15" data-v-4492abde></polyline>', 5))
          ...
          ], 64)) : __props.name === "download" ? (openBlock(), createElementBlock(Fragment, { key: 26 }, [
            _cache[54] || (_cache[54] = createBaseVNode("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }, null, -1)),
            _cache[55] || (_cache[55] = createBaseVNode("polyline", { points: "7 10 12 15 17 10" }, null, -1)),
            _cache[56] || (_cache[56] = createBaseVNode("line", {
              x1: "12",
              y1: "15",
              x2: "12",
              y2: "3"
            }, null, -1))
          ], 64)) : __props.name === "cycle" ? (openBlock(), createElementBlock(Fragment, { key: 27 }, [
            _cache[57] || (_cache[57] = createBaseVNode("polyline", { points: "23 4 23 10 17 10" }, null, -1)),
            _cache[58] || (_cache[58] = createBaseVNode("polyline", { points: "1 20 1 14 7 14" }, null, -1)),
            _cache[59] || (_cache[59] = createBaseVNode("path", { d: "M3.51 9a9 9 0 0 1 14.85-3.36L23 10" }, null, -1)),
            _cache[60] || (_cache[60] = createBaseVNode("path", { d: "M20.49 15a9 9 0 0 1-14.85 3.36L1 14" }, null, -1))
          ], 64)) : __props.name === "send" ? (openBlock(), createElementBlock(Fragment, { key: 28 }, [
            _cache[61] || (_cache[61] = createBaseVNode("line", {
              x1: "12",
              y1: "19",
              x2: "12",
              y2: "5"
            }, null, -1)),
            _cache[62] || (_cache[62] = createBaseVNode("polyline", { points: "5 12 12 5 19 12" }, null, -1))
          ], 64)) : __props.name === "send-plane" ? (openBlock(), createElementBlock(Fragment, { key: 29 }, [
            _cache[63] || (_cache[63] = createBaseVNode("line", {
              x1: "22",
              y1: "2",
              x2: "11",
              y2: "13"
            }, null, -1)),
            _cache[64] || (_cache[64] = createBaseVNode("polygon", { points: "22 2 15 22 11 13 2 9 22 2" }, null, -1))
          ], 64)) : __props.name === "stop-dot" ? (openBlock(), createElementBlock(Fragment, { key: 30 }, [
            _cache[65] || (_cache[65] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "6",
              class: "stop-pulse"
            }, null, -1)),
            _cache[66] || (_cache[66] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "10",
              class: "stop-pulse-ring"
            }, null, -1))
          ], 64)) : __props.name === "wrench" ? (openBlock(), createElementBlock("path", _hoisted_6$4)) : __props.name === "database" ? (openBlock(), createElementBlock(Fragment, { key: 32 }, [
            _cache[67] || (_cache[67] = createBaseVNode("ellipse", {
              cx: "12",
              cy: "5",
              rx: "9",
              ry: "3"
            }, null, -1)),
            _cache[68] || (_cache[68] = createBaseVNode("path", { d: "M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" }, null, -1)),
            _cache[69] || (_cache[69] = createBaseVNode("path", { d: "M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" }, null, -1))
          ], 64)) : __props.name === "user" ? (openBlock(), createElementBlock(Fragment, { key: 33 }, [
            _cache[70] || (_cache[70] = createBaseVNode("path", { d: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" }, null, -1)),
            _cache[71] || (_cache[71] = createBaseVNode("circle", {
              cx: "12",
              cy: "7",
              r: "4"
            }, null, -1))
          ], 64)) : __props.name === "info" ? (openBlock(), createElementBlock(Fragment, { key: 34 }, [
            _cache[72] || (_cache[72] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "10"
            }, null, -1)),
            _cache[73] || (_cache[73] = createBaseVNode("line", {
              x1: "12",
              y1: "16",
              x2: "12",
              y2: "12"
            }, null, -1)),
            _cache[74] || (_cache[74] = createBaseVNode("line", {
              x1: "12",
              y1: "8",
              x2: "12.01",
              y2: "8"
            }, null, -1))
          ], 64)) : __props.name === "lightbulb" ? (openBlock(), createElementBlock(Fragment, { key: 35 }, [
            _cache[75] || (_cache[75] = createBaseVNode("path", { d: "M9 18h6" }, null, -1)),
            _cache[76] || (_cache[76] = createBaseVNode("path", { d: "M10 22h4" }, null, -1)),
            _cache[77] || (_cache[77] = createBaseVNode("path", { d: "M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14" }, null, -1))
          ], 64)) : __props.name === "sparkles" ? (openBlock(), createElementBlock(Fragment, { key: 36 }, [
            _cache[78] || (_cache[78] = createStaticVNode('<path d="M13.5 4L15 8l4 .5L15 12l1.5 4-4-2-4 2L10 12l-4-3.5L10 8z" data-v-4492abde></path><line x1="3" y1="18" x2="3" y2="21" data-v-4492abde></line><line x1="21" y1="18" x2="21" y2="21" data-v-4492abde></line><line x1="7" y1="20" x2="11" y2="20" data-v-4492abde></line><line x1="17" y1="20" x2="19" y2="20" data-v-4492abde></line>', 5))
          ], 64)) : __props.name === "bot" ? (openBlock(), createElementBlock(Fragment, { key: 37 }, [
            _cache[79] || (_cache[79] = createStaticVNode('<rect x="3" y="11" width="18" height="10" rx="2" data-v-4492abde></rect><circle cx="12" cy="5" r="2" data-v-4492abde></circle><path d="M12 7v4" data-v-4492abde></path><line x1="8" y1="16" x2="8" y2="16" data-v-4492abde></line><line x1="16" y1="16" x2="16" y2="16" data-v-4492abde></line>', 5))
          ], 64)) : __props.name === "file-js" ? (openBlock(), createElementBlock(Fragment, { key: 38 }, [
          ...
          ], 64)) : __props.name === "file-ts" ? (openBlock(), createElementBlock(Fragment, { key: 39 }, [
          ...
          ], 64)) : __props.name === "file-go" ? (openBlock(), createElementBlock(Fragment, { key: 40 }, [
          ...
          ], 64)) : __props.name === "file-py" ? (openBlock(), createElementBlock(Fragment, { key: 41 }, [
          ...
          ], 64)) : __props.name === "file-java" ? (openBlock(), createElementBlock(Fragment, { key: 42 }, [
          ...
          ], 64)) : __props.name === "file-html" ? (openBlock(), createElementBlock(Fragment, { key: 43 }, [
          ...
          ], 64)) : __props.name === "file-css" ? (openBlock(), createElementBlock(Fragment, { key: 44 }, [
          ...
          ], 64)) : __props.name === "file-json" ? (openBlock(), createElementBlock(Fragment, { key: 45 }, [
          ...
          ], 64)) : __props.name === "file-md" ? (openBlock(), createElementBlock(Fragment, { key: 46 }, [
          ...
          ], 64)) : __props.name === "file-vue" ? (openBlock(), createElementBlock(Fragment, { key: 47 }, [
            _cache[107] || (_cache[107] = createBaseVNode("path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" }, null, -1)),
            _cache[108] || (_cache[108] = createBaseVNode("polyline", { points: "14 2 14 8 20 8" }, null, -1)),
            _cache[109] || (_cache[109] = createBaseVNode("text", {
              x: "7",
              y: "17",
              "font-size": "9",
              fill: "currentColor",
          ...
          ], 64)) : __props.name === "copy" ? (openBlock(), createElementBlock(Fragment, { key: 48 }, [
            _cache[110] || (_cache[110] = createBaseVNode("rect", {
              x: "9",
              y: "9",
              width: "13",
              height: "13",
            ...
            _cache[111] || (_cache[111] = createBaseVNode("path", { d: "M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" }, null, -1))
          ], 64)) : __props.name === "minus" ? (openBlock(), createElementBlock("line", _hoisted_7$4)) : __props.name === "edit" ? (openBlock(), createElementBlock(Fragment, { key: 50 }, [
            _cache[112] || (_cache[112] = createBaseVNode("path", { d: "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" }, null, -1)),
            _cache[113] || (_cache[113] = createBaseVNode("path", { d: "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" }, null, -1))
          ], 64)) : __props.name === "trash" ? (openBlock(), createElementBlock(Fragment, { key: 51 }, [
            _cache[114] || (_cache[114] = createBaseVNode("polyline", { points: "3 6 5 6 21 6" }, null, -1)),
            _cache[115] || (_cache[115] = createBaseVNode("path", { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }, null, -1))
          ], 64)) : __props.name === "file-plus" ? (openBlock(), createElementBlock(Fragment, { key: 52 }, [
            _cache[116] || (_cache[116] = createBaseVNode("path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" }, null, -1)),
            _cache[117] || (_cache[117] = createBaseVNode("polyline", { points: "14 2 14 8 20 8" }, null, -1)),
          ...
          ], 64)) : __props.name === "message-square" ? (openBlock(), createElementBlock("path", _hoisted_8$4)) : __props.name === "folder-plus" ? (openBlock(), createElementBlock(Fragment, { key: 54 }, [
            _cache[120] || (_cache[120] = createBaseVNode("path", { d: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v3" }, null, -1)),
            _cache[121] || (_cache[121] = createBaseVNode("line", {
              x1: "12",
              y1: "11",
              x2: "12",
              y2: "17"
            }, null, -1)),
            _cache[122] || (_cache[122] = createBaseVNode("line", {
              x1: "9",
              y1: "14",
              x2: "15",
              y2: "14"
            }, null, -1))
          ], 64)) : __props.name === "brain" ? (openBlock(), createElementBlock(Fragment, { key: 55 }, [
            _cache[123] || (_cache[123] = createBaseVNode("path", { d: "M12 2a4 4 0 0 0-4 4v1a5 5 0 0 0-5 5v1a4 4 0 0 0 3 3.87V17a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-.13A4 4 0 0 0 21 13v-1a5 5 0 0 0-5-5V6a4 4 0 0 0-4-4z" }, null, -1)),
            _cache[124] || (_cache[124] = createBaseVNode("path", { d: "M9 12v2" }, null, -1)),
            _cache[125] || (_cache[125] = createBaseVNode("path", { d: "M15 12v2" }, null, -1)),
            _cache[126] || (_cache[126] = createBaseVNode("path", { d: "M12 9v5" }, null, -1))
          ], 64)) : __props.name === "check" ? (openBlock(), createElementBlock("polyline", _hoisted_9$4)) : __props.name === "clock" ? (openBlock(), createElementBlock(Fragment, { key: 57 }, [
            _cache[127] || (_cache[127] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "10"
            }, null, -1)),
            _cache[128] || (_cache[128] = createBaseVNode("polyline", { points: "12 6 12 12 16 14" }, null, -1))
          ], 64)) : __props.name === "help" ? (openBlock(), createElementBlock(Fragment, { key: 58 }, [
            _cache[129] || (_cache[129] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "10"
            }, null, -1)),
            _cache[130] || (_cache[130] = createBaseVNode("path", { d: "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" }, null, -1)),
            _cache[131] || (_cache[131] = createBaseVNode("line", {
              x1: "12",
              y1: "17",
              x2: "12.01",
              y2: "17"
            }, null, -1))
          ], 64)) : __props.name === "shield" ? (openBlock(), createElementBlock("path", _hoisted_10$4)) : __props.name === "shield-off" ? (openBlock(), createElementBlock(Fragment, { key: 60 }, [
            _cache[132] || (_cache[132] = createBaseVNode("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }, null, -1)),
            _cache[133] || (_cache[133] = createBaseVNode("line", {
              x1: "4",
              y1: "4",
              x2: "20",
              y2: "20",
          ...
          ], 64)) : __props.name === "code" ? (openBlock(), createElementBlock(Fragment, { key: 61 }, [
            _cache[134] || (_cache[134] = createBaseVNode("polyline", { points: "16 18 22 12 16 6" }, null, -1)),
            _cache[135] || (_cache[135] = createBaseVNode("polyline", { points: "8 6 2 12 8 18" }, null, -1))
          ], 64)) : __props.name === "list" ? (openBlock(), createElementBlock(Fragment, { key: 62 }, [
            _cache[136] || (_cache[136] = createStaticVNode('<line x1="8" y1="6" x2="21" y2="6" data-v-4492abde></line><line x1="8" y1="12" x2="21" y2="12" data-v-4492abde></line><line x1="8" y1="18" x2="21" y2="18" data-v-4492abde></line><line x1="3" y1="6" x2="3.01" y2="6" data-v-4492abde></line><line x1="3" y1="12" x2="3.01" y2="12" data-v-4492abde></line><line x1="3" y1="18" x2="3.01" y2="18" data-v-4492abde></line>', 6))
          ], 64)) : __props.name === "layers" ? (openBlock(), createElementBlock(Fragment, { key: 63 }, [
            _cache[137] || (_cache[137] = createBaseVNode("polygon", { points: "12 2 2 7 12 12 22 7 12 2" }, null, -1)),
            _cache[138] || (_cache[138] = createBaseVNode("polyline", { points: "2 17 12 22 22 17" }, null, -1)),
            _cache[139] || (_cache[139] = createBaseVNode("polyline", { points: "2 12 12 17 22 12" }, null, -1))
          ], 64)) : __props.name === "eye" ? (openBlock(), createElementBlock(Fragment, { key: 64 }, [
            _cache[140] || (_cache[140] = createBaseVNode("path", { d: "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" }, null, -1)),
            _cache[141] || (_cache[141] = createBaseVNode("circle", {
              cx: "12",
              cy: "12",
              r: "3"
            }, null, -1))
          ], 64)) : __props.name === "eye-off" ? (openBlock(), createElementBlock(Fragment, { key: 65 }, [
            _cache[142] || (_cache[142] = createBaseVNode("path", { d: "M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94" }, null, -1)),
            _cache[143] || (_cache[143] = createBaseVNode("path", { d: "M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19" }, null, -1)),
            _cache[144] || (_cache[144] = createBaseVNode("line", {
              x1: "1",
              y1: "1",
              x2: "23",
              y2: "23"
            }, null, -1))
          ], 64)) : __props.name === "bug" ? (openBlock(), createElementBlock(Fragment, { key: 66 }, [
            _cache[145] || (_cache[145] = createStaticVNode('<rect x="8" y="2" width="8" height="4" rx="1" ry="1" data-v-4492abde></rect><path d="M20 12h-3a5 5 0 0 1-5 5 5 5 0 0 1-5-5H4" data-v-4492abde></path><path d="M4 8h16" data-v-4492abde></path><path d="M12 2v7" data-v-4492abde></path><path d="M9 17l-3 4" data-v-4492abde></path><path d="M15 17l3 4" data-v-4492abde></path>', 6))
          ], 64)) : __props.name === "check-circle" ? (openBlock(), createElementBlock(Fragment, { key: 67 }, [
            _cache[146] || (_cache[146] = createBaseVNode("path", { d: "M22 11.08V12a10 10 0 1 1-5.93-9.14" }, null, -1)),
            _cache[147] || (_cache[147] = createBaseVNode("polyline", { points: "22 4 12 14.01 9 11.01" }, null, -1))
          ], 64)) : __props.name === "book-open" ? (openBlock(), createElementBlock(Fragment, { key: 68 }, [
            _cache[148] || (_cache[148] = createBaseVNode("path", { d: "M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" }, null, -1)),
            _cache[149] || (_cache[149] = createBaseVNode("path", { d: "M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" }, null, -1))
          ], 64)) : __props.name === "tool" ? (openBlock(), createElementBlock("path", _hoisted_11$4)) : __props.name === "keyboard" ? (openBlock(), createElementBlock(Fragment, { key: 70 }, [
            _cache[150] || (_cache[150] = createStaticVNode('<rect x="2" y="4" width="20" height="16" rx="2" ry="2" data-v-4492abde></rect><line x1="6" y1="8" x2="6.01" y2="8" data-v-4492abde></line><line x1="10" y1="8" x2="10.01" y2="8" data-v-4492abde></line><line x1="14" y1="8" x2="14.01" y2="8" data-v-4492abde></line><line x1="18" y1="8" x2="18.01" y2="8" data-v-4492abde></line><line x1="6" y1="12" x2="6.01" y2="12" data-v-4492abde></line><line x1="10" y1="12" x2="10.01" y2="12" data-v-4492abde></line><line x1="14" y1="12" x2="14.01" y2="12" data-v-4492abde></line><line x1="18" y1="12" x2="18.01" y2="12" data-v-4492abde></line><line x1="6" y1="16" x2="18" y2="16" data-v-4492abde></line>', 10))
          ], 64)) : __props.name === "chevron-left" ? (openBlock(), createElementBlock("polyline", _hoisted_12$4)) : __props.name === "grid" ? (openBlock(), createElementBlock(Fragment, { key: 72 }, [
            ...
            _cache[152] || (_cache[152] = createBaseVNode("rect", {
              x: "14",
              y: "3",
              width: "7",
              height: "7"
            }, null, -1)),
            _cache[153] || (_cache[153] = createBaseVNode("rect", {
              x: "14",
              y: "14",
              width: "7",
              height: "7"
            }, null, -1)),
            _cache[154] || (_cache[154] = createBaseVNode("rect", {
              x: "3",
              y: "14",
              width: "7",
              height: "7"
            }, null, -1))
          ], 64)) : __props.name === "puzzle" ? (openBlock(), createElementBlock(Fragment, { key: 73 }, [
            _cache[155] || (_cache[155] = createBaseVNode("path", { d: "M4 7h3a2 2 0 0 1 4 0h9v9h-3a2 2 0 0 0-4 0H4z" }, null, -1)),
            _cache[156] || (_cache[156] = createBaseVNode("path", { d: "M11 7v9" }, null, -1))
          ], 64)) : (openBlock(), createElementBlock(Fragment, { key: 74 }, [
            _cache[157] || (_cache[157] = createBaseVNode("path", { d: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" }, null, -1)),
            _cache[158] || (_cache[158] = createBaseVNode("polyline", { points: "14 2 14 8 20 8" }, null, -1)),
            _cache[159] || (_cache[159] = createBaseVNode("line", {
              x1: "9",
              y1: "13",
              x2: "15",
              y2: "13"
            }, null, -1)),
            _cache[160] || (_cache[160] = createBaseVNode("line", {
              x1: "9",
              y1: "17",
              x2: "15",
              y2: "17"
  ...
  const SvgIcon = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-4492abde"]]);
  const _hoisted_1$3 = { class: "plugin-panel" };
  const _hoisted_2$3 = { class: "pp-header" };
  const _hoisted_3$3 = { class: "pp-title" };
  const _hoisted_4$3 = { class: "pp-actions" };
  const _hoisted_5$3 = {
    key: 0,
    class: "pp-new"
  };
  const _hoisted_6$3 = { class: "pp-new-foot" };
  const _hoisted_7$3 = { class: "pp-check" };
  const _hoisted_8$3 = ["disabled"];
  const _hoisted_9$3 = {
    key: 1,
    class: "pp-client"
  };
  const _hoisted_10$3 = { class: "pp-client-tabs" };
  const _hoisted_11$3 = ["onClick"];
  const _hoisted_12$3 = { class: "pp-client-tab-title" };
  const _hoisted_13$3 = {
    key: 2,
    class: "pp-slots"
  };
  const _hoisted_14$3 = ["title"];
  const _hoisted_15$3 = { class: "pp-slots-title" };
  ...
  const _hoisted_25$2 = { class: "pp-list" };
  const _hoisted_26$2 = {
    key: 0,
    class: "pp-builtin"
  };
  const _hoisted_27$2 = ["title"];
  const _hoisted_28$2 = { class: "pp-builtin-title" };
  const _hoisted_29$2 = { class: "pp-builtin-grow" };
  const _hoisted_30$2 = { class: "pp-builtin-gname" };
  const _hoisted_31$2 = {
    key: 0,
    class: "pp-builtin-gdesc"
  };
  const _hoisted_32$2 = { class: "pp-builtin-gcount" };
  const _hoisted_33$2 = ["onClick"];
  const _hoisted_34$2 = ["onClick"];
  const _hoisted_35$2 = { class: "pp-builtin-tools" };
  const _hoisted_36$2 = ["title"];
  const _hoisted_37$2 = { class: "pp-d-tname" };
  const _hoisted_38$2 = ["title"];
  const _hoisted_39$2 = ["checked", "onChange"];
  const _hoisted_40$2 = {
    key: 2,
    class: "pp-loading"
  };
  ...
  const _hoisted_50$1 = ["title"];
  const _hoisted_51$1 = ["checked", "onChange"];
  const _hoisted_52$1 = {
    key: 0,
    class: "pp-detail"
  };
  ...
  const _hoisted_62 = { class: "pp-d-conflict-title" };
  const _hoisted_63 = ["title"];
  const _hoisted_64 = ["title"];
  const _hoisted_65 = ["title"];
  const _hoisted_66 = ["disabled", "title", "onClick"];
  const _hoisted_67 = {
    key: 7,
    class: "pp-d-tools"
  };
  const _hoisted_68 = { class: "pp-d-tools-title" };
  const _hoisted_69 = ["title"];
  const _hoisted_70 = ["title"];
  const _hoisted_71 = ["checked", "onChange"];
  const _hoisted_72 = {
    key: 8,
    class: "pp-d-code"
  };
  const _hoisted_73 = { class: "pp-d-code-head" };
  const _hoisted_74 = ["onClick"];
  const _hoisted_75 = { class: "pp-d-actions" };
  const _hoisted_76 = {
    key: 0,
    class: "pp-d-hint"
  };
  ...
  const _sfc_main$3 = {
    ...
    setup(__props) {
      ...
      const builtinOpen = /* @__PURE__ */ ref(false);
      ...
      const preferring = /* @__PURE__ */ reactive({});
      const preferMsg = /* @__PURE__ */ ref("");
      const preferMsgErr = /* @__PURE__ */ ref(false);
      function srcLabel(p2) {
        if (p2.source === "node-bridge") return p2.runtime === "dsh" ? "cordis4 桥" : "npm 桥";
        return p2.source || "?";
      }
      function srcTitle(p2) {
        if (p2.source === "node-bridge") {
          return p2.runtime === "dsh" ? "cordis4 轨插件：npm 包，由 Node 桥进程（cordis4 插件服务面）装载，与 repo 版功能重叠时可切换生效方" : "npm 插件：npm 包，由 Node 桥进程（cordis3）装载";
        }
        if (p2.source === "js") return "JS 插件：goja 沙箱内运行（磁盘包 .pair/plugins/ 或 cordis(op=define) 定义）";
        if (p2.source === "go") return "Go 内置插件：随程序编译，提供框架能力";
        return "插件来源：" + (p2.source || "未知");
      }
      ...
      function conflictsOf(p2) {
        return p2 && p2.conflicts || [];
      }
      function conflictTitle(p2) {
        const list = conflictsOf(p2);
      ...
      const wsToolsetMap = /* @__PURE__ */ ref(null);
      ...
      const builtinGroups = /* @__PURE__ */ ref([]);
      ...
      async function toggleBuiltinTool(t, checked) {
        try {
          ...
          window.$toast && window.$toast((res == null ? void 0 : res.message) || (checked ? "已加入通用集合" : "已移出通用集合") + " " + t.name, "info");
      ...
      async function enableBuiltinGroup(g) {
        try {
          ...
          window.$toast && window.$toast((res == null ? void 0 : res.message) || "已整组加入通用集合", "info");
          await loadBuiltinGroups();
          await loadWsToolsetMap();
        } catch (e) {
          window.$toast && window.$toast(e.message || "操作失败", "error");
      ...
      async function disableBuiltinGroup(g) {
        try {
          ...
          window.$toast && window.$toast((res == null ? void 0 : res.message) || "已整组移出通用集合", "info");
          await loadBuiltinGroups();
          await loadWsToolsetMap();
        } catch (e) {
          window.$toast && window.$toast(e.message || "操作失败", "error");
      ...
      function pluginToolOn(p2, t) {
        var _a;
        return ((_a = p2.toolCordisVisible) == null ? void 0 : _a[t]) !== false;
      }
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$3, [
          createBaseVNode("div", _hoisted_2$3, [
            createBaseVNode("span", _hoisted_3$3, [
              ...
              _cache[9] || (_cache[9] = createTextVNode(" 插件", -1))
            ]),
            createBaseVNode("div", _hoisted_4$3, [
              ...
              createBaseVNode("button", {
                class: "pp-icon-btn",
                onClick: _cache[0] || (_cache[0] = ($event) => showNew.value = !showNew.value),
                title: "新建插件"
              }, [
                createVNode(SvgIcon, {
                  name: "plus",
          ...
          showNew.value ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
            _cache[12] || (_cache[12] = createBaseVNode("div", { class: "pp-new-title" }, "新建 JS 动态插件", -1)),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => newForm.purpose = $event),
              placeholder: "用途说明（必填）",
              class: "pp-input"
            }, null, 512), [
            ...
            withDirectives(createBaseVNode("textarea", {
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => newForm.code = $event),
            ...
            withDirectives(createBaseVNode("textarea", {
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => newForm.client = $event),
            ...
            createBaseVNode("div", _hoisted_6$3, [
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => newForm.language = $event),
              ...
              createBaseVNode("label", _hoisted_7$3, [
                withDirectives(createBaseVNode("input", {
                  type: "checkbox",
                  "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => newForm.run = $event)
                }, null, 512), [
                  [vModelCheckbox, newForm.run]
                ]),
                _cache[11] || (_cache[11] = createTextVNode(" 定义后立即装载", -1))
              ]),
              createBaseVNode("button", {
                class: "pp-btn primary",
                disabled: defining.value || !newForm.purpose || !newForm.code,
                onClick: doDefine
              }, toDisplayString(defining.value ? "定义中…" : "定义"), 9, _hoisted_8$3)
            ]),
          ...
          unref(clientPanels).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_9$3, [
            createBaseVNode("div", _hoisted_10$3, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(clientPanels), (p2) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("span", _hoisted_12$3, toDisplayString(p2.title), 1)
                ], 10, _hoisted_11$3);
              }), 128))
            ]),
            createBaseVNode("div", {
          ...
          slotGroups.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_13$3, [
            createBaseVNode("div", {
              class: "pp-slots-head",
              ...
              createBaseVNode("span", _hoisted_15$3, [
                ...
                _cache[13] || (_cache[13] = createTextVNode(" UI 槽位", -1))
              ]),
              _cache[14] || (_cache[14] = createBaseVNode("span", { class: "pp-slots-sub" }, "插件可替换的界面区域", -1)),
              createVNode(SvgIcon, {
                name: "chevron-right",
                size: 11,
            ...
            slotsOpen.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(slotGroups.value, (g) => {
              return openBlock(), createElementBlock("div", {
                ...
                g.kind !== "list" ? (openBlock(), createElementBlock("select", {
                  ...
                  !g.candidates.length ? (openBlock(), createElementBlock("span", _hoisted_24$2, "（无叠加条目）")) : createCommentVNode("", true)
                ]))
              ]);
            }), 128)) : createCommentVNode("", true)
          ])) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_25$2, [
            builtinGroups.value.length ? (openBlock(), createElementBlock("div", _hoisted_26$2, [
              createBaseVNode("div", {
                class: "pp-builtin-head",
                onClick: _cache[7] || (_cache[7] = ($event) => builtinOpen.value = !builtinOpen.value),
                ...
                createBaseVNode("span", _hoisted_28$2, [
                  ...
                  _cache[15] || (_cache[15] = createTextVNode(" 内置工具（框架自带）", -1))
                ]),
                _cache[16] || (_cache[16] = createBaseVNode("span", { class: "pp-builtin-sub" }, "勾选=在通用集合 default 中（agent 可用）；取消=移出", -1)),
                createVNode(SvgIcon, {
                  name: "chevron-right",
                  size: 11,
                  class: normalizeClass(["pp-chevron", { open: builtinOpen.value }])
                }, null, 8, ["class"])
              ], 8, _hoisted_27$2),
              builtinOpen.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(builtinGroups.value, (g) => {
                return openBlock(), createElementBlock("div", {
                  key: g.name,
                  class: "pp-builtin-group"
                }, [
                  createBaseVNode("div", _hoisted_29$2, [
                    createBaseVNode("span", _hoisted_30$2, toDisplayString(g.title || g.name), 1),
                    g.desc ? (openBlock(), createElementBlock("span", _hoisted_31$2, toDisplayString(g.desc), 1)) : createCommentVNode("", true),
                    createBaseVNode("span", _hoisted_32$2, toDisplayString(g.tools.length) + " 工具", 1),
                    !g.allOn ? (openBlock(), createElementBlock("button", {
                      key: 1,
                      class: "pp-btn mini",
                      onClick: ($event) => enableBuiltinGroup(g),
                      title: "整组加入通用集合"
                    }, "整组启用", 8, _hoisted_33$2)) : createCommentVNode("", true),
                    g.anyOn ? (openBlock(), createElementBlock("button", {
                      key: 2,
                      class: "pp-btn mini danger",
                      onClick: ($event) => disableBuiltinGroup(g),
                      title: "整组移出通用集合"
                    }, "整组移出", 8, _hoisted_34$2)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", _hoisted_35$2, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(g.tools, (t) => {
                      return openBlock(), createElementBlock("div", {
                        key: t.name,
                        class: "pp-d-tool",
                        title: t.desc
                      }, [
                        createBaseVNode("span", _hoisted_37$2, toDisplayString(t.name), 1),
                        createBaseVNode("label", {
                          class: "pp-switch",
                          title: t.enabled ? "在通用集合中（agent 可用）；点击移出" : "未加入通用集合；点击加入"
                        }, [
                          createBaseVNode("input", {
                            type: "checkbox",
                            checked: t.enabled,
                            onChange: ($event) => toggleBuiltinTool(t, $event.target.checked)
                          }, null, 40, _hoisted_39$2),
                          _cache[17] || (_cache[17] = createBaseVNode("span", { class: "pp-switch-track" }, null, -1))
                        ], 8, _hoisted_38$2)
                      ], 8, _hoisted_36$2);
                    }), 128))
                  ])
            ...
            preferMsg.value ? (openBlock(), createElementBlock("div", {
              key: 1,
              class: normalizeClass(["pp-prefer-msg", { err: preferMsgErr.value }])
            }, [
              createVNode(SvgIcon, {
                name: preferMsgErr.value ? "warning" : "check",
                size: 11
              }, null, 8, ["name"]),
              createBaseVNode("span", null, toDisplayString(preferMsg.value), 1)
            ], 2)) : createCommentVNode("", true),
            loading.value && plugins.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_40$2, [
              createVNode(SvgIcon, {
                name: "refresh",
                size: 16,
                class: "spinner"
              }),
              _cache[18] || (_cache[18] = createBaseVNode("span", null, "加载插件…", -1))
            ])) : loadError.value ? (openBlock(), createElementBlock("div", _hoisted_41$2, [
              createVNode(SvgIcon, {
                name: "puzzle",
                size: 22,
                color: "var(--text-muted)"
              }),
              _cache[19] || (_cache[19] = createBaseVNode("span", null, "插件列表加载失败", -1)),
              createBaseVNode("button", {
                class: "pp-btn primary",
                onClick: refresh
              }, "重试")
            ])) : plugins.value.length === 0 && !loading.value ? (openBlock(), createElementBlock("div", _hoisted_42$2, [
              createVNode(SvgIcon, {
                name: "puzzle",
                size: 22,
                color: "var(--text-muted)"
              }),
              _cache[20] || (_cache[20] = createBaseVNode("span", null, "暂无插件", -1)),
              _cache[21] || (_cache[21] = createBaseVNode("span", { class: "pp-empty-sub" }, "点击上方 + 新建 JS 动态插件，或用对话 cordis(op=define) 定义", -1))
            ])) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(plugins.value, (p2) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", {
                  ...
                  }, toDisplayString(p2.name), 9, _hoisted_44$2),
                  createBaseVNode("span", {
                    class: normalizeClass(["pp-src", p2.source]),
                    title: srcTitle(p2)
                  }, toDisplayString(srcLabel(p2)), 11, _hoisted_45$2),
                  p2.scope === "global" ? (openBlock(), createElementBlock("span", _hoisted_46$2, "全局")) : createCommentVNode("", true),
                  p2.hasClient ? (openBlock(), createElementBlock("span", _hoisted_47$2, "UI")) : createCommentVNode("", true),
                  conflictsOf(p2).length ? (openBlock(), createElementBlock("span", {
                    key: 2,
                    class: "pp-badge pp-badge-warn",
                    title: conflictTitle(p2)
                  }, "同名并存 " + toDisplayString(conflictsOf(p2).length), 9, _hoisted_48$1)) : createCommentVNode("", true),
                  p2.tools && p2.tools.length ? (openBlock(), createElementBlock("span", {
                    key: 3,
                    class: "pp-count",
                    title: p2.tools.join(", ")
                  }, toDisplayString(p2.tools.length) + " 工具", 9, _hoisted_49$1)) : createCommentVNode("", true),
                  p2.hasClient && uiSlotsOf(p2.name).length ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
                    createBaseVNode("span", {
                    ...
                    createBaseVNode("label", {
                      ...
                      }, null, 40, _hoisted_51$1),
                      _cache[22] || (_cache[22] = createBaseVNode("span", { class: "pp-switch-track" }, null, -1))
                    ], 8, _hoisted_50$1)
                ...
                expanded[p2.name] ? (openBlock(), createElementBlock("div", _hoisted_52$1, [
                  p2.purpose ? (openBlock(), createElementBlock("div", _hoisted_53$1, toDisplayString(p2.purpose), 1)) : createCommentVNode("", true),
                  p2.defId ? (openBlock(), createElementBlock("div", _hoisted_54$1, [
                    createTextVNode("定义: " + toDisplayString(p2.defId), 1),
                    p2.version ? (openBlock(), createElementBlock("span", _hoisted_55$1, " · " + toDisplayString(p2.version), 1)) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true),
                  p2.spec ? (openBlock(), createElementBlock("div", _hoisted_56$1, [
                    createTextVNode("npm 包: " + toDisplayString(p2.spec), 1),
                    p2.runtime ? (openBlock(), createElementBlock("span", _hoisted_57$1, " · runtime=" + toDisplayString(p2.runtime) + "（" + toDisplayString(p2.runtime === "dsh" ? "cordis4 插件服务面" : "cordis3") + "）", 1)) : createCommentVNode("", true)
                  ])) : createCommentVNode("", true),
                  p2.lastError ? (openBlock(), createElementBlock("div", _hoisted_58$1, "异常: " + toDisplayString(p2.lastError), 1)) : createCommentVNode("", true),
                  p2.provides && p2.provides.length ? (openBlock(), createElementBlock("div", _hoisted_59$1, "服务: " + toDisplayString(p2.provides.join(", ")), 1)) : createCommentVNode("", true),
                  p2.sections && p2.sections.length ? (openBlock(), createElementBlock("div", _hoisted_60, "提示片段: " + toDisplayString(p2.sections.join(", ")), 1)) : createCommentVNode("", true),
                  conflictsOf(p2).length ? (openBlock(), createElementBlock("div", _hoisted_61, [
                    createBaseVNode("div", _hoisted_62, [
                      createVNode(SvgIcon, {
                        name: "warning",
                        size: 11
                      }),
                      _cache[23] || (_cache[23] = createBaseVNode("span", null, "同名工具并存：两个来源实现同一工具（两侧插件都保留，只有一方对 agent 生效）", -1))
                    ]),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(conflictsOf(p2), (c) => {
                      return openBlock(), createElementBlock("div", {
                        key: c.tool,
                        class: "pp-d-conflict-row"
                      }, [
                        createBaseVNode("span", {
                          class: "pp-d-tname",
                          title: c.tool
                        }, toDisplayString(c.tool), 9, _hoisted_63),
                        createBaseVNode("span", {
                          class: normalizeClass(["pp-d-side", { on: c.active === "repo" }]),
                          title: "repo 移植版（goja 插件）：" + c.repo
                        }, "repo · " + toDisplayString(c.repo), 11, _hoisted_64),
                        createBaseVNode("span", {
                          class: normalizeClass(["pp-d-side", { on: c.active === "bridge" }]),
                          title: "npm 桥插件：" + c.bridge
                        }, "npm · " + toDisplayString(shortPkg(c.bridge)), 11, _hoisted_65),
                        createBaseVNode("button", {
                          class: "pp-btn",
                          disabled: preferring[c.tool],
                          title: c.active === "repo" ? "切为桥插件实现生效（repo 版保留，不停用）" : "切回 repo 版实现生效（桥版保留，不停用）",
                          onClick: ($event) => switchImpl(c, c.active === "repo" ? "bridge" : "repo")
                        }, [
                          createVNode(SvgIcon, {
                            name: "cycle",
                            size: 11
                          }),
                          createTextVNode(" " + toDisplayString(c.active === "repo" ? "改用桥版" : "改回 repo 版"), 1)
                        ], 8, _hoisted_66)
                      ]);
                    }), 128))
                  ])) : createCommentVNode("", true),
                  p2.tools && p2.tools.length ? (openBlock(), createElementBlock("div", _hoisted_67, [
                    createBaseVNode("div", _hoisted_68, "工具（" + toDisplayString(p2.tools.length) + "）· 勾选=对 cordis（JS 插件运行时）可见；取消=隐藏。agent 可用性由会话选择的通用集合决定", 1),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(p2.tools, (t) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createBaseVNode("span", {
                          class: "pp-d-tname",
                          title: t
                        }, toDisplayString(t), 9, _hoisted_69),
                        createBaseVNode("label", {
                          class: "pp-switch",
                          title: pluginToolOn(p2, t) ? "对 cordis 可见；点击隐藏（JS 插件 ctx.tools 看不到它）" : "对 cordis 隐藏；点击恢复可见"
                        }, [
                          createBaseVNode("input", {
                            type: "checkbox",
                            checked: pluginToolOn(p2, t),
                            onChange: ($event) => _ctx.togglePluginTool(p2, t)
                          }, null, 40, _hoisted_71),
                  ...
                  p2.clientCode ? (openBlock(), createElementBlock("div", _hoisted_72, [
                  ...
                  createBaseVNode("div", _hoisted_75, [
                    p2.source === "node-bridge" ? (openBlock(), createElementBlock("span", _hoisted_76, "Node 桥插件（npm 包）：安装/卸载经 npm 插件市场管理；同名工具可在上方切换生效方")) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      p2.state === "running" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        !(p2.hasClient && uiSlotsOf(p2.name).length) ? (openBlock(), createElementBlock("button", {
                          key: 0,
                          class: "pp-btn",
                          title: "停止整个插件（其全部工具对 agent 不可见）；单工具请用上方工具开关",
                          onClick: ($event) => doAction(p2, "stop")
                        }, "停止插件", 8, _hoisted_77)) : createCommentVNode("", true)
                      ...
                      }, "删除定义", 8, _hoisted_79)) : createCommentVNode("", true)
                    ], 64))
                  ])
                ])) : createCommentVNode("", true)
              ]);
  ...
  const PluginPanel = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-08bc13a6"]]);
  const _hoisted_1$2 = { class: "tp-panel" };
  const _hoisted_2$2 = { class: "tp-header" };
  const _hoisted_3$2 = { class: "tp-title" };
  const _hoisted_4$2 = { class: "tp-actions" };
  const _hoisted_5$2 = { class: "tp-body" };
  const _hoisted_6$2 = { class: "tp-list" };
  const _hoisted_7$2 = {
    key: 0,
    class: "tp-empty"
  };
  const _hoisted_8$2 = ["onClick"];
  const _hoisted_9$2 = { class: "tp-item-main" };
  const _hoisted_10$2 = { class: "tp-item-name" };
  const _hoisted_11$2 = { class: "tp-item-count" };
  const _hoisted_12$2 = { class: "tp-item-desc" };
  const _hoisted_13$2 = {
    key: 1,
    class: "tp-empty"
  };
  ...
  const _hoisted_15$2 = { class: "tp-dhead" };
  ...
  const _hoisted_24$1 = { class: "tp-pname" };
  ...
  const _hoisted_29$1 = ["title", "onClick"];
  const _hoisted_30$1 = {
    key: 2,
    class: "tp-muted"
  };
  ...
  const _hoisted_33$1 = {
    key: 1,
    class: "tp-empty tp-side-empty"
  };
  const _hoisted_34$1 = { class: "tp-sheet-head" };
  const _hoisted_35$1 = { class: "tp-sheet-body" };
  const _hoisted_36$1 = { class: "tp-field" };
  const _hoisted_37$1 = { class: "tp-field" };
  const _hoisted_38$1 = { class: "tp-field" };
  const _hoisted_39$1 = {
    key: 0,
    class: "tp-hint"
  };
  const _hoisted_40$1 = { class: "tp-sheet-actions" };
  const _hoisted_41$1 = ["disabled"];
  const _hoisted_42$1 = { class: "tp-sheet-head" };
  const _hoisted_43$1 = { class: "tp-sheet-body" };
  const _hoisted_44$1 = { class: "tp-file-row" };
  const _hoisted_45$1 = {
    key: 0,
    class: "tp-muted"
  };
  const _hoisted_46$1 = { class: "tp-field" };
  const _hoisted_47$1 = { class: "tp-sheet-actions" };
  const _hoisted_48 = ["disabled"];
  const _hoisted_49 = { class: "tp-sheet-head" };
  const _hoisted_50 = { class: "tp-sheet-title" };
  const _hoisted_51 = { class: "tp-add-search" };
  const _hoisted_52 = { class: "tp-add-grid" };
  const _hoisted_53 = ["onClick"];
  const _hoisted_54 = { class: "tp-pcard-head" };
  const _hoisted_55 = { class: "tp-pcard-name" };
  const _hoisted_56 = { class: "tp-pcard-count" };
  const _hoisted_57 = { class: "tp-pcard-desc" };
  const _hoisted_58 = { class: "tp-pcard-add" };
  const _hoisted_59 = {
    key: 0,
    class: "tp-empty"
  };
  const _sfc_main$2 = {
    __name: "ToolsetPanel",
    setup(__props) {
      const metas = /* @__PURE__ */ ref([]);
      const detail = /* @__PURE__ */ ref(null);
      const selName = /* @__PURE__ */ ref("");
      const plugins = /* @__PURE__ */ ref([]);
      const loading = /* @__PURE__ */ ref(false);
      const refreshing = /* @__PURE__ */ ref(false);
      const openBuild = /* @__PURE__ */ ref(false);
      const buildForm = /* @__PURE__ */ reactive({ name: "", description: "", requirement: "" });
      const buildBusy = /* @__PURE__ */ ref(false);
      const buildHint = /* @__PURE__ */ ref(false);
      const openImport = /* @__PURE__ */ ref(false);
      const importJSON = /* @__PURE__ */ ref("");
      const fileName = /* @__PURE__ */ ref("");
      const fileInput = /* @__PURE__ */ ref(null);
      const importBusy = /* @__PURE__ */ ref(false);
      const openAddPlugin = /* @__PURE__ */ ref(false);
      const addFilter = /* @__PURE__ */ ref("");
      ...
      const addablePlugins = computed(() => {
        const inTs = new Set((detail.value && detail.value.plugins || []).map((p2) => p2.name));
        return plugins.value.filter((p2) => !inTs.has(p2.name)).map((p2) => ({ name: p2.name, purpose: p2.purpose || "（无描述）", toolCount: (p2.tools || []).length }));
      });
      const filteredAddable = computed(() => {
        const q = addFilter.value.trim().toLowerCase();
        if (!q) return addablePlugins.value;
        return addablePlugins.value.filter((p2) => p2.name.toLowerCase().includes(q) || p2.purpose.toLowerCase().includes(q));
      });
      ...
      function validName(n) {
        return /^[a-z0-9_-]+$/.test((n || "").trim());
      }
      async function doBuild() {
        const name = buildForm.name.trim();
        if (!validName(name)) {
          toastErr("名称只能含小写字母/数字/-/_");
          return;
        }
      ...
      function onFile(e) {
        ...
        fr.onload = () => {
          importJSON.value = String(fr.result || "");
        };
        ...
        return openBlock(), createElementBlock("div", _hoisted_1$2, [
          createBaseVNode("div", _hoisted_2$2, [
            createBaseVNode("span", _hoisted_3$2, [
              ...
              _cache[20] || (_cache[20] = createTextVNode(" 工具集", -1))
            ]),
            createBaseVNode("div", _hoisted_4$2, [
              ...
              createBaseVNode("button", {
                class: "tp-icon-btn",
                onClick: _cache[0] || (_cache[0] = ($event) => openImport.value = true),
                title: "导入工具集（粘贴 JSON 或选择文件）"
              }, [
                createVNode(SvgIcon, {
                  name: "download",
                  size: 13
              ...
              createBaseVNode("button", {
                class: "tp-icon-btn",
                onClick: _cache[1] || (_cache[1] = ($event) => openBuild.value = true),
                title: "新建工具集（模板构建 + AI 分析）"
              }, [
                createVNode(SvgIcon, {
                  name: "plus",
                  size: 14
          ...
          createBaseVNode("div", _hoisted_5$2, [
            createBaseVNode("div", _hoisted_6$2, [
              !metas.value.length && !loading.value ? (openBlock(), createElementBlock("div", _hoisted_7$2, [..._cache[21] || (_cache[21] = [
                createTextVNode(" 暂无工具集。", -1),
                createBaseVNode("br", null, null, -1),
                createTextVNode("点右上角 + 新建（描述你的项目用途，AI 分析后模板生成插件集）。 ", -1)
              ])])) : createCommentVNode("", true),
              (openBlock(true), createElementBlock(Fragment, null, renderList(metas.value, (m) => {
                return openBlock(), createElementBlock("div", {
                  key: m.name,
                  class: normalizeClass(["tp-item", { active: m.name === selName.value, builtin: m.scope === "builtin" }]),
                  onClick: ($event) => select(m)
                }, [
                  createBaseVNode("div", _hoisted_9$2, [
                    createBaseVNode("span", _hoisted_10$2, toDisplayString(m.name), 1),
                    createBaseVNode("span", _hoisted_11$2, toDisplayString(m.pluginCount) + " 插件", 1)
                  ]),
                  createBaseVNode("div", _hoisted_12$2, toDisplayString(m.description || (m.scope === "builtin" ? "内置工具包（core/git/codegraph/…）" : "—")), 1)
                ], 10, _hoisted_8$2);
              }), 128)),
              loading.value ? (openBlock(), createElementBlock("div", _hoisted_13$2, "加载中…")) : createCommentVNode("", true)
            ]),
            detail.value ? (openBlock(), createElementBlock("div", _hoisted_14$2, [
              createBaseVNode("div", _hoisted_15$2, [
                ...
                createBaseVNode("div", _hoisted_19$1, [
                  createBaseVNode("button", {
                    class: "tp-btn",
                    onClick: doExport,
                    title: "导出发布 JSON 到本地下载"
                  }, [
                    createVNode(SvgIcon, {
                      name: "upload",
                      size: 11
                    }),
                    _cache[22] || (_cache[22] = createTextVNode(" 导出", -1))
                  ]),
                  detail.value.scope !== "builtin" ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    class: "tp-btn danger",
                    onClick: doRemove,
                    title: "删除该工具集（含固化的插件定义）"
                  }, [
                    createVNode(SvgIcon, {
                      name: "trash",
                      size: 11
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(detail.value.plugins || [], (pl) => {
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_23$1, [
                      createBaseVNode("span", _hoisted_24$1, toDisplayString(pl.name), 1),
                      detail.value.scope !== "builtin" ? (openBlock(), createElementBlock("button", {
                        key: 0,
                        class: "tp-btn tiny danger",
                        onClick: ($event) => rmPlugin(pl),
                        title: "从工具集移出（插件定义仍留在宿主）"
                      }, "移出", 8, _hoisted_25$1)) : (openBlock(), createElementBlock("span", _hoisted_26$1, "内置"))
                    ]),
                    pl.purpose ? (openBlock(), createElementBlock("div", _hoisted_27$1, toDisplayString(pl.purpose), 1)) : createCommentVNode("", true),
                    pluginToolsOf(pl.name).length ? (openBlock(), createElementBlock("div", _hoisted_28$1, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(pluginToolsOf(pl.name), (t) => {
                        return openBlock(), createElementBlock("button", {
                          key: t,
                          class: normalizeClass(["tp-tool", { off: isToolDisabled(pl, t) }]),
                          title: isToolDisabled(pl, t) ? "已摘除（对 agent 不可见），点击恢复" : "点击摘除（插件保留、工具不可见）",
                          onClick: ($event) => toggleTool(pl, t)
                        }, toDisplayString(t), 11, _hoisted_29$1);
                      }), 128))
                    ])) : (openBlock(), createElementBlock("div", _hoisted_30$1, "（插件未运行或无工具）"))
                  ]);
                }), 128)),
                !(detail.value.plugins || []).length ? (openBlock(), createElementBlock("div", _hoisted_31$1, "空工具集：点下方「添加插件」加入宿主插件")) : createCommentVNode("", true)
              ]),
              detail.value.scope !== "builtin" ? (openBlock(), createElementBlock("div", _hoisted_32$1, [
                createBaseVNode("button", {
                  class: "tp-btn tp-add-btn",
                  onClick: _cache[2] || (_cache[2] = ($event) => openAddPlugin.value = true)
                }, [
                  createVNode(SvgIcon, {
                    name: "plus",
                    size: 12
                  }),
                  _cache[24] || (_cache[24] = createTextVNode(" 添加插件", -1))
                ])
              ])) : createCommentVNode("", true)
            ])) : (openBlock(), createElementBlock("div", _hoisted_33$1, "选择左侧工具集查看详情"))
          ]),
          (openBlock(), createBlock(Teleport, { to: "body" }, [
            createVNode(Transition, { name: "tp-fade" }, {
              default: withCtx(() => [
                openBuild.value ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: "tp-overlay",
                  onClick: _cache[9] || (_cache[9] = withModifiers(($event) => openBuild.value = false, ["self"]))
                }, [
                  createBaseVNode("div", {
                    class: "tp-sheet",
                    onClick: _cache[8] || (_cache[8] = withModifiers(() => {
                    ...
                    createBaseVNode("div", _hoisted_34$1, [
                      _cache[25] || (_cache[25] = createBaseVNode("span", { class: "tp-sheet-title" }, "新建工具集", -1)),
                      createBaseVNode("button", {
                        class: "tp-cancel",
                        onClick: _cache[3] || (_cache[3] = ($event) => openBuild.value = false)
                      }, "取消")
                    ]),
                    createBaseVNode("div", _hoisted_35$1, [
                      createBaseVNode("label", _hoisted_36$1, [
                        _cache[26] || (_cache[26] = createBaseVNode("span", { class: "tp-field-label" }, "名称（小写字母/数字/-/_）", -1)),
                        withDirectives(createBaseVNode("input", {
                          "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => buildForm.name = $event),
                          class: "tp-input",
                          placeholder: "如 web-dev / go-backend"
                        }, null, 512), [
                          [vModelText, buildForm.name]
                        ])
                      ]),
                      createBaseVNode("label", _hoisted_37$1, [
                        _cache[27] || (_cache[27] = createBaseVNode("span", { class: "tp-field-label" }, "描述（可选）", -1)),
                        withDirectives(createBaseVNode("input", {
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => buildForm.description = $event),
                          class: "tp-input",
                          placeholder: "工具集用途说明"
                        }, null, 512), [
                          [vModelText, buildForm.description]
                        ])
                      ]),
                      createBaseVNode("label", _hoisted_38$1, [
                        _cache[28] || (_cache[28] = createBaseVNode("span", { class: "tp-field-label" }, "需求说明（可选，AI 分析项目时参考）", -1)),
                        withDirectives(createBaseVNode("textarea", {
                          "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => buildForm.requirement = $event),
                          class: "tp-input tp-textarea",
                          rows: "3",
                          placeholder: "如：需要前后端脚手架 + 数据库迁移工具"
                        }, null, 512), [
                          [vModelText, buildForm.requirement]
                        ])
                      ]),
                      buildHint.value ? (openBlock(), createElementBlock("label", _hoisted_39$1, "检测到同名工具集已存在，勾选后覆盖重建（原插件先卸载）")) : createCommentVNode("", true),
                      createBaseVNode("div", _hoisted_40$1, [
                        createBaseVNode("button", {
                          class: "tp-btn",
                          onClick: _cache[7] || (_cache[7] = ($event) => openBuild.value = false)
                        }, "取消"),
                        createBaseVNode("button", {
                          class: "tp-btn primary",
                          disabled: buildBusy.value || !validName(buildForm.name),
                          onClick: doBuild
                        }, toDisplayString(buildBusy.value ? "构建中…" : "构建并装载"), 9, _hoisted_41$1)
                      ])
                    ])
                  ])
                ])) : createCommentVNode("", true)
          ...
          (openBlock(), createBlock(Teleport, { to: "body" }, [
            createVNode(Transition, { name: "tp-fade" }, {
              default: withCtx(() => [
                openImport.value ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: "tp-overlay",
                  onClick: _cache[15] || (_cache[15] = withModifiers(($event) => openImport.value = false, ["self"]))
                }, [
                  createBaseVNode("div", {
                    class: "tp-sheet",
                    ...
                    createBaseVNode("div", _hoisted_42$1, [
                      _cache[29] || (_cache[29] = createBaseVNode("span", { class: "tp-sheet-title" }, "导入工具集", -1)),
                      createBaseVNode("button", {
                        class: "tp-cancel",
                        onClick: _cache[10] || (_cache[10] = ($event) => openImport.value = false)
                      }, "取消")
                    ]),
                    createBaseVNode("div", _hoisted_43$1, [
                      createBaseVNode("div", _hoisted_44$1, [
                        createBaseVNode("input", {
                          ...
                          class: "tp-hidden-input",
                          onChange: onFile
                        }, null, 544),
                        createBaseVNode("button", {
                          class: "tp-btn",
                          onClick: _cache[11] || (_cache[11] = ($event) => fileInput.value && fileInput.value.click())
                        }, "选择 JSON 文件…"),
                        fileName.value ? (openBlock(), createElementBlock("span", _hoisted_45$1, toDisplayString(fileName.value), 1)) : createCommentVNode("", true)
                      ]),
                      createBaseVNode("label", _hoisted_46$1, [
                        _cache[30] || (_cache[30] = createBaseVNode("span", { class: "tp-field-label" }, "或粘贴工具集 JSON", -1)),
                        withDirectives(createBaseVNode("textarea", {
                          "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => importJSON.value = $event),
                          class: "tp-input tp-textarea code",
                          rows: "9",
                          placeholder: '{"name":"my-tools","description":"…","plugins":[…]}'
                        }, null, 512), [
                          [vModelText, importJSON.value]
                        ])
                      ]),
                      createBaseVNode("div", _hoisted_47$1, [
                        createBaseVNode("button", {
                          class: "tp-btn",
                          onClick: _cache[13] || (_cache[13] = ($event) => openImport.value = false)
                        }, "取消"),
                        createBaseVNode("button", {
                          class: "tp-btn primary",
                          disabled: importBusy.value || !importJSON.value.trim(),
                          onClick: doImport
                        }, toDisplayString(importBusy.value ? "导入中…" : "导入"), 9, _hoisted_48)
                      ])
                    ])
                  ])
                ])) : createCommentVNode("", true)
          ...
          (openBlock(), createBlock(Teleport, { to: "body" }, [
            createVNode(Transition, { name: "tp-fade" }, {
              default: withCtx(() => [
                openAddPlugin.value ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: "tp-overlay",
                  onClick: _cache[19] || (_cache[19] = withModifiers(($event) => openAddPlugin.value = false, ["self"]))
                }, [
                  createBaseVNode("div", {
                    class: "tp-sheet tp-add-sheet",
                    ...
                    createBaseVNode("div", _hoisted_49, [
                      createBaseVNode("span", _hoisted_50, [
                        ...
                        createTextVNode(" 添加宿主插件（" + toDisplayString(filteredAddable.value.length) + "）", 1)
                      ]),
                      createBaseVNode("button", {
                        class: "tp-cancel",
                        onClick: _cache[16] || (_cache[16] = ($event) => openAddPlugin.value = false)
                      }, "取消")
                    ]),
                    createBaseVNode("div", _hoisted_51, [
                      createVNode(SvgIcon, {
                        name: "search",
                        size: 13,
                        class: "tp-add-search-icon"
                      }),
                      withDirectives(createBaseVNode("input", {
                        "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => addFilter.value = $event),
                        class: "tp-input tp-add-search-input",
                        placeholder: "搜索插件名 / 用途…"
                      }, null, 512), [
                        [vModelText, addFilter.value]
                      ])
                    ]),
                    createBaseVNode("div", _hoisted_52, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(filteredAddable.value, (p2) => {
                        return openBlock(), createElementBlock("button", {
                          key: p2.name,
                          class: "tp-pcard",
                          onClick: ($event) => doAddPlugin(p2.name)
                        }, [
                          createBaseVNode("div", _hoisted_54, [
                            createBaseVNode("span", _hoisted_55, toDisplayString(p2.name), 1),
                            createBaseVNode("span", _hoisted_56, toDisplayString(p2.toolCount) + " 工具", 1)
                          ]),
                          createBaseVNode("div", _hoisted_57, toDisplayString(p2.purpose), 1),
                          createBaseVNode("div", _hoisted_58, [
                            createVNode(SvgIcon, {
                              name: "plus",
                              size: 11
                            }),
                            _cache[31] || (_cache[31] = createTextVNode(" 加入", -1))
                          ])
                        ], 8, _hoisted_53);
                      }), 128)),
                      !filteredAddable.value.length ? (openBlock(), createElementBlock("div", _hoisted_59, "无匹配插件（或宿主插件已全部加入）")) : createCommentVNode("", true)
                    ])
                  ])
                ])) : createCommentVNode("", true)
              ]),
  ...
  const ToolsetPanel = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d09e78dd"]]);
  const _hoisted_1$1 = { class: "stats-rail" };
  const _hoisted_2$1 = { class: "sr-card" };
  const _hoisted_3$1 = { class: "sr-head" };
  const _hoisted_4$1 = ["title"];
  const _hoisted_5$1 = { class: "sr-summary" };
  const _hoisted_6$1 = { class: "sr-row" };
  const _hoisted_7$1 = { class: "sr-v" };
  const _hoisted_8$1 = { class: "sr-row" };
  const _hoisted_9$1 = { class: "sr-v" };
  const _hoisted_10$1 = { class: "sr-row" };
  const _hoisted_11$1 = { class: "sr-v" };
  const _hoisted_12$1 = { class: "sr-row" };
  const _hoisted_13$1 = { class: "sr-v sr-v-ok" };
  const _hoisted_14$1 = { class: "sr-card" };
  const _hoisted_15$1 = { class: "sr-head" };
  const _hoisted_16 = { class: "sr-badge" };
  const _hoisted_17 = { class: "sr-tokens" };
  ...
  const _hoisted_20 = ["stroke-dasharray"];
  const _hoisted_21 = { class: "cache-ring-label" };
  const _hoisted_22 = { class: "cache-ring-pct" };
  const _hoisted_23 = { class: "sr-token-detail" };
  const _hoisted_24 = { class: "sr-row" };
  const _hoisted_25 = { class: "sr-v" };
  const _hoisted_26 = { class: "sr-row" };
  const _hoisted_27 = { class: "sr-v sr-v-ok" };
  const _hoisted_28 = { class: "sr-row" };
  const _hoisted_29 = { class: "sr-v" };
  const _hoisted_30 = { class: "sr-row" };
  const _hoisted_31 = { class: "sr-v" };
  const _hoisted_32 = { class: "sr-row sr-token-total" };
  const _hoisted_33 = { class: "sr-v" };
  const _hoisted_34 = { class: "sr-card" };
  const _hoisted_35 = { class: "sr-head" };
  ...
  const _hoisted_40 = { class: "sr-task-text" };
  const _hoisted_41 = { class: "sr-card" };
  const _hoisted_42 = { class: "sr-segbar" };
  const _hoisted_43 = ["title"];
  const _hoisted_44 = { class: "sr-legend" };
  const _hoisted_45 = ["title"];
  const _hoisted_46 = { class: "sr-legend-txt" };
  const _hoisted_47 = {
    key: 0,
    class: "sr-note"
  };
  const _sfc_main$1 = {
    ...
    setup(__props) {
      ...
      const runSummary = computed(() => {
        ...
        if (runElapsedMs.value >= 1e3) seg.push(fmtDuration(runElapsedMs.value));
      ...
      const runSpeed = computed(() => runHasData.value && run.value.tokensPerSecond > 0 ? fmtSpeed(run.value.tokensPerSecond) : "—");
      onMounted(() => {
      ...
      const SEG_COLORS = {
        ...
        // 主色（延续原「提示词」段主色）
        skills: "var(--color-cat-purple)",
        // 技能（新增独立段）
        mcp: "var(--color-cat-teal)",
        // MCP（新增独立段）
      ...
      const segs = computed(() => {
        const p2 = parts.value;
        const tot = SEG_ORDER.reduce((s, k) => s + p2[k], 0);
      ...
      const cacheRate = computed(() => cacheDenom.value > 0 ? (wsStats.value.cacheHitTokens / cacheDenom.value * 100).toFixed(1) : "0.0");
      ...
      function onTasksDirty(e) {
        ...
        tasksDirtyTimer = setTimeout(() => {
          tasksDirtyTimer = null;
          loadTasks();
        }, 150);
      }
      onMounted(() => {
        loadTasks();
        window.addEventListener("paircode:tasks-changed", onTasksDirty);
      });
      onUnmounted(() => {
        window.removeEventListener("paircode:tasks-changed", onTasksDirty);
        if (tasksDirtyTimer) {
          clearTimeout(tasksDirtyTimer);
          tasksDirtyTimer = null;
        }
      });
      ...
      function fmtDuration(ms) {
        const sec = Math.floor((Number(ms) || 0) / 1e3);
        ...
        return openBlock(), createElementBlock("aside", _hoisted_1$1, [
          createBaseVNode("section", _hoisted_2$1, [
            createBaseVNode("div", _hoisted_3$1, [
              _cache[1] || (_cache[1] = createBaseVNode("span", { class: "sr-title" }, "运行统计", -1)),
              createBaseVNode("button", {
                class: "sr-icon-btn",
                title: folded.value ? "展开明细" : "收起明细",
                onClick: _cache[0] || (_cache[0] = ($event) => folded.value = !folded.value)
              }, [
                createVNode(SvgIcon, {
                  name: folded.value ? "chevron-down" : "chevron-up",
                  size: 16
                }, null, 8, ["name"])
              ], 8, _hoisted_4$1)
            ]),
            createBaseVNode("div", _hoisted_5$1, toDisplayString(runSummary.value), 1),
            !folded.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              _cache[6] || (_cache[6] = createBaseVNode("div", { class: "sr-divider" }, null, -1)),
              createBaseVNode("div", _hoisted_6$1, [
                _cache[2] || (_cache[2] = createBaseVNode("span", { class: "sr-k" }, "步数", -1)),
                createBaseVNode("span", _hoisted_7$1, toDisplayString(runSteps.value), 1)
              ]),
              createBaseVNode("div", _hoisted_8$1, [
                _cache[3] || (_cache[3] = createBaseVNode("span", { class: "sr-k" }, "工具调用", -1)),
                createBaseVNode("span", _hoisted_9$1, toDisplayString(runToolCalls.value), 1)
              ]),
              createBaseVNode("div", _hoisted_10$1, [
                _cache[4] || (_cache[4] = createBaseVNode("span", { class: "sr-k" }, "LLM 调用", -1)),
                createBaseVNode("span", _hoisted_11$1, toDisplayString(runLLMCalls.value), 1)
              ]),
              createBaseVNode("div", _hoisted_12$1, [
                _cache[5] || (_cache[5] = createBaseVNode("span", { class: "sr-k" }, "输出速度", -1)),
                createBaseVNode("span", _hoisted_13$1, toDisplayString(runSpeed.value), 1)
              ])
            ], 64)) : createCommentVNode("", true)
          ]),
          createBaseVNode("section", _hoisted_14$1, [
            createBaseVNode("div", _hoisted_15$1, [
              _cache[7] || (_cache[7] = createBaseVNode("span", { class: "sr-title" }, "Token 统计", -1)),
              createBaseVNode("span", _hoisted_16, "命中 " + toDisplayString(cacheRate.value) + "%", 1)
            ]),
            createBaseVNode("div", _hoisted_17, [
              createBaseVNode("div", {
                class: "cache-ring-wrap",
                title: "缓存命中率 " + cacheRate.value + "%（命中 " + fmt(wsStats.value.cacheHitTokens) + " / 未命中 " + fmt(wsStats.value.cacheMissTokens) + "）"
              }, [
                (openBlock(), createElementBlock("svg", _hoisted_19, [
                  ...
                  createBaseVNode("circle", {
                    ...
                    stroke: "var(--accent)",
                    "stroke-width": "4",
                    "stroke-dasharray": cacheRingDash.value,
                    "stroke-linecap": "round",
                ...
                createBaseVNode("div", _hoisted_21, [
                  createBaseVNode("span", _hoisted_22, toDisplayString(cacheRate.value) + "%", 1),
                  _cache[9] || (_cache[9] = createBaseVNode("span", { class: "cache-ring-text" }, "缓存命中", -1))
                ])
              ], 8, _hoisted_18),
              createBaseVNode("div", _hoisted_23, [
                createBaseVNode("div", _hoisted_24, [
                  _cache[10] || (_cache[10] = createBaseVNode("span", { class: "sr-k" }, "输入", -1)),
                  createBaseVNode("span", _hoisted_25, toDisplayString(fmt(wsStats.value.promptTokens)), 1)
                ]),
                createBaseVNode("div", _hoisted_26, [
                  _cache[11] || (_cache[11] = createBaseVNode("span", { class: "sr-k" }, "● 缓存命中", -1)),
                  createBaseVNode("span", _hoisted_27, toDisplayString(fmt(wsStats.value.cacheHitTokens)), 1)
                ]),
                createBaseVNode("div", _hoisted_28, [
                  _cache[12] || (_cache[12] = createBaseVNode("span", { class: "sr-k" }, "● 未命中", -1)),
                  createBaseVNode("span", _hoisted_29, toDisplayString(fmt(wsStats.value.cacheMissTokens)), 1)
                ]),
                createBaseVNode("div", _hoisted_30, [
                  _cache[13] || (_cache[13] = createBaseVNode("span", { class: "sr-k" }, "输出", -1)),
                  createBaseVNode("span", _hoisted_31, toDisplayString(fmt(wsStats.value.completionTokens)), 1)
                ]),
                _cache[15] || (_cache[15] = createBaseVNode("div", { class: "sr-divider" }, null, -1)),
                createBaseVNode("div", _hoisted_32, [
                  _cache[14] || (_cache[14] = createBaseVNode("span", { class: "sr-k" }, "总 Token", -1)),
                  createBaseVNode("span", _hoisted_33, toDisplayString(fmt(wsStats.value.totalTokens)), 1)
                ])
              ])
            ])
          ]),
          createBaseVNode("section", _hoisted_34, [
            createBaseVNode("div", _hoisted_35, [
              _cache[16] || (_cache[16] = createBaseVNode("span", { class: "sr-title" }, "任务进度", -1)),
              createBaseVNode("span", {
                class: "sr-badge",
                title: "已完成 " + doneCount.value + " 项 / 共 " + tasks.value.length + " 项"
              }, toDisplayString(doneCount.value) + " / " + toDisplayString(tasks.value.length), 9, _hoisted_36)
            ]),
            tasks.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_37, [
              createBaseVNode("div", {
                class: "sr-bar-fill",
                style: normalizeStyle({ width: donePct.value + "%" })
              }, null, 4)
            ])) : createCommentVNode("", true),
            tasks.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_38, "暂无任务")) : (openBlock(), createElementBlock("div", _hoisted_39, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(tasks.value, (t, i) => {
                return openBlock(), createElementBlock("div", {
                  key: i,
                  class: "sr-task"
                }, [
                  createBaseVNode("span", _hoisted_40, toDisplayString(t.subject), 1),
                  createBaseVNode("span", {
                    class: normalizeClass(["sr-task-st", statusClass(t.status)])
                  }, toDisplayString(statusText(t.status)), 3)
                ]);
              }), 128))
            ]))
          ]),
          createBaseVNode("section", _hoisted_41, [
            _cache[17] || (_cache[17] = createBaseVNode("div", { class: "sr-head" }, [
              createBaseVNode("span", { class: "sr-title" }, "上下文构成")
            ], -1)),
            createBaseVNode("div", _hoisted_42, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(segs.value, (s, i) => {
            ...
            createBaseVNode("div", _hoisted_44, [
              (openBlock(), createElementBlock(Fragment, null, renderList(SEG_ORDER, (k) => {
                return createBaseVNode("span", {
                  key: k,
                  class: "sr-legend-item",
                  title: SEG_LABELS[k] + " " + parts.value[k] + " tokens"
                }, [
                  createBaseVNode("i", {
                    class: "sr-legend-dot",
                    style: normalizeStyle({ background: SEG_COLORS[k] })
                  }, null, 4),
                  createBaseVNode("span", _hoisted_46, toDisplayString(SEG_LABELS[k]) + " " + toDisplayString(fmt(parts.value[k])), 1)
                ], 8, _hoisted_45);
              }), 64))
            ]),
            ctxMax.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_47, "剩余 " + toDisplayString(fmt(remainTokens.value)) + "（" + toDisplayString(remainPct.value) + "%）", 1)) : createCommentVNode("", true)
          ]),
          _cache[18] || (_cache[18] = createBaseVNode("div", { class: "sr-filler" }, null, -1)),
          _cache[19] || (_cache[19] = createBaseVNode("section", { class: "sr-card sr-card-tip" }, [
            createBaseVNode("div", { class: "sr-tip-main" }, "外观可在「设置 → 外观」调整"),
            createBaseVNode("div", { class: "sr-tip-sub" }, "主题 / 背景图 / 面板不透明度")
          ], -1))
        ]);
      };
    }
  };
  const StatsRail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2c44dfd0"]]);
  const _hoisted_1 = {
    key: 0,
  ...
  const _hoisted_4 = { class: "view-pane view-pane-chat" };
  const _hoisted_5 = {
    key: 0,
    class: "view-pane"
  };
  ...
  const _hoisted_9 = { class: "plugin-slot-host toolsets-container" };
  const _hoisted_10 = {
    key: 6,
    class: "right-rail-host"
  };
  const _hoisted_11 = {
    key: 7,
  ...
  const _hoisted_13 = { class: "plugin-escape-panel" };
  const _hoisted_14 = { class: "plugin-escape-head" };
  const _hoisted_15 = { class: "plugin-escape-body" };
  const _sfc_main = {
    __name: "ShellApp",
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock(Fragment, null, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", {
              class: normalizeClass(["main-area", { "panel-only": unref(panelMode) }])
            }, [
              createBaseVNode("div", {
                ...
                withDirectives(createBaseVNode("div", _hoisted_4, [
                  (unref(state).rightPanelVisible || unref(panelMode)) && !slots.conversation.owner.value ? (openBlock(), createElementBlock("div", {
                    ...
                    _cache[12] || (_cache[12] = createBaseVNode("span", null, "对话面板未装配（ui-right-panel）", -1)),
                    createBaseVNode("button", {
                      class: "escape-link",
                ...
                !unref(panelMode) ? withDirectives((openBlock(), createElementBlock("div", _hoisted_5, [
                  !slots.editor.owner.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
                    _cache[13] || (_cache[13] = createBaseVNode("span", null, "编辑器未装配（ui-editor）", -1)),
                    createBaseVNode("button", {
                      class: "escape-link",
                ...
                !unref(panelMode) && unref(state).marketTabOpen ? withDirectives((openBlock(), createElementBlock("div", _hoisted_7, [
                  createBaseVNode("div", {
                    ref_key: "marketHost",
                    ref: marketHost,
                ...
                !unref(panelMode) && unref(state).toolsetsTabOpen ? withDirectives((openBlock(), createElementBlock("div", _hoisted_8, [
            ...
            !unref(panelMode) && unref(state).statsRailVisible !== false ? (openBlock(), createElementBlock("div", _hoisted_10, [
              createVNode(StatsRail)
            ])) : createCommentVNode("", true),
            !unref(panelMode) && !slots.statusbar.owner.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
            ...
            !slots.modals.owner.value ? (openBlock(), createElementBlock("div", _hoisted_12)) : (openBlock(), createElementBlock("div", {
              key: 10,
  ...
  const ShellApp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4ef64614"]]);
  window.__PAIRCODE_CORE = {
    ...
    actions,
    layout,
    // ★ ctx.uiLayout 服务面（见 ui-state.js `layout`）
    version: "1.0.0"
    // ★ 共享核心契约版本锚（region 包兼容检测）
  };
  initTheme();
