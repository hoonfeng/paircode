var UiSidebar = (function(exports, vue, uiState_js, api, pluginRuntime_js) {
                    ...
                    vue.renderList(items.value, (item, i) => {
                      return vue.openBlock(), vue.createElementBlock(
                        ...
                        [
                          ...
                          item.separator ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$7)) : (vue.openBlock(), vue.createElementBlock(
                            vue.Fragment,
                            { key: 1 },
                            [
  ...
  const ContextMenu = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-dde82381"]]);
  const _hoisted_1$6 = { class: "file-tree-item" };
  const _hoisted_2$6 = {
    key: 0,
    class: "chevron-wrap"
  };
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$6, [
          vue.createElementVNode(
            ...
            [
              __props.item.isDir ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$6, [
  ...
  const FileTreeItem = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-493c29a3"]]);
  ...
  const _hoisted_18$3 = { class: "ts-add-list" };
  const _hoisted_19$3 = { class: "ts-add-group-title" };
  const _hoisted_20$3 = { class: "ts-tool-desc" };
  const _hoisted_21$3 = ["title"];
  const _hoisted_22$3 = { class: "ts-add-tool-name" };
  const _hoisted_23$3 = ["onClick"];
  const _hoisted_24$3 = { class: "ts-toolbar" };
  const _hoisted_25$2 = { class: "ts-toolbar-title" };
  const _hoisted_26$2 = { class: "ts-toolbar-count" };
  const _hoisted_27$2 = {
    key: 1,
    class: "ts-tools"
  };
  const _hoisted_28$2 = ["onClick", "title"];
  const _hoisted_29$2 = { class: "ts-tool-group" };
  const _hoisted_30$2 = ["title"];
  const _hoisted_31$2 = { class: "ts-tool-desc" };
  const _hoisted_32$2 = {
    key: 2,
    class: "ts-empty"
  };
  ...
  const _hoisted_34$2 = { class: "ts-detail-title" };
  const _hoisted_35$2 = { class: "ts-detail-count" };
  const _hoisted_36$2 = { class: "ts-tool-group" };
  const _hoisted_37$2 = { class: "ts-tool-desc" };
  const _hoisted_38$2 = { class: "ts-tool-group" };
  const _hoisted_39$2 = {
    key: 0,
    class: "ts-joined-badge"
  };
  const _hoisted_40$2 = { class: "ts-tool-desc" };
  const _hoisted_41$2 = {
    class: "dialog-box",
    style: { "max-width": "420px" }
  };
  const _hoisted_42$2 = { class: "dialog-body" };
  const _hoisted_43$2 = { class: "input-row" };
  const _hoisted_44$2 = { class: "dialog-footer" };
  const _hoisted_45$2 = {
    key: 0,
    class: "dlg-error"
  };
  const _hoisted_46$2 = ["disabled"];
  const _hoisted_47$2 = { class: "dialog-box dir-browser-box" };
  const _hoisted_48$2 = { class: "dialog-title" };
  const _hoisted_49$2 = { class: "dir-browser" };
  const _hoisted_50$2 = { class: "dir-breadcrumb" };
  const _hoisted_51$2 = ["disabled"];
  const _hoisted_52$2 = { class: "bc-path" };
  const _hoisted_53$2 = {
    key: 0,
    class: "dir-list"
  };
  const _hoisted_54$2 = ["onDblclick"];
  const _hoisted_55$2 = { class: "dir-name" };
  const _hoisted_56$2 = {
    key: 1,
    class: "dir-list"
  };
  const _hoisted_57$2 = ["onClick"];
  const _hoisted_58$2 = { class: "dir-name" };
  const _hoisted_59$2 = {
    key: 0,
    class: "dir-empty"
  };
  const _hoisted_60$2 = { class: "dialog-footer" };
  const _hoisted_61$2 = {
    key: 0,
    class: "dlg-error"
  };
  ...
  const _sfc_main$5 = {
    ...
    setup(__props) {
      ...
      const tsMetas = vue.ref([]);
      const tsDetail = vue.ref(null);
      const tsOpenDetail = vue.reactive({});
      const tsRefreshing = vue.ref(false);
      const tsAddOpen = vue.ref(false);
      ...
      const builtinGroups = vue.computed(() => {
        var _a;
      ...
      async function toggleTsDetail(name) {
        ...
        try {
          ...
          (_a = window.$toast) == null ? void 0 : _a.call(window, "加载工具集详情失败: " + (e.message || e), "error");
        }
      }
      function toggleTs() {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$5, [
          ...
          vue.createElementVNode("div", _hoisted_14$3, [
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode(
                "span",
                _hoisted_15$3,
                vue.toDisplayString(tsMetas.value.length) + " 工具集",
                1
                /* TEXT */
              ),
              _cache[15] || (_cache[15] = vue.createElementVNode(
              ...
              vue.createElementVNode("button", {
                class: "ts-mini-btn",
                onClick: vue.withModifiers(loadToolsets, ["stop"]),
                title: "刷新工具集"
              }, [
                vue.createVNode(SvgIcon, {
                  name: "refresh",
                  size: 11,
                  class: vue.normalizeClass({ spinning: tsRefreshing.value })
                }, null, 8, ["class"])
              ]),
              vue.createElementVNode("button", {
                class: "ts-mini-btn",
                onClick: _cache[2] || (_cache[2] = vue.withModifiers(($event) => tsAddOpen.value = !tsAddOpen.value, ["stop"])),
                title: "添加工具到工作区工具集（固化 .pair/toolsets/builtin.json）"
              }, [
                vue.createVNode(SvgIcon, {
                  name: "plus",
                  size: 12
            ...
            tsOpen.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_16$3, [
              vue.createCommentVNode(" 添加工具（从插件面板池子捞入工作区工具集，固化 .pair/toolsets/builtin.json） "),
              tsAddOpen.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_17$3, [
                _cache[16] || (_cache[16] = vue.createElementVNode(
                  "div",
                  { class: "ts-build-title" },
                  "添加工具到工作区工具集（固化 builtin.json；插件面板为池子，勾选=运行时可见）",
                  -1
                  /* CACHED */
                )),
                vue.withDirectives(vue.createElementVNode(
                  "input",
                  {
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => tsAddSearch.value = $event),
                    placeholder: "搜索工具名…",
                    class: "ts-input"
                  },
                  null,
                        ...
                        (vue.openBlock(true), vue.createElementBlock(
                          ...
                          vue.renderList(filterTools(g.tools), (t) => {
                            return vue.openBlock(), vue.createElementBlock("div", {
                              ...
                              vue.createElementVNode("button", {
                                class: vue.normalizeClass(["ts-btn mini", { added: joinedTools.value[t.name] }]),
                                onClick: ($event) => toggleToolsetTool(t)
                              }, vue.toDisplayString(joinedTools.value[t.name] ? "✓ 已加入" : "＋ 添加"), 11, _hoisted_23$3)
                            ], 8, _hoisted_21$3);
                          }),
                          128
                          /* KEYED_FRAGMENT */
              ...
              vue.createCommentVNode(" 工作区工具集列表（.pair/toolsets/*.json；工具集 = agent 可用工具集合） "),
              vue.createElementVNode("div", _hoisted_24$3, [
                vue.createElementVNode("span", _hoisted_25$2, [
                  ...
                  vue.createElementVNode(
                    "span",
                    _hoisted_26$2,
                    vue.toDisplayString(tsMetas.value.length),
                    1
                    /* TEXT */
                  )
                ])
              ]),
              tsMetas.value.length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_27$2, [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(tsMetas.value, (ts) => {
                    return vue.openBlock(), vue.createElementBlock("div", {
                      key: ts.name,
                      class: "ts-tool-row ts-ts-row",
                      onClick: ($event) => toggleTsDetail(ts.name),
                      title: "展开/收起：" + ts.name
                    }, [
                      vue.createElementVNode(
                        "span",
                        _hoisted_29$2,
                        vue.toDisplayString(ts.scope === "global" ? "全局" : "工作区"),
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode("span", {
                        class: "ts-tool-name",
                        title: ts.description || ts.name
                      }, vue.toDisplayString(ts.name), 9, _hoisted_30$2),
                      vue.createElementVNode(
                        "span",
                        _hoisted_31$2,
                        vue.toDisplayString(ts.pluginCount) + " 插件",
                        1
                        /* TEXT */
                      ),
                      vue.createVNode(SvgIcon, {
                        name: "chevron-right",
                        size: 10,
                        class: vue.normalizeClass(["ts-chevron", { open: tsOpenDetail[ts.name] }])
                      }, null, 8, ["class"])
                    ], 8, _hoisted_28$2);
                  }),
                  128
              ...
              ])) : !tsRefreshing.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_32$2, [..._cache[18] || (_cache[18] = [
                vue.createElementVNode(
                  "span",
                  null,
                  "暂无工具集。点「＋」添加工具到工作区工具集。",
              ...
              vue.createCommentVNode(" 展开：工具集详情（插件/分组 + 工具数） "),
              tsDetail.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_33$2, [
                vue.createElementVNode("div", _hoisted_34$2, [
                  ...
                  vue.createElementVNode(
                    "span",
                    _hoisted_35$2,
                    vue.toDisplayString((tsDetail.value.plugins || []).length || (tsDetail.value.groups || []).length) + " 条目",
                    1
                    /* TEXT */
                  )
                ]),
                  ...
                  vue.renderList(tsDetail.value.plugins || [], (pl) => {
                    return vue.openBlock(), vue.createElementBlock("div", {
                      ...
                      vue.createElementVNode(
                        "span",
                        _hoisted_37$2,
                        vue.toDisplayString((pl.tools || []).length) + " 工具",
                        1
                        /* TEXT */
                      )
                    ]);
                ...
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(tsDetail.value.groups || [], (g) => {
                    return vue.openBlock(), vue.createElementBlock("div", {
                      key: g.name,
                      class: "ts-detail-plugin"
                    }, [
                      vue.createElementVNode("span", _hoisted_38$2, [
                        vue.createTextVNode(
                          vue.toDisplayString(g.name),
                          1
                          /* TEXT */
                        ),
                        g.joined ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_39$2, "已加入")) : vue.createCommentVNode("v-if", true)
                      ]),
                      vue.createElementVNode(
                        "span",
                        _hoisted_40$2,
          ...
          showWorkspaceDialog.value ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            onClick: _cache[8] || (_cache[8] = vue.withModifiers(($event) => showWorkspaceDialog.value = false, ["self"]))
          }, [
            vue.createElementVNode("div", _hoisted_41$2, [
              ...
              vue.createElementVNode("div", _hoisted_42$2, [
                ...
                vue.withDirectives(vue.createElementVNode(
                  "input",
                  {
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => newWsName.value = $event),
                    class: "dlg-input",
                ...
                vue.createElementVNode("div", _hoisted_43$2, [
                  vue.withDirectives(vue.createElementVNode(
                    "input",
                    {
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => newWsPath.value = $event),
                  ...
                  vue.createElementVNode("button", {
                    class: "dlg-btn-sm",
                    onClick: _cache[6] || (_cache[6] = ($event) => openBrowseDialog("ws-path"))
                  }, "浏览")
                ])
              ]),
              vue.createElementVNode("div", _hoisted_44$2, [
                ...
                vue.createElementVNode("button", {
                  class: "dlg-btn",
                  onClick: _cache[7] || (_cache[7] = ($event) => showWorkspaceDialog.value = false)
                }, "取消"),
                vue.createElementVNode("button", {
          ...
          browseVisible.value ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            vue.createElementVNode("div", _hoisted_47$2, [
              ...
              vue.createElementVNode("div", _hoisted_49$2, [
                ...
                browsePath.value === "" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_53$2, [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                ...
                ])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_56$2, [
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                  ...
                  browseEntries.value.length === 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_59$2, "空目录")) : vue.createCommentVNode("v-if", true)
                ]))
              ]),
              vue.createElementVNode("div", _hoisted_60$2, [
                ...
                browseMode.value === "new" ? vue.withDirectives((vue.openBlock(), vue.createElementBlock(
                  ...
                  {
                    key: 1,
                    "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => newProjectName.value = $event),
                    class: "dlg-input",
  ...
  const FileExplorer = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f541f7aa"]]);
              ...
              vue.renderList(plugins.value, (p) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  vue.createElementVNode("div", {
                    ...
                    p.hasClient && p.clientApproved ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_53, "UI")) : p.hasClient && p.state === "running" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_54, "UI 待批准")) : p.hasClient ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_55, "UI")) : vue.createCommentVNode("v-if", true),
                    p.tools && p.tools.length ? (vue.openBlock(), vue.createElementBlock("span", {
                      key: 4,
                      class: "pp-count",
                      title: p.tools.join(", ")
                    }, vue.toDisplayString(p.tools.length) + " 工具", 9, _hoisted_56)) : vue.createCommentVNode("v-if", true),
                    p.hasClient && p.clientApproved && uiSlotsOf(p.name).length ? (vue.openBlock(), vue.createElementBlock(
                      vue.Fragment,
                      { key: 5 },
                      [
                        vue.createElementVNode(
                  ...
                  expanded[p.name] ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_59, [
                    ...
                    p.defId ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_61, [
                      vue.createTextVNode(
                    ...
                    p.tools && p.tools.length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_65, [
                      vue.createElementVNode(
                        "div",
                        _hoisted_66,
                        "工具（" + vue.toDisplayString(p.tools.length) + "）· 开关控制 agent 可见性",
                        1
                        /* TEXT */
                      ),
                      (vue.openBlock(true), vue.createElementBlock(
                        ...
                        vue.renderList(p.tools, (t) => {
                          return vue.openBlock(), vue.createElementBlock("div", {
                            ...
                            vue.createElementVNode("span", {
                              class: "pp-d-tname",
                              title: t
                            }, vue.toDisplayString(t), 9, _hoisted_67),
                            vue.createElementVNode("label", {
                              class: "pp-switch",
                              title: pluginToolOn(p, t) ? "对 agent 可见；点击禁用（不影响插件运行）" : "对 agent 不可见；点击启用"
                            }, [
                              vue.createElementVNode("input", {
                                type: "checkbox",
                    ...
                    p.clientCode ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_70, [
                    ...
                    vue.createElementVNode("div", _hoisted_73, [
                      ...
                      p.state === "running" ? (vue.openBlock(), vue.createElementBlock(
                        ...
                        { key: 0 },
                        [
                          !(p.hasClient && p.clientApproved && uiSlotsOf(p.name).length) ? (vue.openBlock(), vue.createElementBlock("button", {
                            key: 0,
                            class: "pp-btn",
                            title: "停止整个插件（其全部工具对 agent 不可见）；单工具请用上方工具开关",
                            onClick: ($event) => doAction(p, "stop")
                          }, "停止插件", 8, _hoisted_74)) : vue.createCommentVNode("v-if", true)
                        ],
                        64
                        /* STABLE_FRAGMENT */
                      ...
                      }, "删除定义", 8, _hoisted_76)) : vue.createCommentVNode("v-if", true)
                    ])
                  ])) : vue.createCommentVNode("v-if", true)
                ]);
              }),
