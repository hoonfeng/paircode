...
删除后它们仍可继续聊天（配置是完整快照），但在对话面板里会失去模型分组；建议先在「AI 配置」里把它们改选到其他服务商。`),!window.confirm(E))return;const b=G();delete b[V.name];try{await A.saveModels(b),await S(),n("saved")}catch(T){f.value="删除失败: "+(T.message||T)}}function F(V){const p=l.value.find(T=>T.name===V);if(!p)return"";const E=Object.keys(p.modelParams||{}).length,b=[];return p.temperature&&b.push("温度 "+p.temperature),p.maxTokens>0&&b.push("输出上限 "+p.maxTokens),E&&b.push("模型参数 "+E+" 个"),b.join(" · ")}return(V,p)=>(e.openBlock(),e.createElementBlock("div",nn,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",tn,[e.createElementVNode("span",rn,e.toDisplayString(l.value.length)+" 个服务商",1),e.createElementVNode("button",{class:"pm-btn pm-primary",onClick:u},"+ 新增服务商")]),e.createCommentVNode(" 新增表单（工具栏下方展开，紧邻按钮不跳动） "),a.value==="__new__"?(e.openBlock(),e.createElementBlock("div",on,[p[18]||(p[18]=e.createElementVNode("div",{class:"pm-edit-title"},"新增服务商",-1)),e.createElementVNode("div",ln,[p[12]||(p[12]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[0]||(p[0]=E=>s.value.name=E),placeholder:"如 deepseek"},null,512),[[e.vModelText,s.value.name]])]),e.createElementVNode("div",an,[p[13]||(p[13]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[1]||(p[1]=E=>s.value.baseURL=E),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,s.value.baseURL]])]),e.createElementVNode("div",sn,[e.createElementVNode("span",cn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":p[2]||(p[2]=E=>s.value.protocol=E),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,E=>(e.openBlock(),e.createElementBlock("option",{key:"p"+E,value:E},e.toDisplayString(E||"默认"),9,pn))),128))],8,dn),[[e.vModelSelect,s.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",mn,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",gn,[p[14]||(p[14]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[3]||(p[3]=E=>s.value.contextMaxTokens=E),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,s.value.contextMaxTokens]])]),e.createElementVNode("div",kn,[p[15]||(p[15]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[4]||(p[4]=E=>s.value.temperature=E),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,s.value.temperature]])]),e.createElementVNode("div",hn,[p[16]||(p[16]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[5]||(p[5]=E=>s.value.maxTokens=E),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,s.value.maxTokens]])]),e.createVNode(Te,{models:d.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:I},null,8,["models","label","placeholder"]),e.createElementVNode("div",fn,[p[17]||(p[17]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),d.value.length?(e.openBlock(),e.createElementBlock("div",yn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,E=>(e.openBlock(),e.createElementBlock("div",{key:E,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:E},e.toDisplayString(E),9,un),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,b=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:b.name},[b.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:b.hint||b.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":T=>i.value[E][b.name]=T},null,8,En),[[e.vModelCheckbox,i.value[E][b.name]]]),e.createTextVNode(" "+e.toDisplayString(b.label),1)],8,bn)):b.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":T=>i.value[E][b.name]=T,title:b.hint||b.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(b.options||[],T=>(e.openBlock(),e.createElementBlock("option",{key:"o"+T,value:T},e.toDisplayString(T===""?b.label+"默认":T),9,Vn))),128))],8,xn)),[[e.vModelSelect,i.value[E][b.name]]]):b.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":T=>i.value[E][b.name]=T,type:"number",min:b.min??0,step:b.step??1,placeholder:b.label,title:b.hint||b.label},null,8,Nn)),[[e.vModelText,i.value[E][b.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":T=>i.value[E][b.name]=T,type:"text",placeholder:b.label,title:b.hint||b.label},null,8,wn)),[[e.vModelText,i.value[E][b.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",Bn,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",Tn,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:k.value,onClick:z},e.toDisplayString(k.value?"保存中…":"保存服务商"),9,Sn),e.createElementVNode("button",{class:"pm-btn",onClick:L},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 服务商卡片列表（编辑时在卡片位置就地展开表单，不跳顶） "),l.value.length?(e.openBlock(),e.createElementBlock("div",Cn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(l.value,E=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:E.name},[a.value===E.name?(e.openBlock(),e.createElementBlock("div",In,[e.createElementVNode("div",Pn,"编辑服务商："+e.toDisplayString(E.name),1),e.createElementVNode("div",An,[p[19]||(p[19]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[6]||(p[6]=b=>s.value.name=b),placeholder:"如 deepseek"},null,512),[[e.vModelText,s.value.name]]),p[20]||(p[20]=e.createElementVNode("span",{class:"pm-hint"},"改名会一并同步引用该服务商的 AI 配置（连接信息不丢）；空=保持原名",-1))]),e.createElementVNode("div",$n,[p[21]||(p[21]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[7]||(p[7]=b=>s.value.baseURL=b),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,s.value.baseURL]])]),e.createElementVNode("div",Mn,[e.createElementVNode("span",Dn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":p[8]||(p[8]=b=>s.value.protocol=b),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,b=>(e.openBlock(),e.createElementBlock("option",{key:"p"+b,value:b},e.toDisplayString(b||"默认"),9,Ln))),128))],8,Rn),[[e.vModelSelect,s.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",Fn,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",Gn,[p[22]||(p[22]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[9]||(p[9]=b=>s.value.contextMaxTokens=b),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,s.value.contextMaxTokens]])]),e.createElementVNode("div",On,[p[23]||(p[23]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[10]||(p[10]=b=>s.value.temperature=b),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,s.value.temperature]])]),e.createElementVNode("div",zn,[p[24]||(p[24]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[11]||(p[11]=b=>s.value.maxTokens=b),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,s.value.maxTokens]])]),e.createVNode(Te,{models:d.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:I},null,8,["models","label","placeholder"]),e.createElementVNode("div",Un,[p[25]||(p[25]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),d.value.length?(e.openBlock(),e.createElementBlock("div",jn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,b=>(e.openBlock(),e.createElementBlock("div",{key:b,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:b},e.toDisplayString(b),9,Hn),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,T=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:T.name},[T.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:T.hint||T.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":g=>i.value[b][T.name]=g},null,8,qn),[[e.vModelCheckbox,i.value[b][T.name]]]),e.createTextVNode(" "+e.toDisplayString(T.label),1)],8,Wn)):T.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":g=>i.value[b][T.name]=g,title:T.hint||T.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(T.options||[],g=>(e.openBlock(),e.createElementBlock("option",{key:"o"+g,value:g},e.toDisplayString(g===""?T.label+"默认":g),9,Kn))),128))],8,Jn)),[[e.vModelSelect,i.value[b][T.name]]]):T.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":g=>i.value[b][T.name]=g,type:"number",min:T.min??0,step:T.step??1,placeholder:T.label,title:T.hint||T.label},null,8,Zn)),[[e.vModelText,i.value[b][T.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":g=>i.value[b][T.name]=g,type:"text",placeholder:T.label,title:T.hint||T.label},null,8,Qn)),[[e.vModelText,i.value[b][T.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",_n,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",Yn,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:k.value,onClick:z},e.toDisplayString(k.value?"保存中…":"保存服务商"),9,Xn),e.createElementVNode("button",{class:"pm-btn",onClick:L},"取消")])])):(e.openBlock(),e.createElementBlock("div",vn,[e.createElementVNode("div",et,[e.createElementVNode("span",{class:"pm-name",title:E.name},e.toDisplayString(E.name),9,nt),e.createElementVNode("div",tt,[e.createElementVNode("button",{class:"pm-btn pm-small",onClick:b=>C(E)},"编辑",8,rt),e.createElementVNode("button",{class:"pm-btn pm-small pm-danger",onClick:b=>j(E)},"删除",8,ot)])]),e.createElementVNode("div",{class:"pm-url",title:E.baseURL},e.toDisplayString(E.baseURL||"未配置 API URL"),9,lt),E.protocol?(e.openBlock(),e.createElementBlock("div",{key:0,class:"pm-protocol",title:r.protocolHint},"协议 "+e.toDisplayString(E.protocol),9,at)):e.createCommentVNode("v-if",!0),e.createElementVNode("div",st,e.toDisplayString(E.contextMaxTokens>0?"上下文 "+(E.contextMaxTokens/1e3).toFixed(0)+"K Token":"上下文 未限制"),1),e.createElementVNode("div",it,[E.models.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("span",ct,"（未配置模型）")),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(E.models,b=>(e.openBlock(),e.createElementBlock("span",{key:b,class:"pm-tag"},e.toDisplayString(b),1))),128))]),F(E.name)?(e.openBlock(),e.createElementBlock("div",dt,e.toDisplayString(F(E.name)),1)):e.createCommentVNode("v-if",!0)]))],64))),128))])):a.value!=="__new__"?(e.openBlock(),e.createElementBlock("div",pt,"暂无服务商，点「+ 新增服务商」添加")):e.createCommentVNode("v-if",!0),f.value?(e.openBlock(),e.createElementBlock("div",mt,e.toDisplayString(f.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-9f62208c"]]),kt={class:"pm-manager"},ht={class:"mgm-toolbar"},ft={class:"mgm-count"},yt={key:0,class:"mgm-edit"},ut={class:"mgm-edit-title"},bt={class:"mgm-field"},Et={class:"mgm-field-label"},xt={key:0,class:"mgm-required"},Vt=["onUpdate:modelValue","onChange"],Nt=["value"],wt=["onUpdate:modelValue","placeholder"],Bt=["onUpdate:modelValue","placeholder"],Tt={key:3,class:"mgm-field-hint"},St={class:"mgm-edit-actions"},Ct=["disabled"],It={key:1,class:"mgm-cards"},Pt={class:"mgm-card-head"},At=["title"],$t={key:0,class:"pm-active-badge"},Mt={class:"mgm-ops"},Dt=["disabled","onClick"],Rt=["onClick"],Lt=["onClick"],Ft={class:"pm-preview"},Gt={class:"pm-snap-row"},Ot={class:"pm-snap-row"},zt={key:2,class:"mgm-empty"},Ut={key:3,class:"mgm-error"},jt=U({__name:"PresetManager",props:{presetFields:{type:Array,default:()=>[]}},emits:["saved"],setup(r,{expose:t,emit:n}){const o=r,l=n,a=e.ref({}),s=e.computed(()=>Object.keys(a.value||{})),d=e.ref(""),i=e.ref(!1),f=e.ref(""),k=e.ref(!1),B=e.ref(""),w=e.ref(""),S=e.ref(null),u=e.computed(()=>S.value&&S.value.providers||[]),C=e.ref({name:"",provider:"",baseURL:"",apiKey:""});function I(g={}){const m={name:"",provider:"",baseURL:"",apiKey:""};for(const y of o.presetFields)y.name in m||(m[y.name]="");return Object.assign(m,g)}function L(g){w.value=g,setTimeout(()=>{w.value===g&&(w.value="")},4e3)}async function G(){try{const[g,m,y]=await Promise.all([A.getAiPresets().catch(()=>({presets:{}})),A.apiGet("/settings").catch(()=>({settings:{}})),A.getModels().catch(()=>null)]);a.value=g&&g.presets||{},d.value=m&&m.settings&&m.settings.preset||"",S.value=y}catch(g){L("加载失败: "+(g.message||g))}}function z(g){const m=S.value||{};return{baseURL:m.providerBaseURLs&&m.providerBaseURLs[g]||"",models:m.models&&m.models[g]||[]}}function H(){const g=window&&window.__PAIRCODE_CORE&&window.__PAIRCODE_CORE.uiState&&window.__PAIRCODE_CORE.uiState.state&&window.__PAIRCODE_CORE.uiState.state.settings||{};let m={};g.preset&&a.value&&a.value[g.preset]&&(m=a.value[g.preset]);const y=m.provider||u.value[0]||"",h=z(y);C.value=I({provider:y,baseURL:m.baseURL||h.baseURL||"",apiKey:m.apiKey||""}),f.value="",i.value=!0}function j(g){const m=a.value&&a.value[g]||{};C.value=I({name:g,provider:m.provider||"",baseURL:m.baseURL||"",apiKey:m.apiKey||""}),f.value=g,i.value=!0}function F(){i.value=!1,f.value=""}function V(g){return g.source==="providers"?u.value||[]:g.options||[]}function p(g){if(g.name==="provider"&&C.value.provider){const m=z(C.value.provider);C.value.baseURL=m.baseURL||""}}e.watch(()=>C.value.provider,(g,m)=>{!i.value||m===""||g!==m&&p({name:"provider"})});async function E(){const g=C.value.name.trim();if(!g){L("请输入配置名称");return}const m=C.value.provider||"";if(!m){L("请选择服务商");return}for(const h of o.presetFields)if(h.required&&!C.value[h.name]){L("请填写"+h.label);return}const y=z(m);C.value.baseURL||(C.value.baseURL=y.baseURL||""),k.value=!0,w.value="";try{const h={provider:m,baseURL:C.value.baseURL,apiKey:C.value.apiKey};for(const c of o.presetFields)c.name!=="provider"&&c.name!=="apiKey"&&(h[c.name]=C.value[c.name]);if(f.value&&f.value!==g){const c={...a.value||{}};c[g]=h,delete c[f.value];const N=await A.saveAiPresets(c);if(!(N&&N.ok)){L(N&&N.error||"保存失败");return}a.value=c,d.value===f.value&&(d.value=g,await A.apiPut("/settings",{settings:{preset:g},pluginSettings:{}}).catch(()=>{}))}else{const c=await A.saveAiPreset("save",g,h);if(!(c&&c.ok)){L(c&&c.error||"保存失败");return}a.value=c.presets||a.value}F(),l("saved")}catch(h){L("保存失败: "+(h.message||h))}finally{k.value=!1}}async function b(g){B.value=g,w.value="";try{const m=await A.saveAiPreset("apply",g);m&&m.ok?(d.value=g,l("saved")):L(m&&m.error||"应用失败")}catch(m){L("应用失败: "+(m.message||m))}finally{B.value=""}}async function T(g){if(confirm("删除配置「"+g+"」？")){w.value="";try{const m=await A.saveAiPreset("delete",g);m&&m.ok?(a.value=m.presets||a.value,d.value===g&&(d.value=""),l("saved")):L(m&&m.error||"删除失败")}catch(m){L("删除失败: "+(m.message||m))}}}return e.onMounted(G),t({load:G}),(g,m)=>(e.openBlock(),e.createElementBlock("div",kt,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",ht,[e.createElementVNode("span",ft,e.toDisplayString(s.value.length)+" 个配置",1),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:H,title:"添加一条 AI 配置（服务商 + API Key）"},"＋ 添加新配置")]),e.createCommentVNode(" 添加 / 编辑表单（点击添加/编辑才弹出） "),i.value?(e.openBlock(),e.createElementBlock("div",yt,[e.createElementVNode("div",ut,e.toDisplayString(f.value?"编辑配置："+f.value:"添加新配置"),1),e.createElementVNode("div",bt,[m[1]||(m[1]=e.createElementVNode("span",{class:"mgm-field-label"},"配置名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":m[0]||(m[0]=y=>C.value.name=y),type:"text",placeholder:"如：主力 / 写作备用…",onKeydown:e.withKeys(E,["enter"])},null,544),[[e.vModelText,C.value.name]])]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.presetFields,y=>(e.openBlock(),e.createElementBlock("div",{key:y.name,class:"mgm-field"},[e.createElementVNode("span",Et,[e.createTextVNode(e.toDisplayString(y.label),1),y.required?(e.openBlock(),e.createElementBlock("span",xt,"*")):e.createCommentVNode("v-if",!0)]),e.createCommentVNode(" select 类型（服务商选择） "),y.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:0,"onUpdate:modelValue":h=>C.value[y.name]=h,class:"mgm-select",onChange:h=>p(y)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(V(y),h=>(e.openBlock(),e.createElementBlock("option",{key:h,value:h},e.toDisplayString(h),9,Nt))),128))],40,Vt)),[[e.vModelSelect,C.value[y.name]]]):y.type==="password"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" password 类型（API Key） "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":h=>C.value[y.name]=h,type:"password",placeholder:y.placeholder||""},null,8,wt),[[e.vModelText,C.value[y.name]]])],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" text 兜底 "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":h=>C.value[y.name]=h,type:"text",placeholder:y.placeholder||""},null,8,Bt),[[e.vModelText,C.value[y.name]]])],2112)),y.hint?(e.openBlock(),e.createElementBlock("span",Tt,e.toDisplayString(y.hint),1)):e.createCommentVNode("v-if",!0)]))),128)),e.createElementVNode("div",St,[e.createElementVNode("button",{class:"mgm-btn mgm-primary",disabled:k.value,onClick:E},e.toDisplayString(k.value?"保存中…":"保存配置"),9,Ct),e.createElementVNode("button",{class:"mgm-btn",onClick:F},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 配置卡片列表（主视图） "),s.value.length?(e.openBlock(),e.createElementBlock("div",It,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(s.value,y=>(e.openBlock(),e.createElementBlock("div",{key:y,class:e.normalizeClass(["mgm-card",{"pm-active":y===d.value}])},[e.createElementVNode("div",Pt,[e.createElementVNode("span",{class:"mgm-name",title:y},[e.createTextVNode(e.toDisplayString(y),1),y===d.value?(e.openBlock(),e.createElementBlock("span",$t,"使用中")):e.createCommentVNode("v-if",!0)],8,At),e.createElementVNode("div",Mt,[e.createElementVNode("button",{class:"mgm-btn mgm-small",disabled:B.value===y,onClick:h=>b(y)},e.toDisplayString(B.value===y?"应用中…":"应用"),9,Dt),e.createElementVNode("button",{class:"mgm-btn mgm-small",onClick:h=>j(y)},"编辑",8,Rt),e.createElementVNode("button",{class:"mgm-btn mgm-small mgm-danger",onClick:h=>T(y)},"删除",8,Lt)])]),e.createElementVNode("div",Ft,[e.createElementVNode("div",Gt,[m[2]||(m[2]=e.createElementVNode("span",null,"服务商",-1)),e.createElementVNode("b",null,e.toDisplayString((a.value[y]||{}).provider||"—"),1)]),e.createElementVNode("div",Ot,[m[3]||(m[3]=e.createElementVNode("span",null,"API Key",-1)),e.createElementVNode("b",null,e.toDisplayString((a.value[y]||{}).apiKey?"已配置":"未配置"),1)])])],2))),128))])):i.value?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",zt,[e.createElementVNode("div",{class:"mgm-empty-box"},[m[4]||(m[4]=e.createElementVNode("div",{class:"mgm-empty-title"},"还没有 AI 配置",-1)),m[5]||(m[5]=e.createElementVNode("div",{class:"mgm-empty-sub"},"添加一条服务商 + API Key，保存后即可在对话面板中选模型。",-1)),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:H},"＋ 添加新配置")])])),w.value?(e.openBlock(),e.createElementBlock("div",Ut,e.toDisplayString(w.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-3e18e523"]]),Ht={class:"modal-content"},Wt={class:"modal-head"},qt={class:"mh-text"},Jt={class:"mh-title"},Kt={class:"mh-sub"},Zt={class:"modal-body"},Qt={key:0,class:"settings-tabs"},_t={key:0,class:"settings-tabs-filter-wrap"},Yt=["onClick"],Xt={class:"st-label"},vt={key:1,class:"settings-tabs-none"},er={class:"settings-content"},nr={key:0},tr={key:0,class:"group-title"},rr=["title"],or=["title"],lr=["onUpdate:modelValue"],ar=["title"],sr={class:"field-control"},ir=["type","onUpdate:modelValue","placeholder"],cr=["onUpdate:modelValue","min","max","step"],dr=["onUpdate:modelValue","onChange"],pr=["value"],mr={class:"theme-gallery"},gr=["title","onClick"],kr={class:"tg-preview"},hr={class:"tg-text"},fr={class:"tg-label"},yr={key:0,class:"tg-desc"},ur={class:"color-dots"},br=["title","onClick"],Er=["onUpdate:modelValue","placeholder"],xr={class:"slider-row"},Vr=["onUpdate:modelValue","min","max","step"],Nr={class:"slider-val"},wr={class:"color-row"},Br=["onUpdate:modelValue"],Tr={class:"color-code"},Sr=["value","onInput","placeholder"],Cr=["placeholder"],Ir=["onUpdate:modelValue"],Pr={key:0,class:"setting-hint"},Ar={key:0,class:"settings-empty"},$r=U({__name:"SettingsModal",emits:["close"],setup(r,{emit:t}){const n=t,o=e.ref(""),l=e.ref(""),a=e.computed(()=>{const g=(x.state.pluginSchemas||[]).map(m=>({key:m.key,title:m.title||m.key,groups:d(m.fields||[])}));return g.length&&!o.value&&(o.value=g[0].key),g}),s=e.computed(()=>{const g=l.value.trim().toLowerCase();if(!g)return a.value;const m=a.value.find(h=>h.key===o.value),y=a.value.filter(h=>(h.title||h.key).toLowerCase().includes(g));return m&&!y.includes(m)&&y.unshift(m),y});function d(g){const m=[],y={};for(const h of g){const c=h.group||"";y[c]||(y[c]=[],m.push({title:c,fields:y[c]})),y[c].push(h)}return m}const i=e.ref(null);let f="";async function k(){try{i.value=await A.getModels()}catch{i.value=null}}function B(g){return g?(i.value&&i.value.models||{})[g]||[]:[]}function w(g,m){var y,h,c;if(m.optionsSource==="models"){const N=(y=u[g])==null?void 0:y[m.name],M=B((h=u.ai)==null?void 0:h.provider);return N&&!M.includes(N)?[...M,N]:M}if(m.optionsSource==="providers"){const N=i.value&&i.value.providers||[];if(N.length){const M=(c=u[g])==null?void 0:c[m.name];return M&&!N.includes(M)?[...N,M]:N}return m.options||[]}return m.options||[]}function S(g){if(!u.ai)return;const m=u.ai,y=g.linkFields||(g.linkField?[g.linkField]:[]);if(!y.length)return;const h=i.value||{},c=h.providerBaseURLs||{},N=h.providerKeys||{},M=m.provider,Q=c[f];for(const pe of y)if(pe==="apiKey")m[pe]=N[M]||"";else{const Ve=m[pe];(Ve===void 0||Ve===""||Q&&Ve===Q)&&(m[pe]=c[M]||"")}f=M}const u=e.reactive({}),C=e.ref("");function I(g){return Array.isArray(g.swatches)&&g.swatches.length?g.swatches:(g.options||[]).map(m=>({value:m,label:m,colors:[]}))}function L(g){switch(g){case"checkbox":return!1;case"number":return 0;case"tags":return[];default:return""}}function G(){for(const h of Object.keys(u))delete u[h];const g=x.state.settings||{};f=g.provider||"";const m=g.pluginSettings||{};for(const h of x.state.pluginSchemas||[]){u[h.key]={};for(const c of h.fields||[]){let N;if(!(c.type==="project"||c.type==="provider-manager"||c.type==="model-params-manager"||c.type==="preset-manager")){if(c.binding)N=g[c.binding]!==void 0?g[c.binding]:c.default;else{const M=m[h.key]||{};N=M[c.name]!==void 0?M[c.name]:c.default}N===void 0&&(N=L(c.type)),c.type==="checkbox"&&(N=!!N),c.type==="number"&&(N=typeof N=="number"?N:Number(N)||0),c.type==="tags"&&(N=Array.isArray(N)?N:[]),u[h.key][c.name]=N}}}const y=(x.state.pluginSchemas||[]).some(h=>(h.fields||[]).some(c=>c.type==="project"));C.value="",y&&j()}function z(g,m){var h;const y=(h=u[g])==null?void 0:h[m.name];return Array.isArray(y)?y.join(", "):y||""}function H(g,m,y){u[g][m.name]=y.target.value.split(",").map(h=>h.trim()).filter(Boolean)}async function j(){try{const g=await A.getInstructions("project");C.value=g.content||""}catch{}}function F(){var g;G(),(g=x.state.settings)!=null&&g.theme&&x.applyTheme(x.state.settings.theme)}const V=()=>{F()},p=e.ref(0);async function E(){await k(),p.value++}async function b(){try{const g=await A.apiGet("/settings");g&&g.settings&&(x.state.settings=g.settings,await k(),F())}catch{}}const T=async()=>{try{let g={};try{const c=await A.apiGet("/settings");g=c&&c.settings||{}}catch{}const m={...g},y={...g.pluginSettings||{}};let h=!1;for(const c of x.state.pluginSchemas||[]){const N=u[c.key]||{};for(const M of c.fields||[]){if(M.type==="project"){await A.saveInstructions("project",C.value);continue}if(M.type==="provider-manager"||M.type==="model-params-manager"||M.type==="preset-manager")continue;const Q=N[M.name];M.binding?(M.name==="theme"&&Q!==m[M.binding]&&(h=!0),m[M.binding]=Q):(y[c.key]||(y[c.key]={}),y[c.key][M.name]=Q)}}await A.apiPut("/settings",{settings:m,pluginSettings:y}),x.state.settings=m,h&&x.applyTheme(m.theme),window.$toast("设置已保存","success"),n("close")}catch(g){window.$toast("保存失败: "+g.message,"error")}};return G(),e.onMounted(async()=>{await k(),F()}),(g,m)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:m[3]||(m[3]=e.withModifiers(y=>g.$emit("close"),["self"]))},[e.createElementVNode("div",Ht,[e.createCommentVNode(` ★ 2026-09-24 对齐设计稿 appearance-theme th782（头部 = 标题 + 副标题两行）：
           副标题显示**当前分类名**（真实数据，非装饰文案）。 `),e.createElementVNode("div",Wt,[e.createElementVNode("div",qt,[e.createElementVNode("div",Jt,[e.createVNode(R,{name:"settings",size:16}),m[4]||(m[4]=e.createTextVNode(" 设置",-1))]),e.createElementVNode("div",Kt,e.toDisplayString((a.value.find(y=>y.key===o.value)||{}).title||"所有分类"),1)]),e.createElementVNode("button",{class:"modal-close",onClick:m[0]||(m[0]=y=>g.$emit("close"))},"×")]),e.createElementVNode("div",Zt,[e.createCommentVNode(" ═══ 纯 schema 驱动：所有配置 tab 由插件 ctx.registerSettings 注册 ═══ "),a.value.length?(e.openBlock(),e.createElementBlock("div",Qt,[e.createCommentVNode(" 设计稿 th783：分组标题「设置分类」 "),m[5]||(m[5]=e.createElementVNode("div",{class:"settings-tabs-title"},"设置分类",-1)),a.value.length>6?(e.openBlock(),e.createElementBlock("div",_t,[e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":m[1]||(m[1]=y=>l.value=y),class:"settings-tabs-filter",type:"text",placeholder:"筛选设置…"},null,512),[[e.vModelText,l.value]])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 设计稿 th755-th773：项 32 高 / radius 8 / 前置图标（选中态=check） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(s.value,y=>(e.openBlock(),e.createElementBlock("button",{key:y.key,class:e.normalizeClass(["settings-tab",{active:o.value===y.key}]),onClick:h=>o.value=y.key},[e.createVNode(R,{name:o.value===y.key?"check":"chevron-right",size:14},null,8,["name"]),e.createElementVNode("span",Xt,e.toDisplayString(y.title),1)],10,Yt))),128)),s.value.length===0?(e.openBlock(),e.createElementBlock("div",vt,"无匹配设置")):e.createCommentVNode("v-if",!0)])):e.createCommentVNode("v-if",!0),e.createElementVNode("div",er,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(a.value,y=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:y.key},[o.value===y.key?(e.openBlock(),e.createElementBlock("div",nr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(y.groups,h=>(e.openBlock(),e.createElementBlock("div",{key:h.title||"__main",class:"setting-group"},[h.title?(e.openBlock(),e.createElementBlock("div",tr,e.toDisplayString(h.title),1)):e.createCommentVNode("v-if",!0),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(h.fields,c=>(e.openBlock(),e.createElementBlock("div",{key:c.name,class:e.normalizeClass(["setting-row",{"row-toggle":c.type==="checkbox"}])},[e.createCommentVNode(" checkbox：label 与开关同行 "),c.type==="checkbox"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:0},[e.createElementVNode("label",{class:"field-label",title:c.hint},e.toDisplayString(c.label),9,rr),e.createElementVNode("label",{class:"pp-switch",title:c.hint},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":N=>u[y.key][c.name]=N},null,8,lr),[[e.vModelCheckbox,u[y.key][c.name]]]),m[6]||(m[6]=e.createElementVNode("span",{class:"pp-switch-track"},null,-1))],8,or)],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" 其他类型：label 在上、控件在下、说明文字在控件下方（不挤占输入区） "),e.createElementVNode("label",{class:"field-label",title:c.hint},e.toDisplayString(c.label),9,ar),e.createElementVNode("div",sr,[e.createCommentVNode(" text / password "),c.type==="text"||c.type==="password"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:0,class:"field-input",type:c.type==="password"?"password":"text","onUpdate:modelValue":N=>u[y.key][c.name]=N,placeholder:c.placeholder},null,8,ir)),[[e.vModelDynamic,u[y.key][c.name]]]):c.type==="number"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" number "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"number","onUpdate:modelValue":N=>u[y.key][c.name]=N,min:c.min,max:c.max,step:c.step},null,8,cr),[[e.vModelText,u[y.key][c.name],void 0,{number:!0}]])],2112)):c.type==="select"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" select（optionsSource 驱动动态数据源：models=按服务商模型列表 / providers=服务商列表） "),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":N=>u[y.key][c.name]=N,class:"field-select",onChange:N=>S(c)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(w(y.key,c),N=>(e.openBlock(),e.createElementBlock("option",{key:N,value:N},e.toDisplayString(N),9,pr))),128))],40,dr),[[e.vModelSelect,u[y.key][c.name]]])],2112)):c.type==="theme-gallery"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:3},[e.createCommentVNode(` theme-gallery（主题画廊：缩略色卡选择）
                           ★ 值仍是 string 主题 id，binding 直连 AppSettings.theme —— 与 select 同数据模型，
                             仅换一种更直观的呈现（色卡 + 明暗标识）。无联动字段故不调 onSelectChange。 `),e.createElementVNode("div",mr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(I(c),N=>(e.openBlock(),e.createElementBlock("button",{key:N.value,type:"button",class:e.normalizeClass(["tg-item",{active:u[y.key][c.name]===N.value}]),title:N.label,onClick:M=>u[y.key][c.name]=N.value},[e.createCommentVNode(" 设计稿 th584：预览区 48 高（主题代表色横向平铺） "),e.createElementVNode("span",kr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(N.colors,(M,Q)=>(e.openBlock(),e.createElementBlock("i",{key:Q,style:e.normalizeStyle({background:M})},null,4))),128))]),e.createElementVNode("span",hr,[e.createElementVNode("span",fr,e.toDisplayString(N.label),1),e.createCommentVNode(` ★ 2026-09-25：定位文案（设计稿每张卡 = 预览 + 名称 + 一句定位，
                                 如「默认暗色，久看不累」）。由插件 swatches[].desc 提供。 `),N.desc?(e.openBlock(),e.createElementBlock("span",yr,e.toDisplayString(N.desc),1)):e.createCommentVNode("v-if",!0)])],10,gr))),128))])],2112)):c.type==="color-dots"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:4},[e.createCommentVNode(` color-dots（色点选择：强调色覆盖等 —— 圆点 + 选中描边，悬停看名称）
                           ★ 值仍是 string，与 select / theme-gallery 同数据模型，仅换呈现形态。 `),e.createElementVNode("div",ur,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(I(c),N=>(e.openBlock(),e.createElementBlock("button",{key:N.value,type:"button",class:e.normalizeClass(["cd-item",{active:String(u[y.key][c.name]||"")===N.value}]),title:N.label,onClick:M=>u[y.key][c.name]=N.value},[e.createElementVNode("i",{class:"cd-dot",style:e.normalizeStyle({background:N.colors&&N.colors[0]||"transparent"})},null,4)],10,br))),128))])],2112)):c.type==="textarea"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:5},[e.createCommentVNode(" textarea "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":N=>u[y.key][c.name]=N,class:"field-textarea",rows:"4",placeholder:c.placeholder},null,8,Er),[[e.vModelText,u[y.key][c.name]]])],2112)):c.type==="slider"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:6},[e.createCommentVNode(" slider "),e.createElementVNode("div",xr,[e.withDirectives(e.createElementVNode("input",{type:"range","onUpdate:modelValue":N=>u[y.key][c.name]=N,min:c.min!=null?c.min:0,max:c.max!=null?c.max:100,step:c.step||1},null,8,Vr),[[e.vModelText,u[y.key][c.name],void 0,{number:!0}]]),e.createElementVNode("span",Nr,e.toDisplayString(u[y.key][c.name]),1)])],2112)):c.type==="color"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:7},[e.createCommentVNode(" color "),e.createElementVNode("div",wr,[e.withDirectives(e.createElementVNode("input",{type:"color","onUpdate:modelValue":N=>u[y.key][c.name]=N},null,8,Br),[[e.vModelText,u[y.key][c.name]]]),e.createElementVNode("code",Tr,e.toDisplayString(u[y.key][c.name]),1)])],2112)):c.type==="tags"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:8},[e.createCommentVNode(" tags（逗号分隔数组） "),e.createElementVNode("input",{type:"text",class:"field-input",value:z(y.key,c),onInput:N=>H(y.key,c,N),placeholder:c.placeholder||"逗号分隔"},null,40,Sr)],2112)):c.type==="project"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:9},[e.createCommentVNode(" project（平台特殊：项目级指令，经 /api/instructions 读写） "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":m[2]||(m[2]=N=>C.value=N),class:"field-textarea",rows:"4",placeholder:c.placeholder},null,8,Cr),[[e.vModelText,C.value]])],2112)):c.type==="provider-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:10},[e.createCommentVNode(" provider-manager（服务商维护面板：CRUD /api/models，独立保存，不参与普通表单） "),e.createVNode(gt,{"model-param-fields":c.modelParamFields||[],"model-editor":c.modelEditor||{},"protocol-label":c.protocolLabel||"LLM 协议","protocol-options":c.protocolOptions||[],"protocol-hint":c.protocolHint||"",onSaved:E},null,8,["model-param-fields","model-editor","protocol-label","protocol-options","protocol-hint"])],2112)):c.type==="preset-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:11},[e.createCommentVNode(" preset-manager（AI 配置预设面板：CRUD /api/ai-presets，独立保存，不参与普通表单） "),(e.openBlock(),e.createBlock(jt,{key:p.value,"preset-fields":c.presetFields||[],onSaved:b},null,8,["preset-fields"]))],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:12},[e.createCommentVNode(" 兜底 text "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"text","onUpdate:modelValue":N=>u[y.key][c.name]=N},null,8,Ir),[[e.vModelText,u[y.key][c.name]]])],2112))]),c.hint?(e.openBlock(),e.createElementBlock("span",Pr,e.toDisplayString(c.hint),1)):e.createCommentVNode("v-if",!0)],64))],2))),128))]))),128))])):e.createCommentVNode("v-if",!0)],64))),128)),a.value.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",Ar,"暂无配置项（等待插件注册…）"))])]),e.createCommentVNode(` ★ 2026-09-24 对齐设计稿 th790（底 48：说明 + 信息）：左侧补说明文本，
           与「撤销 / 保存设置」按钮同行（设计稿未画按钮，但 schema 驱动需显式保存）。 `),e.createElementVNode("div",{class:"modal-footer"},[m[7]||(m[7]=e.createElementVNode("span",{class:"mf-note"},"配置项由插件注册，修改后点「保存设置」生效",-1)),e.createElementVNode("button",{class:"btn-secondary",onClick:V},"撤销"),e.createElementVNode("button",{class:"btn-primary",onClick:T},"保存设置")])])]))}},[["__scopeId","data-v-062893bb"]]),Mr={class:"modal-content sys-modal"},Dr={class:"modal-header"},Rr={class:"modal-body"},Lr={key:0,class:"loading"},Fr={key:1,class:"sys-info"},Gr={class:"info-row"},Or={class:"info-row"},zr={class:"info-row"},Ur={class:"info-row"},jr={class:"info-row"},Hr={class:"info-row"},Wr={class:"modal-footer"},qr=U({__name:"SystemModal",emits:["close"],setup(r,{emit:t}){const n=e.ref(!0),o=e.ref({});return e.onMounted(async()=>{try{o.value=await A.apiGet("/system/info")}catch{}n.value=!1}),(l,a)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:a[2]||(a[2]=e.withModifiers(s=>l.$emit("close"),["self"]))},[e.createElementVNode("div",Mr,[e.createElementVNode("div",Dr,[a[3]||(a[3]=e.createElementVNode("h2",null,"ℹ 系统信息",-1)),e.createElementVNode("button",{class:"modal-close",onClick:a[0]||(a[0]=s=>l.$emit("close"))},"×")]),e.createElementVNode("div",Rr,[n.value?(e.openBlock(),e.createElementBlock("div",Lr,"加载中...")):(e.openBlock(),e.createElementBlock("div",Fr,[e.createElementVNode("div",Gr,[a[4]||(a[4]=e.createElementVNode("label",null,"主机名",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.hostname),1)]),e.createElementVNode("div",Or,[a[5]||(a[5]=e.createElementVNode("label",null,"当前目录",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.cwd),1)]),e.createElementVNode("div",zr,[a[6]||(a[6]=e.createElementVNode("label",null,"操作系统",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.os),1)]),e.createElementVNode("div",Ur,[a[7]||(a[7]=e.createElementVNode("label",null,"Go 版本",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.goos),1)]),e.createElementVNode("div",jr,[a[8]||(a[8]=e.createElementVNode("label",null,"工作区",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.workspace),1)]),e.createElementVNode("div",Hr,[a[9]||(a[9]=e.createElementVNode("label",null,"文件夹",-1)),e.createElementVNode("span",null,e.toDisplayString((o.value.folders||[]).join(", ")),1)])]))]),e.createElementVNode("div",Wr,[e.createElementVNode("button",{class:"btn-secondary",onClick:a[1]||(a[1]=s=>l.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-bb4d0117"]]),Jr={class:"modal-content source-modal"},Kr={class:"modal-header"},Zr={class:"modal-footer"},Qr=U({__name:"SourceModal",emits:["close"],setup(r){return(t,n)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:n[2]||(n[2]=e.withModifiers(o=>t.$emit("close"),["self"]))},[e.createElementVNode("div",Jr,[e.createElementVNode("div",Kr,[n[3]||(n[3]=e.createElementVNode("h2",null,"⎔ 源代码管理",-1)),e.createElementVNode("button",{class:"modal-close",onClick:n[0]||(n[0]=o=>t.$emit("close"))},"×")]),n[4]||(n[4]=e.createElementVNode("div",{class:"modal-body"},[e.createElementVNode("p",{style:{color:"var(--text-muted)","text-align":"center","margin-top":"40px"}},[e.createTextVNode(" Git 集成开发中"),e.createElementVNode("br"),e.createElementVNode("br"),e.createTextVNode(" 功能规划："),e.createElementVNode("br"),e.createTextVNode(" · Git 状态查看"),e.createElementVNode("br"),e.createTextVNode(" · 暂存/提交/推送"),e.createElementVNode("br"),e.createTextVNode(" · 分支管理"),e.createElementVNode("br"),e.createTextVNode(" · Diff 对比 ")])],-1)),e.createElementVNode("div",Zr,[e.createElementVNode("button",{class:"btn-secondary",onClick:n[1]||(n[1]=o=>t.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-bc520229"]]),_r=`# 功能介绍
...
${f}`:f,l=l?`${l}
${k}`:k;let B=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(k,a,!0),this.lexer.state.top=B,n.length===0)break;let w=a.at(-1);if((w==null?void 0:w.type)==="code")break;if((w==null?void 0:w.type)==="blockquote"){let S=w,u=S.raw+`
`+n.join(`
`),C=this.blockquote(u);a[a.length-1]=C,o=o.substring(0,o.length-S.raw.length)+C.raw,l=l.substring(0,l.length-S.text.length)+C.text;break}else if((w==null?void 0:w.type)==="list"){let S=w,u=S.raw+`
`+n.join(`
`),C=this.list(u);a[a.length-1]=C,o=o.substring(0,o.length-w.raw.length)+C.raw,l=l.substring(0,l.length-S.raw.length)+C.raw,n=u.substring(a.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:o,tokens:a,text:l}}}list(r){let t=this.rules.block.list.exec(r);if(t){let n=t[1].trim(),o=n.length>1,l={type:"list",raw:"",ordered:o,start:o?+n.slice(0,-1):"",loose:!1,items:[]};n=o?`\\d{1,9}\\${n.slice(-1)}`:`\\${n}`,this.options.pedantic&&(n=o?n:"[*+-]");let a=this.rules.other.listItemRegex(n),s=!1;for(;r;){let i=!1,f="",k="";if(!(t=a.exec(r))||this.rules.block.hr.test(r))break;f=t[0],r=r.substring(f.length);let B=jo(t[2].split(`
`,1)[0],t[1].length),w=r.split(`
`,1)[0],S=!B.trim(),u=0;if(this.options.pedantic?(u=2,k=B.trimStart()):S?u=t[1].length+1:(u=B.search(this.rules.other.nonSpaceChar),u=u>4?1:u,k=B.slice(u),u+=t[1].length),S&&this.rules.other.blankLine.test(w)&&(f+=w+`
`,r=r.substring(w.length+1),i=!0),!i){let C=this.rules.other.nextBulletRegex(u),I=this.rules.other.hrRegex(u),L=this.rules.other.fencesBeginRegex(u),G=this.rules.other.headingBeginRegex(u),z=this.rules.other.htmlBeginRegex(u),H=this.rules.other.blockquoteBeginRegex(u);for(;r;){let j=r.split(`
`,1)[0],F;if(w=j,this.options.pedantic?(w=w.replace(this.rules.other.listReplaceNesting,"  "),F=w):F=w.replace(this.rules.other.tabCharGlobal,"    "),L.test(w)||G.test(w)||z.test(w)||H.test(w)||C.test(w)||I.test(w))break;if(F.search(this.rules.other.nonSpaceChar)>=u||!w.trim())k+=`
`+F.slice(u);else{if(S||B.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||L.test(B)||G.test(B)||I.test(B))break;k+=`
`+w}S=!w.trim(),f+=j+`
`,r=r.substring(j.length+1),B=F.slice(u)}}l.loose||(s?l.loose=!0:this.rules.other.doubleBlankLine.test(f)&&(s=!0)),l.items.push({type:"list_item",raw:f,task:!!this.options.gfm&&this.rules.other.listIsTask.test(k),loose:!1,text:k,tokens:[]}),l.raw+=f}let d=l.items.at(-1);if(d)d.raw=d.raw.trimEnd(),d.text=d.text.trimEnd();else return;l.raw=l.raw.trimEnd();for(let i of l.items){this.lexer.state.top=!1,i.tokens=this.lexer.blockTokens(i.text,[]);let f=i.tokens[0];if(i.task&&((f==null?void 0:f.type)==="text"||(f==null?void 0:f.type)==="paragraph")){i.text=i.text.replace(this.rules.other.listReplaceTask,""),f.raw=f.raw.replace(this.rules.other.listReplaceTask,""),f.text=f.text.replace(this.rules.other.listReplaceTask,"");for(let B=this.lexer.inlineQueue.length-1;B>=0;B--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[B].src)){this.lexer.inlineQueue[B].src=this.lexer.inlineQueue[B].src.replace(this.rules.other.listReplaceTask,"");break}let k=this.rules.other.listTaskCheckbox.exec(i.raw);if(k){let B={type:"checkbox",raw:k[0]+" ",checked:k[0]!=="[ ]"};i.checked=B.checked,l.loose?i.tokens[0]&&["paragraph","text"].includes(i.tokens[0].type)&&"tokens"in i.tokens[0]&&i.tokens[0].tokens?(i.tokens[0].raw=B.raw+i.tokens[0].raw,i.tokens[0].text=B.raw+i.tokens[0].text,i.tokens[0].tokens.unshift(B)):i.tokens.unshift({type:"paragraph",raw:B.raw,text:B.raw,tokens:[B]}):i.tokens.unshift(B)}}else i.task&&(i.task=!1);if(!l.loose){let k=i.tokens.filter(w=>w.type==="space"),B=k.length>0&&k.some(w=>this.rules.other.anyLine.test(w.raw));l.loose=B}}if(l.loose)for(let i of l.items){i.loose=!0;for(let f of i.tokens)f.type==="text"&&(f.type="paragraph")}return l}}html(r){let t=this.rules.block.html.exec(r);if(t){let n=je(t[0]);return{type:"html",block:!0,raw:n,pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:n}}}def(r){let t=this.rules.block.def.exec(r);if(t){let n=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),o=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",l=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:n,raw:Z(t[0],`
`),href:o,title:l}}}table(r){var s;let t=this.rules.block.table.exec(r);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;let n=Ue(t[1]),o=t[2].replace(this.rules.other.tableAlignChars,"").split("|"),l=(s=t[3])!=null&&s.trim()?t[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],a={type:"table",raw:Z(t[0],`
`),header:[],align:[],rows:[]};if(n.length===o.length){for(let d of o)this.rules.other.tableAlignRight.test(d)?a.align.push("right"):this.rules.other.tableAlignCenter.test(d)?a.align.push("center"):this.rules.other.tableAlignLeft.test(d)?a.align.push("left"):a.align.push(null);for(let d=0;d<n.length;d++)a.header.push({text:n[d],tokens:this.lexer.inline(n[d]),header:!0,align:a.align[d]});for(let d of l)a.rows.push(Ue(d,a.header.length).map((i,f)=>({text:i,tokens:this.lexer.inline(i),header:!1,align:a.align[f]})));return a}}lheading(r){let t=this.rules.block.lheading.exec(r);if(t){let n=t[1].trim();return{type:"heading",raw:Z(t[0],`
...
`)?"":`
`)+i.raw,k.text+=`
`+i.raw,this.inlineQueue.at(-1).src=k.text):this.tokens.links[i.tag]||(this.tokens.links[i.tag]={href:i.href,title:i.title},n.push(i));continue}if(i=this.tokenizer.table(t)){t=t.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.lheading(t)){t=t.substring(i.raw.length),n.push(i);continue}let f=t;if((d=this.options.extensions)!=null&&d.startBlock){let k=1/0,B=t.slice(1),w;this.options.extensions.startBlock.forEach(S=>{w=S.call({lexer:this},B),typeof w=="number"&&w>=0&&(k=Math.min(k,w))}),k<1/0&&k>=0&&(f=t.substring(0,k+1))}if(this.state.top&&(i=this.tokenizer.paragraph(f))){let k=n.at(-1);o&&(k==null?void 0:k.type)==="paragraph"?(k.raw+=(k.raw.endsWith(`
`)?"":`
`)+i.raw,k.text+=`
...
`)?"":`
`)+i.raw,k.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=k.text):n.push(i);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){var f,k,B,w,S;this.tokenizer.lexer=this;let o=t,l=null;if(this.tokens.links){let u=Object.keys(this.tokens.links);if(u.length>0)for(;(l=this.tokenizer.rules.inline.reflinkSearch.exec(o))!==null;)u.includes(l[0].slice(l[0].lastIndexOf("[")+1,-1))&&(o=o.slice(0,l.index)+"["+"a".repeat(l[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(l=this.tokenizer.rules.inline.anyPunctuation.exec(o))!==null;)o=o.slice(0,l.index)+"++"+o.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let a;for(;(l=this.tokenizer.rules.inline.blockSkip.exec(o))!==null;)a=l[2]?l[2].length:0,o=o.slice(0,l.index+a)+"["+"a".repeat(l[0].length-a-2)+"]"+o.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);o=((k=(f=this.options.hooks)==null?void 0:f.emStrongMask)==null?void 0:k.call({lexer:this},o))??o;let s=!1,d="",i=1/0;for(;t;){if(t.length<i)i=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}s||(d=""),s=!1;let u;if((w=(B=this.options.extensions)==null?void 0:B.inline)!=null&&w.some(I=>(u=I.call({lexer:this},t,n))?(t=t.substring(u.raw.length),n.push(u),!0):!1))continue;if(u=this.tokenizer.escape(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.tag(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.link(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(u.raw.length);let I=n.at(-1);u.type==="text"&&(I==null?void 0:I.type)==="text"?(I.raw+=u.raw,I.text+=u.text):n.push(u);continue}if(u=this.tokenizer.emStrong(t,o,d)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.codespan(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.br(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.del(t,o,d)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.autolink(t)){t=t.substring(u.raw.length),n.push(u);continue}if(!this.state.inLink&&(u=this.tokenizer.url(t))){t=t.substring(u.raw.length),n.push(u);continue}let C=t;if((S=this.options.extensions)!=null&&S.startInline){let I=1/0,L=t.slice(1),G;this.options.extensions.startInline.forEach(z=>{G=z.call({lexer:this},L),typeof G=="number"&&G>=0&&(I=Math.min(I,G))}),I<1/0&&I>=0&&(C=t.substring(0,I+1))}if(u=this.tokenizer.inlineText(C)){t=t.substring(u.raw.length),u.raw.slice(-1)!=="_"&&(d=u.raw.slice(-1)),s=!0;let I=n.at(-1);(I==null?void 0:I.type)==="text"?(I.raw+=u.raw,I.text+=u.text):n.push(u);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return n}infiniteLoopError(t){let n="Infinite loop on byte: "+t;if(this.options.silent)console.error(n);else throw new Error(n)}},ce=class{constructor(r){D(this,"options");D(this,"parser");this.options=r||_}space(r){return""}code({text:r,lang:t,escaped:n}){var a;let o=(a=(t||"").match(O.notSpaceStart))==null?void 0:a[0],l=r.replace(O.endingNewline,"")+`
...
`}strong({tokens:r}){return`<strong>${this.parser.parseInline(r)}</strong>`}em({tokens:r}){return`<em>${this.parser.parseInline(r)}</em>`}codespan({text:r}){return`<code>${J(r,!0)}</code>`}br(r){return"<br>"}del({tokens:r}){return`<del>${this.parser.parseInline(r)}</del>`}link({href:r,title:t,tokens:n}){let o=this.parser.parseInline(n),l=ze(r);if(l===null)return o;r=l;let a='<a href="'+r+'"';return t&&(a+=' title="'+J(t)+'"'),a+=">"+o+"</a>",a}image({href:r,title:t,text:n,tokens:o}){o&&(n=this.parser.parseInline(o,this.parser.textRenderer));let l=ze(r);if(l===null)return J(n);r=l;let a=`<img src="${r}" alt="${J(n)}"`;return t&&(a+=` title="${J(t)}"`),a+=">",a}text(r){return"tokens"in r&&r.tokens?this.parser.parseInline(r.tokens):"escaped"in r&&r.escaped?r.text:J(r.text)}},xe=class{strong({text:r}){return r}em({text:r}){return r}codespan({text:r}){return r}del({text:r}){return r}html({text:r}){return r}text({text:r}){return r}link({text:r}){return""+r}image({text:r}){return""+r}br(){return""}checkbox({raw:r}){return r}},q=class we{constructor(t){D(this,"options");D(this,"renderer");D(this,"textRenderer");this.options=t||_,this.options.renderer=this.options.renderer||new ce,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new xe}static parse(t,n){return new we(n).parse(t)}static parseInline(t,n){return new we(n).parseInline(t)}parse(t){var o,l;this.renderer.parser=this;let n="";for(let a=0;a<t.length;a++){let s=t[a];if((l=(o=this.options.extensions)==null?void 0:o.renderers)!=null&&l[s.type]){let i=s,f=this.options.extensions.renderers[i.type].call({parser:this},i);if(f!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(i.type)){n+=f||"";continue}}let d=s;switch(d.type){case"space":{n+=this.renderer.space(d);break}case"hr":{n+=this.renderer.hr(d);break}case"heading":{n+=this.renderer.heading(d);break}case"code":{n+=this.renderer.code(d);break}case"table":{n+=this.renderer.table(d);break}case"blockquote":{n+=this.renderer.blockquote(d);break}case"list":{n+=this.renderer.list(d);break}case"checkbox":{n+=this.renderer.checkbox(d);break}case"html":{n+=this.renderer.html(d);break}case"def":{n+=this.renderer.def(d);break}case"paragraph":{n+=this.renderer.paragraph(d);break}case"text":{n+=this.renderer.text(d);break}default:{let i='Token with "'+d.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}parseInline(t,n=this.renderer){var l,a;this.renderer.parser=this;let o="";for(let s=0;s<t.length;s++){let d=t[s];if((a=(l=this.options.extensions)==null?void 0:l.renderers)!=null&&a[d.type]){let f=this.options.extensions.renderers[d.type].call({parser:this},d);if(f!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(d.type)){o+=f||"";continue}}let i=d;switch(i.type){case"escape":{o+=n.text(i);break}case"html":{o+=n.html(i);break}case"link":{o+=n.link(i);break}case"image":{o+=n.image(i);break}case"checkbox":{o+=n.checkbox(i);break}case"strong":{o+=n.strong(i);break}case"em":{o+=n.em(i);break}case"codespan":{o+=n.codespan(i);break}case"br":{o+=n.br(i);break}case"del":{o+=n.del(i);break}case"text":{o+=n.text(i);break}default:{let f='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(f),"";throw new Error(f)}}}return o}},re=(de=class{constructor(r){D(this,"options");D(this,"block");this.options=r||_}preprocess(r){return r}postprocess(r){return r}processAllTokens(r){return r}emStrongMask(r){return r}provideLexer(r=this.block){return r?W.lex:W.lexInline}provideParser(r=this.block){return r?q.parse:q.parseInline}},D(de,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),D(de,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),de),Wo=class{constructor(...r){D(this,"defaults",me());D(this,"options",this.setOptions);D(this,"parse",this.parseMarkdown(!0));D(this,"parseInline",this.parseMarkdown(!1));D(this,"Parser",q);D(this,"Renderer",ce);D(this,"TextRenderer",xe);D(this,"Lexer",W);D(this,"Tokenizer",ie);D(this,"Hooks",re);this.use(...r)}walkTokens(r,t){var o,l;let n=[];for(let a of r)switch(n=n.concat(t.call(this,a)),a.type){case"table":{let s=a;for(let d of s.header)n=n.concat(this.walkTokens(d.tokens,t));for(let d of s.rows)for(let i of d)n=n.concat(this.walkTokens(i.tokens,t));break}case"list":{let s=a;n=n.concat(this.walkTokens(s.items,t));break}default:{let s=a;(l=(o=this.defaults.extensions)==null?void 0:o.childTokens)!=null&&l[s.type]?this.defaults.extensions.childTokens[s.type].forEach(d=>{let i=s[d].flat(1/0);n=n.concat(this.walkTokens(i,t))}):s.tokens&&(n=n.concat(this.walkTokens(s.tokens,t)))}}return n}use(...r){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return r.forEach(n=>{let o={...n};if(o.async=this.defaults.async||o.async||!1,n.extensions&&(n.extensions.forEach(l=>{if(!l.name)throw new Error("extension name required");if("renderer"in l){let a=t.renderers[l.name];a?t.renderers[l.name]=function(...s){let d=l.renderer.apply(this,s);return d===!1&&(d=a.apply(this,s)),d}:t.renderers[l.name]=l.renderer}if("tokenizer"in l){if(!l.level||l.level!=="block"&&l.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let a=t[l.level];a?a.unshift(l.tokenizer):t[l.level]=[l.tokenizer],l.start&&(l.level==="block"?t.startBlock?t.startBlock.push(l.start):t.startBlock=[l.start]:l.level==="inline"&&(t.startInline?t.startInline.push(l.start):t.startInline=[l.start]))}"childTokens"in l&&l.childTokens&&(t.childTokens[l.name]=l.childTokens)}),o.extensions=t),n.renderer){let l=this.defaults.renderer||new ce(this.defaults);for(let a in n.renderer){if(!(a in l))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;let s=a,d=n.renderer[s],i=l[s];l[s]=(...f)=>{let k=d.apply(l,f);return k===!1&&(k=i.apply(l,f)),k||""}}o.renderer=l}if(n.tokenizer){let l=this.defaults.tokenizer||new ie(this.defaults);for(let a in n.tokenizer){if(!(a in l))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;let s=a,d=n.tokenizer[s],i=l[s];l[s]=(...f)=>{let k=d.apply(l,f);return k===!1&&(k=i.apply(l,f)),k}}o.tokenizer=l}if(n.hooks){let l=this.defaults.hooks||new re;for(let a in n.hooks){if(!(a in l))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;let s=a,d=n.hooks[s],i=l[s];re.passThroughHooks.has(a)?l[s]=f=>{if(this.defaults.async&&re.passThroughHooksRespectAsync.has(a))return(async()=>{let B=await d.call(l,f);return i.call(l,B)})();let k=d.call(l,f);return i.call(l,k)}:l[s]=(...f)=>{if(this.defaults.async)return(async()=>{let B=await d.apply(l,f);return B===!1&&(B=await i.apply(l,f)),B})();let k=d.apply(l,f);return k===!1&&(k=i.apply(l,f)),k}}o.hooks=l}if(n.walkTokens){let l=this.defaults.walkTokens,a=n.walkTokens;o.walkTokens=function(s){let d=[];return d.push(a.call(this,s)),l&&(d=d.concat(l.call(this,s))),d}}this.defaults={...this.defaults,...o}}),this}setOptions(r){return this.defaults={...this.defaults,...r},this}lexer(r,t){return W.lex(r,t??this.defaults)}parser(r,t){return q.parse(r,t??this.defaults)}parseMarkdown(r){return(t,n)=>{let o={...n},l={...this.defaults,...o},a=this.onError(!!l.silent,!!l.async);if(this.defaults.async===!0&&o.async===!1)return a(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof t>"u"||t===null)return a(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return a(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(l.hooks&&(l.hooks.options=l,l.hooks.block=r),l.async)return(async()=>{let s=l.hooks?await l.hooks.preprocess(t):t,d=await(l.hooks?await l.hooks.provideLexer(r):r?W.lex:W.lexInline)(s,l),i=l.hooks?await l.hooks.processAllTokens(d):d;l.walkTokens&&await Promise.all(this.walkTokens(i,l.walkTokens));let f=await(l.hooks?await l.hooks.provideParser(r):r?q.parse:q.parseInline)(i,l);return l.hooks?await l.hooks.postprocess(f):f})().catch(a);try{l.hooks&&(t=l.hooks.preprocess(t));let s=(l.hooks?l.hooks.provideLexer(r):r?W.lex:W.lexInline)(t,l);l.hooks&&(s=l.hooks.processAllTokens(s)),l.walkTokens&&this.walkTokens(s,l.walkTokens);let d=(l.hooks?l.hooks.provideParser(r):r?q.parse:q.parseInline)(s,l);return l.hooks&&(d=l.hooks.postprocess(d)),d}catch(s){return a(s)}}}onError(r,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,r){let o="<p>An error occurred:</p><pre>"+J(n.message+"",!0)+"</pre>";return t?Promise.resolve(o):o}if(t)return Promise.reject(n);throw n}}},X=new Wo;function $(r,t){return X.parse(r,t)}$.options=$.setOptions=function(r){return X.setOptions(r),$.defaults=X.defaults,Se($.defaults),$},$.getDefaults=me,$.defaults=_,$.use=function(...r){return X.use(...r),$.defaults=X.defaults,Se($.defaults),$},$.walkTokens=function(r,t){return X.walkTokens(r,t)},$.parseInline=X.parseInline,$.Parser=q,$.parser=q.parse,$.Renderer=ce,$.TextRenderer=xe,$.Lexer=W,$.lexer=W.lex,$.Tokenizer=ie,$.Hooks=re,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,q.parse,W.lex;const qo={class:"modal-content help-modal"},Jo={class:"modal-header"},Ko={class:"header-actions"},Zo={class:"modal-body"},Qo={class:"doc-sidebar"},_o={class:"doc-sidebar-group"},Yo={class:"doc-sidebar-header"},Xo=["onClick"],vo={class:"doc-sidebar-group"},el={class:"doc-sidebar-header"},nl={class:"doc-content"},tl=["innerHTML"],rl=["innerHTML"],ol=["innerHTML"],ll=["innerHTML"],al=["innerHTML"],sl=["innerHTML"],il=["innerHTML"],cl={class:"doc-pagination"},dl=["disabled"],pl={class:"page-info"},ml=["disabled"],gl=U({__name:"HelpModal",props:{initialDoc:{type:String,default:"getting-started"}},emits:["close","openAbout"],setup(r,{emit:t}){const n=r,o=e.ref(n.initialDoc),l=e.ref(""),a=e.ref(null),s=[{id:"getting-started",title:"快速开始",icon:"home"},{id:"features",title:"功能介绍",icon:"info"},{id:"api",title:"API 文档",icon:"code"},{id:"tools",title:"工具文档",icon:"tool"},{id:"shortcuts",title:"快捷键",icon:"keyboard"},{id:"faq",title:"常见问题",icon:"help"}],d=e.ref(s),i=e.computed(()=>[...d.value,{id:"changelog",title:"更新日志",icon:"activity"}]),f=e.computed(()=>i.value.findIndex(V=>V.id===o.value)),k=e.computed(()=>f.value>0),B=e.computed(()=>f.value<i.value.length-1);function w(){const V=l.value.toLowerCase().trim();if(!V){d.value=s;return}d.value=s.filter(p=>p.title.toLowerCase().includes(V)||p.id.includes(V)),d.value.length>0&&!d.value.find(p=>p.id===o.value)&&(o.value=d.value[0].id)}const S=V=>$(V,{breaks:!0,gfm:!0}).replace(/<table>/g,'<table class="doc-table">'),u=e.computed(()=>S(eo)),C=e.computed(()=>S(no)),I=e.computed(()=>S(_r)),L=e.computed(()=>S(Yr)),G=e.computed(()=>S(Xr)),z=e.computed(()=>S(vr)),H=e.computed(()=>S(to));function j(){var V;k.value&&(o.value=i.value[f.value-1].id,(V=a.value)==null||V.scrollTo(0,0))}function F(){var V;B.value&&(o.value=i.value[f.value+1].id,(V=a.value)==null||V.scrollTo(0,0))}return e.onMounted(()=>{w()}),(V,p)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:p[3]||(p[3]=e.withModifiers(E=>V.$emit("close"),["self"]))},[e.createElementVNode("div",qo,[e.createCommentVNode(" 头部 "),e.createElementVNode("div",Jo,[e.createElementVNode("h2",null,[e.createVNode(R,{name:"book-open",size:18}),p[4]||(p[4]=e.createTextVNode(" 帮助文档",-1))]),e.createElementVNode("div",Ko,[e.createElementVNode("button",{class:"btn-about",onClick:p[0]||(p[0]=E=>V.$emit("openAbout")),title:"关于 PairCode"},[e.createVNode(R,{name:"info",size:14}),p[5]||(p[5]=e.createTextVNode(" 关于 ",-1))]),e.createElementVNode("button",{class:"modal-close",onClick:p[1]||(p[1]=E=>V.$emit("close"))},"×")])]),e.createCommentVNode(" 主体 "),e.createElementVNode("div",Zo,[e.createCommentVNode(" 侧边导航 "),e.createElementVNode("div",Qo,[e.createCommentVNode(" 文档中心分组 "),e.createElementVNode("div",_o,[e.createElementVNode("div",Yo,[e.createVNode(R,{name:"book",size:14}),p[6]||(p[6]=e.createElementVNode("span",null,"文档中心",-1))]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,E=>(e.openBlock(),e.createElementBlock("div",{key:E.id,class:e.normalizeClass(["doc-nav-item",{active:o.value===E.id}]),onClick:b=>o.value=E.id},[e.createVNode(R,{name:E.icon,size:16},null,8,["name"]),e.createElementVNode("span",null,e.toDisplayString(E.title),1)],10,Xo))),128))]),e.createCommentVNode(" 更新日志 "),e.createElementVNode("div",vo,[e.createElementVNode("div",el,[e.createVNode(R,{name:"clock",size:14}),p[7]||(p[7]=e.createElementVNode("span",null,"其他",-1))]),e.createElementVNode("div",{class:e.normalizeClass(["doc-nav-item",{active:o.value==="changelog"}]),onClick:p[2]||(p[2]=E=>o.value="changelog")},[e.createVNode(R,{name:"activity",size:16}),p[8]||(p[8]=e.createElementVNode("span",null,"更新日志",-1))],2)])]),e.createCommentVNode(" 文档内容 "),e.createElementVNode("div",nl,[e.createElementVNode("div",{class:"doc-content-inner",ref_key:"contentRef",ref:a},[o.value==="faq"?(e.openBlock(),e.createElementBlock("div",{key:0,class:"doc-markdown",innerHTML:u.value},null,8,tl)):o.value==="getting-started"?(e.openBlock(),e.createElementBlock("div",{key:1,class:"doc-markdown",innerHTML:C.value},null,8,rl)):o.value==="features"?(e.openBlock(),e.createElementBlock("div",{key:2,class:"doc-markdown",innerHTML:I.value},null,8,ol)):o.value==="api"?(e.openBlock(),e.createElementBlock("div",{key:3,class:"doc-markdown",innerHTML:L.value},null,8,ll)):o.value==="tools"?(e.openBlock(),e.createElementBlock("div",{key:4,class:"doc-markdown",innerHTML:G.value},null,8,al)):o.value==="shortcuts"?(e.openBlock(),e.createElementBlock("div",{key:5,class:"doc-markdown",innerHTML:z.value},null,8,sl)):o.value==="changelog"?(e.openBlock(),e.createElementBlock("div",{key:6,class:"doc-markdown",innerHTML:H.value},null,8,il)):e.createCommentVNode("v-if",!0)],512),e.createCommentVNode(" 底部翻页 "),e.createElementVNode("div",cl,[e.createElementVNode("button",{class:"page-btn",onClick:j,disabled:!k.value},[e.createVNode(R,{name:"chevron-left",size:14}),p[9]||(p[9]=e.createTextVNode(" 上一页 ",-1))],8,dl),e.createElementVNode("span",pl,e.toDisplayString(f.value+1)+" / "+e.toDisplayString(i.value.length),1),e.createElementVNode("button",{class:"page-btn",onClick:F,disabled:!B.value},[p[10]||(p[10]=e.createTextVNode(" 下一页 ",-1)),e.createVNode(R,{name:"chevron-right",size:14})],8,ml)])])])])]))}},[["__scopeId","data-v-0f9c0147"]]),kl={class:"uc"},hl={class:"uc-line"},fl={class:"uc-cur"},yl={key:0,class:"uc-new"},ul={class:"uc-warn"},bl=["disabled"],El={key:0,class:"uc-prog"},xl={class:"uc-bar"},Vl={class:"uc-pct"},Nl={key:1,class:"uc-plan"},wl={key:2,class:"uc-notes"},Bl={class:"uc-pre"},We=U({__name:"UpdateCard",props:{currentVersion:{type:String,default:""}},setup(r){const t=r,n=e.ref("idle"),o=e.ref({}),l=e.ref(""),a=e.ref(!1),s=e.ref(""),d=e.ref(""),i=e.ref({}),f=e.ref(0),k=e.ref(!1),B=e.ref(!1),w=e.ref("");let S=null;const u=["checking","downloading","verifying","extracting","applying","restarting"],C=e.computed(()=>u.includes(n.value)),I=e.computed(()=>{const h=String(t.currentVersion||"").trim();return h?h[0]==="v"||h[0]==="V"?h:"v"+h:"—"}),L=e.computed(()=>n.value==="checking"?"检查中…":a.value?"重新检查":"检查更新"),G=e.computed(()=>d.value||o.value.message||"尚未检查更新"),z=e.computed(()=>{switch(n.value){case"downloading":case"verifying":case"extracting":case"applying":return"package";case"ready":return"check-circle";case"error":return"shield-off";case"available":return"package";default:return"refresh"}}),H=e.computed(()=>n.value==="error"?"var(--danger)":"var(--accent)"),j=e.computed(()=>(((i.value||{}).speedBps||0)/1048576).toFixed(2));function F(h){const c=Number(h||0);return c>=1073741824?(c/1073741824).toFixed(2)+" GB":(c/1048576).toFixed(1)+" MB"}function V(h){h&&(o.value=h,n.value=h.stage||"idle",l.value=h.latest||"",a.value=!!h.hasUpdate,s.value=h.notes||"",d.value=h.error||"",i.value=h.progress||{},f.value=Number(i.value.percent||0),C.value?p():E())}function p(){S||(S=setInterval(async()=>{try{const h=await A.apiGet("/update/status");V(h.state)}catch{}},900))}function E(){S&&(clearInterval(S),S=null)}async function b(){k.value=!0,w.value="",n.value="checking",d.value="";try{const h=await A.apiGet("/update/check");V(h.state),h.error&&(d.value=h.error)}catch(h){d.value="检查更新失败："+((h==null?void 0:h.message)||h),n.value="error"}finally{k.value=!1}}async function T(){w.value="";try{const h=await A.apiPost("/update/download");V(h.state),h.error&&(d.value=h.error),p()}catch(h){d.value="下载失败："+((h==null?void 0:h.message)||h)}}async function g(){try{const h=await A.apiPost("/update/cancel");V(h.state)}catch{}}async function m(){w.value="正在生成替换计划…";try{const h=await A.apiPost("/update/apply",{dryRun:!0,restart:!1}),c=(h.result||{}).plan||{};w.value=`替换预览：将写 ${(c.write||[]).length} 个文件（${F(c.bytes)}），保护名单跳过 ${(c.skip||[]).length} 个（config/ 与 .pair 用户数据），主程序 ${c.mainProgram}`,h.error&&(w.value="预览失败："+h.error)}catch(h){w.value="预览失败："+((h==null?void 0:h.message)||h)}}async function y(h){B.value=!1,w.value=h?"正在安装并重启，页面将在数秒后断开…":"正在安装（不重启）…";try{const c=await A.apiPost("/update/apply",{dryRun:!1,restart:h});if(V(c.state),c.error){w.value="安装失败："+c.error;return}const N=(c.result||{}).plan||{};w.value=h?`已安装 v${l.value}，正在重启（备份：${N.backupPath||"-"}）`:`已安装 v${l.value}（${(N.write||[]).length} 个文件），重启后生效；旧版本备份：${N.backupPath||"-"}`}catch(c){w.value="安装失败："+((c==null?void 0:c.message)||c)}}return e.onMounted(async()=>{try{const h=await A.apiGet("/update/status");V(h.state)}catch{}}),e.onUnmounted(E),(h,c)=>(e.openBlock(),e.createElementBlock("div",kl,[e.createCommentVNode(" 主行：状态 + 操作 "),e.createElementVNode("div",hl,[e.createVNode(R,{name:z.value,size:14,color:H.value},null,8,["name","color"]),c[4]||(c[4]=e.createElementVNode("span",{class:"uc-title"},"软件更新",-1)),e.createElementVNode("span",fl,"当前 "+e.toDisplayString(I.value),1),a.value?(e.openBlock(),e.createElementBlock("span",yl,"→ 新版本 v"+e.toDisplayString(l.value),1)):e.createCommentVNode("v-if",!0),e.createElementVNode("span",{class:e.normalizeClass(["uc-state",{"uc-err":!!d.value}])},e.toDisplayString(G.value),3),c[5]||(c[5]=e.createElementVNode("span",{class:"uc-gap"},null,-1)),B.value?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createElementVNode("span",ul,"确认安装 v"+e.toDisplayString(l.value)+" 并重启？",1),e.createElementVNode("button",{class:"uc-btn uc-primary",onClick:c[0]||(c[0]=N=>y(!0))},"确认安装并重启"),e.createElementVNode("button",{class:"uc-btn",onClick:c[1]||(c[1]=N=>B.value=!1)},"取消")],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[!C.value&&n.value!=="ready"?(e.openBlock(),e.createElementBlock("button",{key:0,class:"uc-btn",disabled:k.value,onClick:b},[e.createVNode(R,{name:"refresh",size:12}),e.createTextVNode(" "+e.toDisplayString(L.value),1)],8,bl)):e.createCommentVNode("v-if",!0),n.value==="available"?(e.openBlock(),e.createElementBlock("button",{key:1,class:"uc-btn uc-primary",onClick:T},"下载并安装")):e.createCommentVNode("v-if",!0),C.value?(e.openBlock(),e.createElementBlock("button",{key:2,class:"uc-btn",onClick:g},"取消")):e.createCommentVNode("v-if",!0),n.value==="ready"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:3},[e.createElementVNode("button",{class:"uc-btn",onClick:m},"预览替换清单"),e.createElementVNode("button",{class:"uc-btn uc-primary",onClick:c[2]||(c[2]=N=>B.value=!0)},"立即安装并重启"),e.createElementVNode("button",{class:"uc-btn",onClick:c[3]||(c[3]=N=>y(!1))},"仅安装，稍后重启")],64)):e.createCommentVNode("v-if",!0)],64))]),e.createCommentVNode(" 进度条 "),C.value?(e.openBlock(),e.createElementBlock("div",El,[e.createElementVNode("div",xl,[e.createElementVNode("div",{class:"uc-fill",style:e.normalizeStyle({width:f.value.toFixed(1)+"%"})},null,4)]),e.createElementVNode("span",Vl,e.toDisplayString(f.value.toFixed(1))+"% ｜ "+e.toDisplayString(F(i.value.downloaded))+" / "+e.toDisplayString(F(i.value.total))+" ｜ "+e.toDisplayString(j.value)+" MB/s",1)])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 替换计划（预览） "),w.value?(e.openBlock(),e.createElementBlock("div",Nl,e.toDisplayString(w.value),1)):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 更新说明（折叠） "),a.value&&s.value?(e.openBlock(),e.createElementBlock("details",wl,[e.createElementVNode("summary",null,"更新说明（v"+e.toDisplayString(l.value)+"）",1),e.createElementVNode("pre",Bl,e.toDisplayString(s.value),1)])):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-14a60d34"]]),Tl="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='512'%20height='512'%20viewBox='0%200%20512%20512'%3e%3cdefs%3e%3c!--%20背景渐变（深色科技风）%20--%3e%3clinearGradient%20id='bgGrad'%20x1='0'%20y1='0'%20x2='1'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%230a1628'/%3e%3cstop%20offset='100%25'%20stop-color='%230d1f2e'/%3e%3c/linearGradient%3e%3c!--%20左侧尖括号渐变（科技蓝）%20--%3e%3clinearGradient%20id='leftBracket'%20x1='0'%20y1='0'%20x2='0'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%2300d4ff'/%3e%3cstop%20offset='100%25'%20stop-color='%230077b6'/%3e%3c/linearGradient%3e%3c!--%20右侧尖括号渐变（科技绿）%20--%3e%3clinearGradient%20id='rightBracket'%20x1='0'%20y1='0'%20x2='0'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%2300e676'/%3e%3cstop%20offset='100%25'%20stop-color='%2300c853'/%3e%3c/linearGradient%3e%3c!--%20中间连接线（蓝绿渐变）%20--%3e%3clinearGradient%20id='connector'%20x1='0'%20y1='0'%20x2='1'%20y2='0'%3e%3cstop%20offset='0%25'%20stop-color='%2300d4ff'/%3e%3cstop%20offset='50%25'%20stop-color='%2300e5ff'/%3e%3cstop%20offset='100%25'%20stop-color='%2300e676'/%3e%3c/linearGradient%3e%3c!--%20外发光%20--%3e%3cfilter%20id='glow'%3e%3cfeGaussianBlur%20stdDeviation='4'%20result='blur'/%3e%3cfeMerge%3e%3cfeMergeNode%20in='blur'/%3e%3cfeMergeNode%20in='SourceGraphic'/%3e%3c/feMerge%3e%3c/filter%3e%3cfilter%20id='softGlow'%3e%3cfeGaussianBlur%20stdDeviation='8'%20result='blur'/%3e%3cfeMerge%3e%3cfeMergeNode%20in='blur'/%3e%3cfeMergeNode%20in='SourceGraphic'/%3e%3c/feMerge%3e%3c/filter%3e%3c/defs%3e%3c!--%20圆角方形背景（深色科技底）%20--%3e%3crect%20x='32'%20y='32'%20width='448'%20height='448'%20rx='96'%20ry='96'%20fill='url(%23bgGrad)'%20stroke='%231a3a4a'%20stroke-width='2'/%3e%3c!--%20左侧%20%3c%20尖括号（三段式直线%20—%20科技蓝，代表代码输入/开发者）%20--%3e%3cpath%20d='M180%20150%20L96%20256%20L180%20362'%20stroke='url(%23leftBracket)'%20stroke-width='40'%20stroke-linejoin='round'%20fill='none'%20filter='url(%23glow)'/%3e%3c!--%20右侧%20%3e%20尖括号（三段式直线%20—%20科技绿，代表代码输出/AI伙伴）%20--%3e%3cpath%20d='M332%20150%20L416%20256%20L332%20362'%20stroke='url(%23rightBracket)'%20stroke-width='40'%20stroke-linejoin='round'%20fill='none'%20filter='url(%23glow)'/%3e%3c!--%20中间「=」连接线已移除（图标只留%20%3c%20%3e%20尖括号%20+%20中心%20AI%20核心光点）。%20--%3e%3c!--%20中心光点（代表%20AI%20核心%20—%20亮青色）%20--%3e%3ccircle%20cx='256'%20cy='256'%20r='18'%20fill='transparent'%20stroke='%2300e5ff'%20stroke-width='3'%20opacity='0.6'/%3e%3ccircle%20cx='256'%20cy='256'%20r='8'%20fill='%2300e5ff'%20opacity='0.9'%3e%3canimate%20attributeName='opacity'%20values='0.6;1;0.6'%20dur='2s'%20repeatCount='indefinite'/%3e%3c/circle%3e%3c/svg%3e",Sl={class:"modal-content about-modal"},Cl={class:"modal-header"},Il={class:"modal-body"},Pl={class:"about-left-col"},Al={class:"about-hero"},$l={class:"about-logo"},Ml=["src"],Dl={class:"about-version"},Rl={class:"about-right-col"},Ll={class:"about-section"},Fl={class:"feature-list"},Gl={class:"about-section"},Ol={key:0,class:"sys-info"},zl={class:"info-row"},Ul={class:"info-row"},jl={class:"info-row"},Hl={class:"info-path"},Wl={class:"info-row"},ql={key:1,class:"loading-info"},Jl={class:"about-update"},Kl={class:"modal-footer"},Zl=U({__name:"AboutModal",props:{showHelpBtn:{type:Boolean,default:!0}},emits:["close","openHelp"],setup(r,{emit:t}){const n=e.ref(""),o=e.ref({}),l=e.ref(!0);return e.onMounted(async()=>{try{const a=await A.apiGet("/system/info");o.value=a,a.version&&(n.value=a.version)}catch{}l.value=!1}),(a,s)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:s[3]||(s[3]=e.withModifiers(d=>a.$emit("close"),["self"]))},[e.createElementVNode("div",Sl,[e.createElementVNode("div",Cl,[e.createElementVNode("h2",null,[e.createVNode(R,{name:"info",size:18}),s[4]||(s[4]=e.createTextVNode(" 关于 PairCode",-1))]),e.createElementVNode("button",{class:"modal-close",onClick:s[0]||(s[0]=d=>a.$emit("close"))},"×")]),e.createElementVNode("div",Il,[e.createCommentVNode(" 左列：Logo + 描述 + 技术栈 "),e.createElementVNode("div",Pl,[e.createCommentVNode(" Logo + 标题 "),e.createElementVNode("div",Al,[e.createElementVNode("div",$l,[e.createElementVNode("img",{src:e.unref(Tl),class:"about-logo-img",alt:"PairCode"},null,8,Ml)]),s[5]||(s[5]=e.createElementVNode("div",{class:"about-title"},"PairCode IDE",-1)),e.createElementVNode("div",Dl,"版本 "+e.toDisplayString(n.value),1)]),e.createCommentVNode(" 描述 "),s[6]||(s[6]=e.createElementVNode("div",{class:"about-section"},[e.createElementVNode("p",{class:"about-description"}," PairCode IDE 是一款纯 Web 端的 AI 辅助编程集成开发环境， 专为浏览器而设计。无需安装任何桌面客户端或本地 IDE 软件， 打开浏览器即可开始编程。它将 AI 对话能力深度融入编码工作流， 你只需用自然语言描述需求，AI 就能自动理解上下文、读写文件、执行命令、 管理版本控制。从代码生成到项目运维，在同一个浏览器窗口中全部完成。 ")],-1)),e.createCommentVNode(" 技术栈 "),s[7]||(s[7]=e.createStaticVNode('<div class="about-section" data-v-226f7b6a><div class="section-title" data-v-226f7b6a>技术栈</div><div class="tech-stack" data-v-226f7b6a><span class="tech-badge" data-v-226f7b6a>Go</span><span class="tech-badge" data-v-226f7b6a>Vue 3</span><span class="tech-badge" data-v-226f7b6a>WebSocket</span><span class="tech-badge" data-v-226f7b6a>CodeMirror</span><span class="tech-badge" data-v-226f7b6a>插件化工具</span><span class="tech-badge" data-v-226f7b6a>TS 编译器</span><span class="tech-badge" data-v-226f7b6a>MCP</span><span class="tech-badge" data-v-226f7b6a>CodeGraph</span><span class="tech-badge" data-v-226f7b6a>DAP</span></div></div>',1))]),e.createCommentVNode(" 右列：特性 + 系统信息 "),e.createElementVNode("div",Rl,[e.createCommentVNode(" 特性亮点 "),e.createElementVNode("div",Ll,[s[18]||(s[18]=e.createElementVNode("div",{class:"section-title"},"主要特性",-1)),e.createElementVNode("ul",Fl,[e.createElementVNode("li",null,[e.createVNode(R,{name:"bot",size:14,color:"var(--accent)"}),s[8]||(s[8]=e.createTextVNode(" AI 对话编程 — 用自然语言与 AI 对话，自动生成与重构代码",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"file",size:14,color:"var(--accent)"}),s[9]||(s[9]=e.createTextVNode(" 智能代码编辑器 — 多语言语法高亮，浏览器中流畅编辑",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"git-branch",size:14,color:"var(--accent)"}),s[10]||(s[10]=e.createTextVNode(" Git 版本控制 — 在对话中完成全部 Git 操作",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"terminal",size:14,color:"var(--accent)"}),s[11]||(s[11]=e.createTextVNode(" 内置终端 — 无需离开浏览器即可执行命令",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"search",size:14,color:"var(--accent)"}),s[12]||(s[12]=e.createTextVNode(" 全局搜索 — 快速搜索文件与代码内容",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"settings",size:14,color:"var(--accent)"}),s[13]||(s[13]=e.createTextVNode(" 自主 Agent 模式 — AI 主动分析项目并自动执行任务",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"grid",size:14,color:"var(--accent)"}),s[14]||(s[14]=e.createTextVNode(" 对话历史管理 — 自动保存、回溯与继续历史对话",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"tool",size:14,color:"var(--accent)"}),s[15]||(s[15]=e.createTextVNode(" Skills / MCP 扩展 — 通过技能市场扩展 IDE 能力",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"code",size:14,color:"var(--accent)"}),s[16]||(s[16]=e.createTextVNode(" 内置调试器 — 支持 Go 程序的断点、单步和变量查看",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"image",size:14,color:"var(--accent)"}),s[17]||(s[17]=e.createTextVNode(" 网页验证 — 打开 URL、截图、分析页面效果",-1))])])]),e.createCommentVNode(" 系统信息 "),e.createElementVNode("div",Gl,[s[23]||(s[23]=e.createElementVNode("div",{class:"section-title"},"系统信息",-1)),l.value?(e.openBlock(),e.createElementBlock("div",ql,"加载中...")):(e.openBlock(),e.createElementBlock("div",Ol,[e.createElementVNode("div",zl,[s[19]||(s[19]=e.createElementVNode("span",{class:"info-label"},"主机名",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.hostname),1)]),e.createElementVNode("div",Ul,[s[20]||(s[20]=e.createElementVNode("span",{class:"info-label"},"操作系统",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.os),1)]),e.createElementVNode("div",jl,[s[21]||(s[21]=e.createElementVNode("span",{class:"info-label"},"工作区",-1)),e.createElementVNode("span",Hl,e.toDisplayString(o.value.workspace),1)]),e.createElementVNode("div",Wl,[s[22]||(s[22]=e.createElementVNode("span",{class:"info-label"},"平台信息",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.goos),1)])]))])])]),e.createCommentVNode(" ★ 软件更新（在线更新：检查 → 下载 → 校验 → 安装重启；数据源 /api/update/*）"),e.createElementVNode("div",Jl,[e.createVNode(We,{"current-version":n.value},null,8,["current-version"])]),e.createCommentVNode(" 底部 "),e.createElementVNode("div",Kl,[r.showHelpBtn?(e.openBlock(),e.createElementBlock("button",{key:0,class:"btn-primary",onClick:s[1]||(s[1]=d=>a.$emit("openHelp"))},[e.createVNode(R,{name:"book-open",size:14}),s[24]||(s[24]=e.createTextVNode(" 查看帮助文档 ",-1))])):e.createCommentVNode("v-if",!0),e.createElementVNode("button",{class:"btn-secondary",onClick:s[2]||(s[2]=d=>a.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-226f7b6a"]]),Ql={class:"modal-header"},_l={class:"modal-title"},Yl={class:"modal-body"},Xl=U({__name:"Modal",props:{maxWidth:{type:String,default:"480px"}},emits:["close"],setup(r,{emit:t}){const n=t,o=e.ref(!0);function l(a){a.key==="Escape"&&n("close")}return e.onMounted(()=>document.addEventListener("keydown",l)),e.onUnmounted(()=>document.removeEventListener("keydown",l)),(a,s)=>(e.openBlock(),e.createBlock(e.Teleport,{to:"body"},[o.value?(e.openBlock(),e.createElementBlock("div",{key:0,class:"modal-overlay",onClick:s[1]||(s[1]=e.withModifiers(d=>a.$emit("close"),["self"]))},[e.createElementVNode("div",{class:"modal-container",style:e.normalizeStyle({maxWidth:r.maxWidth})},[e.createElementVNode("div",Ql,[e.createElementVNode("span",_l,[e.renderSlot(a.$slots,"title",{},()=>[s[2]||(s[2]=e.createTextVNode("提示",-1))],!0)]),e.createElementVNode("button",{class:"modal-close",onClick:s[0]||(s[0]=d=>a.$emit("close"))},[e.createVNode(R,{name:"close",size:14})])]),e.createElementVNode("div",Yl,[e.renderSlot(a.$slots,"default",{},void 0,!0)])],4)])):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-1f96761a"]]),vl={class:"um"},ea=U({__name:"UpdateModal",emits:["close"],setup(r){const t=e.ref("");return e.onMounted(async()=>{try{const n=await A.apiGet("/system/info");n&&n.version&&(t.value=n.version)}catch{}}),(n,o)=>(e.openBlock(),e.createBlock(Xl,{"max-width":"640px",onClose:o[0]||(o[0]=l=>n.$emit("close"))},{title:e.withCtx(()=>[e.createVNode(R,{name:"download",size:14}),o[1]||(o[1]=e.createTextVNode(" 软件更新 ",-1))]),default:e.withCtx(()=>[e.createElementVNode("div",vl,[e.createVNode(We,{"current-version":t.value},null,8,["current-version"]),o[2]||(o[2]=e.createElementVNode("div",{class:"um-tips"},[e.createElementVNode("p",null,[e.createTextVNode("· 安装只替换程序与内置资源，"),e.createElementVNode("b",null,"config/ 与 .pair/ 下的用户数据、配置、技能不会被覆盖"),e.createTextVNode("。")]),e.createElementVNode("p",null,"· 「立即安装并重启」会在替换完成后自动重启服务；「仅安装，稍后重启」等你下次重启生效。"),e.createElementVNode("p",null,"· 更新源 / 发布频道 / 自动检查 / 校验开关：设置面板 → 软件更新。")],-1))])]),_:1}))}},[["__scopeId","data-v-6c94c04d"]]),na={class:"toast-container"},ta={class:"dlg-box",style:{"max-width":"400px"}},ra={class:"dlg-title"},oa={class:"dlg-body"},la={class:"dlg-actions"},aa={class:"dlg-box",style:{"max-width":"420px"}},sa={class:"dlg-title"},ia={class:"dlg-body",style:{display:"flex","flex-direction":"column",gap:"8px"}},ca={style:{"font-size":"13px",color:"var(--text-secondary)"}},da=["placeholder"],pa={class:"dlg-actions"},ma={class:"dlg-box",style:{"max-width":"400px"}},ga={class:"dlg-title"},ka={class:"dlg-body",style:{"white-space":"pre-line"}},ha=U({__name:"GlobalDialogs",setup(r){const t=e.ref(null);e.watch(()=>x.dialogState.show,l=>{l&&x.dialogState.type==="prompt"&&e.nextTick(()=>{var a,s;(a=t.value)==null||a.focus(),(s=t.value)==null||s.select()})});function n(){if(x.dialogState.type==="prompt"){const l=x.dialogState.inputValue;x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(l)}else if(x.dialogState.type==="confirm"&&x.dialogState.checkboxLabel){const a=x.dialogState.checkboxValue;x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve({confirmed:!0,checked:a})}else x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(!0);x.dialogState.resolve=null}function o(){x.dialogState.type==="confirm"&&x.dialogState.checkboxLabel?(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve({confirmed:!1,checked:x.dialogState.checkboxValue})):x.dialogState.type==="prompt"?(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(null)):(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(!1)),x.dialogState.resolve=null}return(l,a)=>(e.openBlock(),e.createElementBlock(e.Fragment,null,[e.createCommentVNode(" Toast 通知区域 "),e.createElementVNode("div",na,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(e.unref(x.dialogState).toasts,s=>(e.openBlock(),e.createElementBlock("div",{key:s.id,class:e.normalizeClass(["toast-item","toast-"+(s.type||"info")])},e.toDisplayString(s.message),3))),128))]),e.createCommentVNode(" Confirm 对话框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="confirm"?(e.openBlock(),e.createElementBlock("div",{key:0,class:"dlg-overlay",onClick:e.withModifiers(o,["self"])},[e.createElementVNode("div",ta,[e.createElementVNode("div",ra,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",oa,e.toDisplayString(e.unref(x.dialogState).message),1),e.unref(x.dialogState).checkboxLabel?(e.openBlock(),e.createElementBlock("label",{key:0,class:"dlg-checkbox",onClick:a[1]||(a[1]=e.withModifiers(()=>{},["stop"]))},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":a[0]||(a[0]=s=>e.unref(x.dialogState).checkboxValue=s)},null,512),[[e.vModelCheckbox,e.unref(x.dialogState).checkboxValue]]),e.createElementVNode("span",null,e.toDisplayString(e.unref(x.dialogState).checkboxLabel),1)])):e.createCommentVNode("v-if",!0),e.createElementVNode("div",la,[e.createElementVNode("button",{class:"dlg-btn",onClick:o},e.toDisplayString(e.unref(x.dialogState).cancelText),1),e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},e.toDisplayString(e.unref(x.dialogState).confirmText),1)])])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" Prompt 对话框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="prompt"?(e.openBlock(),e.createElementBlock("div",{key:1,class:"dlg-overlay",onClick:e.withModifiers(o,["self"])},[e.createElementVNode("div",aa,[e.createElementVNode("div",sa,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",ia,[e.createElementVNode("span",ca,e.toDisplayString(e.unref(x.dialogState).message),1),e.withDirectives(e.createElementVNode("input",{ref_key:"promptInputRef",ref:t,"onUpdate:modelValue":a[2]||(a[2]=s=>e.unref(x.dialogState).inputValue=s),placeholder:e.unref(x.dialogState).inputPlaceholder,class:"dlg-input",onKeyup:[e.withKeys(n,["enter"]),e.withKeys(o,["escape"])]},null,40,da),[[e.vModelText,e.unref(x.dialogState).inputValue]])]),e.createElementVNode("div",pa,[e.createElementVNode("button",{class:"dlg-btn",onClick:o},e.toDisplayString(e.unref(x.dialogState).cancelText),1),e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},e.toDisplayString(e.unref(x.dialogState).confirmText),1)])])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" Alert 信息框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="alert"?(e.openBlock(),e.createElementBlock("div",{key:2,class:"dlg-overlay",onClick:e.withModifiers(n,["self"])},[e.createElementVNode("div",ma,[e.createElementVNode("div",ga,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",ka,e.toDisplayString(e.unref(x.dialogState).message),1),e.createElementVNode("div",{class:"dlg-actions"},[e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},"确定")])])])):e.createCommentVNode("v-if",!0)],64))}},[["__scopeId","data-v-b4faa9fc"]]),fa=U({__name:"UiModals",setup(r){const t=e.ref(null);let n=null;function o(){x.showAbout.value=!1,x.showHelp.value=!0,x.helpDocTarget.value="getting-started"}function l(){x.showHelp.value=!1,x.showAbout.value=!0}return e.onMounted(()=>{n=Be.mountListSlot(t,"overlay",{isActive:a=>Be.isOverlayActive("overlay",a)})}),e.onUnmounted(()=>{n&&(n(),n=null)}),(a,s)=>(e.openBlock(),e.createElementBlock(e.Fragment,null,[e.unref(x.showSettings)?(e.openBlock(),e.createBlock($r,{key:0,onClose:s[0]||(s[0]=d=>x.showSettings.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showSystem)?(e.openBlock(),e.createBlock(qr,{key:1,onClose:s[1]||(s[1]=d=>x.showSystem.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showSource)?(e.openBlock(),e.createBlock(Qr,{key:2,onClose:s[2]||(s[2]=d=>x.showSource.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showHelp)?(e.openBlock(),e.createBlock(gl,{key:3,onClose:s[3]||(s[3]=d=>x.showHelp.value=!1),onOpenAbout:l,initialDoc:e.unref(x.helpDocTarget)},null,8,["initialDoc"])):e.createCommentVNode("v-if",!0),e.unref(x.showAbout)?(e.openBlock(),e.createBlock(Zl,{key:4,onClose:s[4]||(s[4]=d=>x.showAbout.value=!1),onOpenHelp:o})):e.createCommentVNode("v-if",!0),e.unref(x.showUpdate)?(e.openBlock(),e.createBlock(ea,{key:5,onClose:s[5]||(s[5]=d=>x.showUpdate.value=!1)})):e.createCommentVNode("v-if",!0),e.createVNode(ha),e.createCommentVNode(" ★ overlay 槽位（list 型）：插件注册的浮动层条目叠加渲染（badge/toast/status pill 等） "),e.createElementVNode("div",{ref_key:"overlaySlotEl",ref:t,class:"plugin-overlay-host"},null,512)],64))}},[["__scopeId","data-v-a045ab80"]]);function ya(r){const t=e.createApp(fa);return t.mount(r),()=>{t.unmount()}}return K.mount=ya,Object.defineProperty(K,Symbol.toStringTag,{value:"Module"}),K})({},window.__PAIRCODE_CORE.Vue,window.__PAIRCODE_CORE.uiState,window.__PAIRCODE_CORE.pluginRuntime,window.__PAIRCODE_CORE.api);
