...
删除后它们仍可继续聊天（配置是完整快照），但在对话面板里会失去模型分组；建议先在「AI 配置」里把它们改选到其他服务商。`),!window.confirm(E))return;const b=L();delete b[V.name];try{await A.saveModels(b),await T(),n("saved")}catch(h){f.value="删除失败: "+(h.message||h)}}function F(V){const p=l.value.find(h=>h.name===V);if(!p)return"";const E=Object.keys(p.modelParams||{}).length,b=[];return p.temperature&&b.push("温度 "+p.temperature),p.maxTokens>0&&b.push("输出上限 "+p.maxTokens),E&&b.push("模型参数 "+E+" 个"),b.join(" · ")}return(V,p)=>(e.openBlock(),e.createElementBlock("div",en,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",nn,[e.createElementVNode("span",tn,e.toDisplayString(l.value.length)+" 个服务商",1),e.createElementVNode("button",{class:"pm-btn pm-primary",onClick:y},"+ 新增服务商")]),e.createCommentVNode(" 新增表单（工具栏下方展开，紧邻按钮不跳动） "),s.value==="__new__"?(e.openBlock(),e.createElementBlock("div",rn,[p[18]||(p[18]=e.createElementVNode("div",{class:"pm-edit-title"},"新增服务商",-1)),e.createElementVNode("div",on,[p[12]||(p[12]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[0]||(p[0]=E=>a.value.name=E),placeholder:"如 deepseek"},null,512),[[e.vModelText,a.value.name]])]),e.createElementVNode("div",ln,[p[13]||(p[13]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[1]||(p[1]=E=>a.value.baseURL=E),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,a.value.baseURL]])]),e.createElementVNode("div",an,[e.createElementVNode("span",sn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":p[2]||(p[2]=E=>a.value.protocol=E),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,E=>(e.openBlock(),e.createElementBlock("option",{key:"p"+E,value:E},e.toDisplayString(E||"默认"),9,dn))),128))],8,cn),[[e.vModelSelect,a.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",pn,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",mn,[p[14]||(p[14]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[3]||(p[3]=E=>a.value.contextMaxTokens=E),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,a.value.contextMaxTokens]])]),e.createElementVNode("div",gn,[p[15]||(p[15]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[4]||(p[4]=E=>a.value.temperature=E),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,a.value.temperature]])]),e.createElementVNode("div",kn,[p[16]||(p[16]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[5]||(p[5]=E=>a.value.maxTokens=E),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,a.value.maxTokens]])]),e.createVNode(Be,{models:d.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:P},null,8,["models","label","placeholder"]),e.createElementVNode("div",hn,[p[17]||(p[17]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),d.value.length?(e.openBlock(),e.createElementBlock("div",fn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,E=>(e.openBlock(),e.createElementBlock("div",{key:E,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:E},e.toDisplayString(E),9,yn),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,b=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:b.name},[b.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:b.hint||b.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":h=>i.value[E][b.name]=h},null,8,bn),[[e.vModelCheckbox,i.value[E][b.name]]]),e.createTextVNode(" "+e.toDisplayString(b.label),1)],8,un)):b.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":h=>i.value[E][b.name]=h,title:b.hint||b.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(b.options||[],h=>(e.openBlock(),e.createElementBlock("option",{key:"o"+h,value:h},e.toDisplayString(h===""?b.label+"默认":h),9,xn))),128))],8,En)),[[e.vModelSelect,i.value[E][b.name]]]):b.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":h=>i.value[E][b.name]=h,type:"number",min:b.min??0,step:b.step??1,placeholder:b.label,title:b.hint||b.label},null,8,Vn)),[[e.vModelText,i.value[E][b.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":h=>i.value[E][b.name]=h,type:"text",placeholder:b.label,title:b.hint||b.label},null,8,Nn)),[[e.vModelText,i.value[E][b.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",wn,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",Bn,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:g.value,onClick:O},e.toDisplayString(g.value?"保存中…":"保存服务商"),9,Tn),e.createElementVNode("button",{class:"pm-btn",onClick:D},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 服务商卡片列表（编辑时在卡片位置就地展开表单，不跳顶） "),l.value.length?(e.openBlock(),e.createElementBlock("div",Sn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(l.value,E=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:E.name},[s.value===E.name?(e.openBlock(),e.createElementBlock("div",Cn,[e.createElementVNode("div",In,"编辑服务商："+e.toDisplayString(E.name),1),e.createElementVNode("div",Pn,[p[19]||(p[19]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[6]||(p[6]=b=>a.value.name=b),placeholder:"如 deepseek"},null,512),[[e.vModelText,a.value.name]]),p[20]||(p[20]=e.createElementVNode("span",{class:"pm-hint"},"改名会一并同步引用该服务商的 AI 配置（连接信息不丢）；空=保持原名",-1))]),e.createElementVNode("div",An,[p[21]||(p[21]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[7]||(p[7]=b=>a.value.baseURL=b),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,a.value.baseURL]])]),e.createElementVNode("div",$n,[e.createElementVNode("span",Mn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":p[8]||(p[8]=b=>a.value.protocol=b),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,b=>(e.openBlock(),e.createElementBlock("option",{key:"p"+b,value:b},e.toDisplayString(b||"默认"),9,Rn))),128))],8,Dn),[[e.vModelSelect,a.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",Ln,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",Fn,[p[22]||(p[22]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[9]||(p[9]=b=>a.value.contextMaxTokens=b),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,a.value.contextMaxTokens]])]),e.createElementVNode("div",Gn,[p[23]||(p[23]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[10]||(p[10]=b=>a.value.temperature=b),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,a.value.temperature]])]),e.createElementVNode("div",On,[p[24]||(p[24]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":p[11]||(p[11]=b=>a.value.maxTokens=b),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,a.value.maxTokens]])]),e.createVNode(Be,{models:d.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:P},null,8,["models","label","placeholder"]),e.createElementVNode("div",zn,[p[25]||(p[25]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),d.value.length?(e.openBlock(),e.createElementBlock("div",Un,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,b=>(e.openBlock(),e.createElementBlock("div",{key:b,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:b},e.toDisplayString(b),9,jn),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,h=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:h.name},[h.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:h.hint||h.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":k=>i.value[b][h.name]=k},null,8,Wn),[[e.vModelCheckbox,i.value[b][h.name]]]),e.createTextVNode(" "+e.toDisplayString(h.label),1)],8,Hn)):h.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":k=>i.value[b][h.name]=k,title:h.hint||h.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(h.options||[],k=>(e.openBlock(),e.createElementBlock("option",{key:"o"+k,value:k},e.toDisplayString(k===""?h.label+"默认":k),9,Jn))),128))],8,qn)),[[e.vModelSelect,i.value[b][h.name]]]):h.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":k=>i.value[b][h.name]=k,type:"number",min:h.min??0,step:h.step??1,placeholder:h.label,title:h.hint||h.label},null,8,Kn)),[[e.vModelText,i.value[b][h.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":k=>i.value[b][h.name]=k,type:"text",placeholder:h.label,title:h.hint||h.label},null,8,Zn)),[[e.vModelText,i.value[b][h.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",Qn,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",Yn,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:g.value,onClick:O},e.toDisplayString(g.value?"保存中…":"保存服务商"),9,Xn),e.createElementVNode("button",{class:"pm-btn",onClick:D},"取消")])])):(e.openBlock(),e.createElementBlock("div",_n,[e.createElementVNode("div",vn,[e.createElementVNode("span",{class:"pm-name",title:E.name},e.toDisplayString(E.name),9,et),e.createElementVNode("div",nt,[e.createElementVNode("button",{class:"pm-btn pm-small",onClick:b=>S(E)},"编辑",8,tt),e.createElementVNode("button",{class:"pm-btn pm-small pm-danger",onClick:b=>z(E)},"删除",8,rt)])]),e.createElementVNode("div",{class:"pm-url",title:E.baseURL},e.toDisplayString(E.baseURL||"未配置 API URL"),9,ot),E.protocol?(e.openBlock(),e.createElementBlock("div",{key:0,class:"pm-protocol",title:r.protocolHint},"协议 "+e.toDisplayString(E.protocol),9,lt)):e.createCommentVNode("v-if",!0),e.createElementVNode("div",at,e.toDisplayString(E.contextMaxTokens>0?"上下文 "+(E.contextMaxTokens/1e3).toFixed(0)+"K Token":"上下文 未限制"),1),e.createElementVNode("div",st,[E.models.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("span",it,"（未配置模型）")),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(E.models,b=>(e.openBlock(),e.createElementBlock("span",{key:b,class:"pm-tag"},e.toDisplayString(b),1))),128))]),F(E.name)?(e.openBlock(),e.createElementBlock("div",ct,e.toDisplayString(F(E.name)),1)):e.createCommentVNode("v-if",!0)]))],64))),128))])):s.value!=="__new__"?(e.openBlock(),e.createElementBlock("div",dt,"暂无服务商，点「+ 新增服务商」添加")):e.createCommentVNode("v-if",!0),f.value?(e.openBlock(),e.createElementBlock("div",pt,e.toDisplayString(f.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-2a9adc20"]]),gt={class:"pm-manager"},kt={class:"mgm-toolbar"},ht={class:"mgm-count"},ft={key:0,class:"mgm-edit"},yt={class:"mgm-edit-title"},ut={class:"mgm-field"},bt={class:"mgm-field-label"},Et={key:0,class:"mgm-required"},xt=["onUpdate:modelValue","onChange"],Vt=["value"],Nt=["onUpdate:modelValue","placeholder"],wt=["onUpdate:modelValue","placeholder"],Bt={key:3,class:"mgm-field-hint"},Tt={class:"mgm-edit-actions"},St=["disabled"],Ct={key:1,class:"mgm-cards"},It={class:"mgm-card-head"},Pt=["title"],At={key:0,class:"pm-active-badge"},$t={class:"mgm-ops"},Mt=["disabled","onClick"],Dt=["onClick"],Rt=["onClick"],Lt={class:"pm-preview"},Ft={class:"pm-snap-row"},Gt={class:"pm-snap-row"},Ot={key:2,class:"mgm-empty"},zt={key:3,class:"mgm-error"},Ut=U({__name:"PresetManager",props:{presetFields:{type:Array,default:()=>[]}},emits:["saved"],setup(r,{expose:t,emit:n}){const o=r,l=n,s=e.ref({}),a=e.computed(()=>Object.keys(s.value||{})),d=e.ref(""),i=e.ref(!1),f=e.ref(""),g=e.ref(!1),B=e.ref(""),w=e.ref(""),T=e.ref(null),y=e.computed(()=>T.value&&T.value.providers||[]),S=e.ref({name:"",provider:"",baseURL:"",apiKey:""});function P(k={}){const m={name:"",provider:"",baseURL:"",apiKey:""};for(const N of o.presetFields)N.name in m||(m[N.name]="");return Object.assign(m,k)}function D(k){w.value=k,setTimeout(()=>{w.value===k&&(w.value="")},4e3)}async function L(){try{const[k,m,N]=await Promise.all([A.getAiPresets().catch(()=>({presets:{}})),A.apiGet("/settings").catch(()=>({settings:{}})),A.getModels().catch(()=>null)]);s.value=k&&k.presets||{},d.value=m&&m.settings&&m.settings.preset||"",T.value=N}catch(k){D("加载失败: "+(k.message||k))}}function O(k){const m=T.value||{};return{baseURL:m.providerBaseURLs&&m.providerBaseURLs[k]||"",models:m.models&&m.models[k]||[]}}function j(){const k=window&&window.__PAIRCODE_CORE&&window.__PAIRCODE_CORE.uiState&&window.__PAIRCODE_CORE.uiState.state&&window.__PAIRCODE_CORE.uiState.state.settings||{};let m={};k.preset&&s.value&&s.value[k.preset]&&(m=s.value[k.preset]);const N=m.provider||y.value[0]||"",c=O(N);S.value=P({provider:N,baseURL:m.baseURL||c.baseURL||"",apiKey:m.apiKey||""}),f.value="",i.value=!0}function z(k){const m=s.value&&s.value[k]||{};S.value=P({name:k,provider:m.provider||"",baseURL:m.baseURL||"",apiKey:m.apiKey||""}),f.value=k,i.value=!0}function F(){i.value=!1,f.value=""}function V(k){return k.source==="providers"?y.value||[]:k.options||[]}function p(k){if(k.name==="provider"&&S.value.provider){const m=O(S.value.provider);S.value.baseURL=m.baseURL||""}}e.watch(()=>S.value.provider,(k,m)=>{!i.value||m===""||k!==m&&p({name:"provider"})});async function E(){const k=S.value.name.trim();if(!k){D("请输入配置名称");return}const m=S.value.provider||"";if(!m){D("请选择服务商");return}for(const c of o.presetFields)if(c.required&&!S.value[c.name]){D("请填写"+c.label);return}const N=O(m);S.value.baseURL||(S.value.baseURL=N.baseURL||""),g.value=!0,w.value="";try{const c={provider:m,baseURL:S.value.baseURL,apiKey:S.value.apiKey};for(const u of o.presetFields)u.name!=="provider"&&u.name!=="apiKey"&&(c[u.name]=S.value[u.name]);if(f.value&&f.value!==k){const u={...s.value||{}};u[k]=c,delete u[f.value];const C=await A.saveAiPresets(u);if(!(C&&C.ok)){D(C&&C.error||"保存失败");return}s.value=u,d.value===f.value&&(d.value=k,await A.apiPut("/settings",{settings:{preset:k},pluginSettings:{}}).catch(()=>{}))}else{const u=await A.saveAiPreset("save",k,c);if(!(u&&u.ok)){D(u&&u.error||"保存失败");return}s.value=u.presets||s.value}F(),l("saved")}catch(c){D("保存失败: "+(c.message||c))}finally{g.value=!1}}async function b(k){B.value=k,w.value="";try{const m=await A.saveAiPreset("apply",k);m&&m.ok?(d.value=k,l("saved")):D(m&&m.error||"应用失败")}catch(m){D("应用失败: "+(m.message||m))}finally{B.value=""}}async function h(k){if(confirm("删除配置「"+k+"」？")){w.value="";try{const m=await A.saveAiPreset("delete",k);m&&m.ok?(s.value=m.presets||s.value,d.value===k&&(d.value=""),l("saved")):D(m&&m.error||"删除失败")}catch(m){D("删除失败: "+(m.message||m))}}}return e.onMounted(L),t({load:L}),(k,m)=>(e.openBlock(),e.createElementBlock("div",gt,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",kt,[e.createElementVNode("span",ht,e.toDisplayString(a.value.length)+" 个配置",1),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:j,title:"添加一条 AI 配置（服务商 + API Key）"},"＋ 添加新配置")]),e.createCommentVNode(" 添加 / 编辑表单（点击添加/编辑才弹出） "),i.value?(e.openBlock(),e.createElementBlock("div",ft,[e.createElementVNode("div",yt,e.toDisplayString(f.value?"编辑配置："+f.value:"添加新配置"),1),e.createElementVNode("div",ut,[m[1]||(m[1]=e.createElementVNode("span",{class:"mgm-field-label"},"配置名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":m[0]||(m[0]=N=>S.value.name=N),type:"text",placeholder:"如：主力 / 写作备用…",onKeydown:e.withKeys(E,["enter"])},null,544),[[e.vModelText,S.value.name]])]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.presetFields,N=>(e.openBlock(),e.createElementBlock("div",{key:N.name,class:"mgm-field"},[e.createElementVNode("span",bt,[e.createTextVNode(e.toDisplayString(N.label),1),N.required?(e.openBlock(),e.createElementBlock("span",Et,"*")):e.createCommentVNode("v-if",!0)]),e.createCommentVNode(" select 类型（服务商选择） "),N.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:0,"onUpdate:modelValue":c=>S.value[N.name]=c,class:"mgm-select",onChange:c=>p(N)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(V(N),c=>(e.openBlock(),e.createElementBlock("option",{key:c,value:c},e.toDisplayString(c),9,Vt))),128))],40,xt)),[[e.vModelSelect,S.value[N.name]]]):N.type==="password"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" password 类型（API Key） "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":c=>S.value[N.name]=c,type:"password",placeholder:N.placeholder||""},null,8,Nt),[[e.vModelText,S.value[N.name]]])],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" text 兜底 "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":c=>S.value[N.name]=c,type:"text",placeholder:N.placeholder||""},null,8,wt),[[e.vModelText,S.value[N.name]]])],2112)),N.hint?(e.openBlock(),e.createElementBlock("span",Bt,e.toDisplayString(N.hint),1)):e.createCommentVNode("v-if",!0)]))),128)),e.createElementVNode("div",Tt,[e.createElementVNode("button",{class:"mgm-btn mgm-primary",disabled:g.value,onClick:E},e.toDisplayString(g.value?"保存中…":"保存配置"),9,St),e.createElementVNode("button",{class:"mgm-btn",onClick:F},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 配置卡片列表（主视图） "),a.value.length?(e.openBlock(),e.createElementBlock("div",Ct,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(a.value,N=>(e.openBlock(),e.createElementBlock("div",{key:N,class:e.normalizeClass(["mgm-card",{"pm-active":N===d.value}])},[e.createElementVNode("div",It,[e.createElementVNode("span",{class:"mgm-name",title:N},[e.createTextVNode(e.toDisplayString(N),1),N===d.value?(e.openBlock(),e.createElementBlock("span",At,"使用中")):e.createCommentVNode("v-if",!0)],8,Pt),e.createElementVNode("div",$t,[e.createElementVNode("button",{class:"mgm-btn mgm-small",disabled:B.value===N,onClick:c=>b(N)},e.toDisplayString(B.value===N?"应用中…":"应用"),9,Mt),e.createElementVNode("button",{class:"mgm-btn mgm-small",onClick:c=>z(N)},"编辑",8,Dt),e.createElementVNode("button",{class:"mgm-btn mgm-small mgm-danger",onClick:c=>h(N)},"删除",8,Rt)])]),e.createElementVNode("div",Lt,[e.createElementVNode("div",Ft,[m[2]||(m[2]=e.createElementVNode("span",null,"服务商",-1)),e.createElementVNode("b",null,e.toDisplayString((s.value[N]||{}).provider||"—"),1)]),e.createElementVNode("div",Gt,[m[3]||(m[3]=e.createElementVNode("span",null,"API Key",-1)),e.createElementVNode("b",null,e.toDisplayString((s.value[N]||{}).apiKey?"已配置":"未配置"),1)])])],2))),128))])):i.value?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",Ot,[e.createElementVNode("div",{class:"mgm-empty-box"},[m[4]||(m[4]=e.createElementVNode("div",{class:"mgm-empty-title"},"还没有 AI 配置",-1)),m[5]||(m[5]=e.createElementVNode("div",{class:"mgm-empty-sub"},"添加一条服务商 + API Key，保存后即可在对话面板中选模型。",-1)),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:j},"＋ 添加新配置")])])),w.value?(e.openBlock(),e.createElementBlock("div",zt,e.toDisplayString(w.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-ce50425c"]]),jt={class:"modal-content"},Ht={class:"modal-body"},Wt={key:0,class:"settings-tabs"},qt={key:0,class:"settings-tabs-filter-wrap"},Jt=["onClick"],Kt={key:1,class:"settings-tabs-none"},Zt={class:"settings-content"},Qt={key:0},Yt={key:0,class:"group-title"},Xt=["title"],_t=["title"],vt=["onUpdate:modelValue"],er=["title"],nr={class:"field-control"},tr=["type","onUpdate:modelValue","placeholder"],rr=["onUpdate:modelValue","min","max","step"],or=["onUpdate:modelValue","onChange"],lr=["value"],ar=["onUpdate:modelValue","placeholder"],sr={class:"slider-row"},ir=["onUpdate:modelValue","min","max","step"],cr={class:"slider-val"},dr={class:"color-row"},pr=["onUpdate:modelValue"],mr={class:"color-code"},gr=["value","onInput","placeholder"],kr=["placeholder"],hr=["onUpdate:modelValue"],fr={key:0,class:"setting-hint"},yr={key:0,class:"settings-empty"},ur=U({__name:"SettingsModal",emits:["close"],setup(r,{emit:t}){const n=t,o=e.ref(""),l=e.ref(""),s=e.computed(()=>{const h=(x.state.pluginSchemas||[]).map(k=>({key:k.key,title:k.title||k.key,groups:d(k.fields||[])}));return h.length&&!o.value&&(o.value=h[0].key),h}),a=e.computed(()=>{const h=l.value.trim().toLowerCase();if(!h)return s.value;const k=s.value.find(N=>N.key===o.value),m=s.value.filter(N=>(N.title||N.key).toLowerCase().includes(h));return k&&!m.includes(k)&&m.unshift(k),m});function d(h){const k=[],m={};for(const N of h){const c=N.group||"";m[c]||(m[c]=[],k.push({title:c,fields:m[c]})),m[c].push(N)}return k}const i=e.ref(null);let f="";async function g(){try{i.value=await A.getModels()}catch{i.value=null}}function B(h){return h?(i.value&&i.value.models||{})[h]||[]:[]}function w(h,k){var m,N,c;if(k.optionsSource==="models"){const u=(m=y[h])==null?void 0:m[k.name],C=B((N=y.ai)==null?void 0:N.provider);return u&&!C.includes(u)?[...C,u]:C}if(k.optionsSource==="providers"){const u=i.value&&i.value.providers||[];if(u.length){const C=(c=y[h])==null?void 0:c[k.name];return C&&!u.includes(C)?[...u,C]:u}return k.options||[]}return k.options||[]}function T(h){if(!y.ai)return;const k=y.ai,m=h.linkFields||(h.linkField?[h.linkField]:[]);if(!m.length)return;const N=i.value||{},c=N.providerBaseURLs||{},u=N.providerKeys||{},C=k.provider,v=c[f];for(const de of m)if(de==="apiKey")k[de]=u[C]||"";else{const xe=k[de];(xe===void 0||xe===""||v&&xe===v)&&(k[de]=c[C]||"")}f=C}const y=e.reactive({}),S=e.ref("");function P(h){switch(h){case"checkbox":return!1;case"number":return 0;case"tags":return[];default:return""}}function D(){for(const N of Object.keys(y))delete y[N];const h=x.state.settings||{};f=h.provider||"";const k=h.pluginSettings||{};for(const N of x.state.pluginSchemas||[]){y[N.key]={};for(const c of N.fields||[]){let u;if(!(c.type==="project"||c.type==="provider-manager"||c.type==="model-params-manager"||c.type==="preset-manager")){if(c.binding)u=h[c.binding]!==void 0?h[c.binding]:c.default;else{const C=k[N.key]||{};u=C[c.name]!==void 0?C[c.name]:c.default}u===void 0&&(u=P(c.type)),c.type==="checkbox"&&(u=!!u),c.type==="number"&&(u=typeof u=="number"?u:Number(u)||0),c.type==="tags"&&(u=Array.isArray(u)?u:[]),y[N.key][c.name]=u}}}const m=(x.state.pluginSchemas||[]).some(N=>(N.fields||[]).some(c=>c.type==="project"));S.value="",m&&j()}function L(h,k){var N;const m=(N=y[h])==null?void 0:N[k.name];return Array.isArray(m)?m.join(", "):m||""}function O(h,k,m){y[h][k.name]=m.target.value.split(",").map(N=>N.trim()).filter(Boolean)}async function j(){try{const h=await A.getInstructions("project");S.value=h.content||""}catch{}}function z(){var h;D(),(h=x.state.settings)!=null&&h.theme&&x.applyTheme(x.state.settings.theme)}const F=()=>{z()},V=e.ref(0);async function p(){await g(),V.value++}async function E(){try{const h=await A.apiGet("/settings");h&&h.settings&&(x.state.settings=h.settings,await g(),z())}catch{}}const b=async()=>{try{let h={};try{const c=await A.apiGet("/settings");h=c&&c.settings||{}}catch{}const k={...h},m={...h.pluginSettings||{}};let N=!1;for(const c of x.state.pluginSchemas||[]){const u=y[c.key]||{};for(const C of c.fields||[]){if(C.type==="project"){await A.saveInstructions("project",S.value);continue}if(C.type==="provider-manager"||C.type==="model-params-manager"||C.type==="preset-manager")continue;const v=u[C.name];C.binding?(C.name==="theme"&&v!==k[C.binding]&&(N=!0),k[C.binding]=v):(m[c.key]||(m[c.key]={}),m[c.key][C.name]=v)}}await A.apiPut("/settings",{settings:k,pluginSettings:m}),x.state.settings=k,N&&x.applyTheme(k.theme),window.$toast("设置已保存","success"),n("close")}catch(h){window.$toast("保存失败: "+h.message,"error")}};return D(),e.onMounted(async()=>{await g(),z()}),(h,k)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:k[3]||(k[3]=e.withModifiers(m=>h.$emit("close"),["self"]))},[e.createElementVNode("div",jt,[e.createElementVNode("h2",null,[e.createVNode(R,{name:"settings",size:18}),k[4]||(k[4]=e.createTextVNode(" 设置 ",-1)),e.createElementVNode("button",{class:"modal-close",onClick:k[0]||(k[0]=m=>h.$emit("close"))},"×")]),e.createElementVNode("div",Ht,[e.createCommentVNode(" ═══ 纯 schema 驱动：所有配置 tab 由插件 ctx.registerSettings 注册 ═══ "),s.value.length?(e.openBlock(),e.createElementBlock("div",Wt,[s.value.length>6?(e.openBlock(),e.createElementBlock("div",qt,[e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":k[1]||(k[1]=m=>l.value=m),class:"settings-tabs-filter",type:"text",placeholder:"筛选设置…"},null,512),[[e.vModelText,l.value]])])):e.createCommentVNode("v-if",!0),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(a.value,m=>(e.openBlock(),e.createElementBlock("button",{key:m.key,class:e.normalizeClass(["settings-tab",{active:o.value===m.key}]),onClick:N=>o.value=m.key},e.toDisplayString(m.title),11,Jt))),128)),a.value.length===0?(e.openBlock(),e.createElementBlock("div",Kt,"无匹配设置")):e.createCommentVNode("v-if",!0)])):e.createCommentVNode("v-if",!0),e.createElementVNode("div",Zt,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(s.value,m=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:m.key},[o.value===m.key?(e.openBlock(),e.createElementBlock("div",Qt,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(m.groups,N=>(e.openBlock(),e.createElementBlock("div",{key:N.title||"__main",class:"setting-group"},[N.title?(e.openBlock(),e.createElementBlock("div",Yt,e.toDisplayString(N.title),1)):e.createCommentVNode("v-if",!0),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(N.fields,c=>(e.openBlock(),e.createElementBlock("div",{key:c.name,class:e.normalizeClass(["setting-row",{"row-toggle":c.type==="checkbox"}])},[e.createCommentVNode(" checkbox：label 与开关同行 "),c.type==="checkbox"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:0},[e.createElementVNode("label",{class:"field-label",title:c.hint},e.toDisplayString(c.label),9,Xt),e.createElementVNode("label",{class:"pp-switch",title:c.hint},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":u=>y[m.key][c.name]=u},null,8,vt),[[e.vModelCheckbox,y[m.key][c.name]]]),k[5]||(k[5]=e.createElementVNode("span",{class:"pp-switch-track"},null,-1))],8,_t)],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" 其他类型：label 在上、控件在下、说明文字在控件下方（不挤占输入区） "),e.createElementVNode("label",{class:"field-label",title:c.hint},e.toDisplayString(c.label),9,er),e.createElementVNode("div",nr,[e.createCommentVNode(" text / password "),c.type==="text"||c.type==="password"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:0,class:"field-input",type:c.type==="password"?"password":"text","onUpdate:modelValue":u=>y[m.key][c.name]=u,placeholder:c.placeholder},null,8,tr)),[[e.vModelDynamic,y[m.key][c.name]]]):c.type==="number"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" number "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"number","onUpdate:modelValue":u=>y[m.key][c.name]=u,min:c.min,max:c.max,step:c.step},null,8,rr),[[e.vModelText,y[m.key][c.name],void 0,{number:!0}]])],2112)):c.type==="select"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" select（optionsSource 驱动动态数据源：models=按服务商模型列表 / providers=服务商列表） "),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":u=>y[m.key][c.name]=u,class:"field-select",onChange:u=>T(c)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(w(m.key,c),u=>(e.openBlock(),e.createElementBlock("option",{key:u,value:u},e.toDisplayString(u),9,lr))),128))],40,or),[[e.vModelSelect,y[m.key][c.name]]])],2112)):c.type==="textarea"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:3},[e.createCommentVNode(" textarea "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":u=>y[m.key][c.name]=u,class:"field-textarea",rows:"4",placeholder:c.placeholder},null,8,ar),[[e.vModelText,y[m.key][c.name]]])],2112)):c.type==="slider"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:4},[e.createCommentVNode(" slider "),e.createElementVNode("div",sr,[e.withDirectives(e.createElementVNode("input",{type:"range","onUpdate:modelValue":u=>y[m.key][c.name]=u,min:c.min!=null?c.min:0,max:c.max!=null?c.max:100,step:c.step||1},null,8,ir),[[e.vModelText,y[m.key][c.name],void 0,{number:!0}]]),e.createElementVNode("span",cr,e.toDisplayString(y[m.key][c.name]),1)])],2112)):c.type==="color"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:5},[e.createCommentVNode(" color "),e.createElementVNode("div",dr,[e.withDirectives(e.createElementVNode("input",{type:"color","onUpdate:modelValue":u=>y[m.key][c.name]=u},null,8,pr),[[e.vModelText,y[m.key][c.name]]]),e.createElementVNode("code",mr,e.toDisplayString(y[m.key][c.name]),1)])],2112)):c.type==="tags"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:6},[e.createCommentVNode(" tags（逗号分隔数组） "),e.createElementVNode("input",{type:"text",class:"field-input",value:L(m.key,c),onInput:u=>O(m.key,c,u),placeholder:c.placeholder||"逗号分隔"},null,40,gr)],2112)):c.type==="project"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:7},[e.createCommentVNode(" project（平台特殊：项目级指令，经 /api/instructions 读写） "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":k[2]||(k[2]=u=>S.value=u),class:"field-textarea",rows:"4",placeholder:c.placeholder},null,8,kr),[[e.vModelText,S.value]])],2112)):c.type==="provider-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:8},[e.createCommentVNode(" provider-manager（服务商维护面板：CRUD /api/models，独立保存，不参与普通表单） "),e.createVNode(mt,{"model-param-fields":c.modelParamFields||[],"model-editor":c.modelEditor||{},"protocol-label":c.protocolLabel||"LLM 协议","protocol-options":c.protocolOptions||[],"protocol-hint":c.protocolHint||"",onSaved:p},null,8,["model-param-fields","model-editor","protocol-label","protocol-options","protocol-hint"])],2112)):c.type==="preset-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:9},[e.createCommentVNode(" preset-manager（AI 配置预设面板：CRUD /api/ai-presets，独立保存，不参与普通表单） "),(e.openBlock(),e.createBlock(Ut,{key:V.value,"preset-fields":c.presetFields||[],onSaved:E},null,8,["preset-fields"]))],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:10},[e.createCommentVNode(" 兜底 text "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"text","onUpdate:modelValue":u=>y[m.key][c.name]=u},null,8,hr),[[e.vModelText,y[m.key][c.name]]])],2112))]),c.hint?(e.openBlock(),e.createElementBlock("span",fr,e.toDisplayString(c.hint),1)):e.createCommentVNode("v-if",!0)],64))],2))),128))]))),128))])):e.createCommentVNode("v-if",!0)],64))),128)),s.value.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",yr,"暂无配置项（等待插件注册…）"))])]),e.createElementVNode("div",{class:"modal-footer"},[e.createElementVNode("button",{class:"btn-secondary",onClick:F},"撤销"),e.createElementVNode("button",{class:"btn-primary",onClick:b},"保存设置")])])]))}},[["__scopeId","data-v-ca938c4c"]]),br={class:"modal-content sys-modal"},Er={class:"modal-header"},xr={class:"modal-body"},Vr={key:0,class:"loading"},Nr={key:1,class:"sys-info"},wr={class:"info-row"},Br={class:"info-row"},Tr={class:"info-row"},Sr={class:"info-row"},Cr={class:"info-row"},Ir={class:"info-row"},Pr={class:"modal-footer"},Ar=U({__name:"SystemModal",emits:["close"],setup(r,{emit:t}){const n=e.ref(!0),o=e.ref({});return e.onMounted(async()=>{try{o.value=await A.apiGet("/system/info")}catch{}n.value=!1}),(l,s)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:s[2]||(s[2]=e.withModifiers(a=>l.$emit("close"),["self"]))},[e.createElementVNode("div",br,[e.createElementVNode("div",Er,[s[3]||(s[3]=e.createElementVNode("h2",null,"ℹ 系统信息",-1)),e.createElementVNode("button",{class:"modal-close",onClick:s[0]||(s[0]=a=>l.$emit("close"))},"×")]),e.createElementVNode("div",xr,[n.value?(e.openBlock(),e.createElementBlock("div",Vr,"加载中...")):(e.openBlock(),e.createElementBlock("div",Nr,[e.createElementVNode("div",wr,[s[4]||(s[4]=e.createElementVNode("label",null,"主机名",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.hostname),1)]),e.createElementVNode("div",Br,[s[5]||(s[5]=e.createElementVNode("label",null,"当前目录",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.cwd),1)]),e.createElementVNode("div",Tr,[s[6]||(s[6]=e.createElementVNode("label",null,"操作系统",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.os),1)]),e.createElementVNode("div",Sr,[s[7]||(s[7]=e.createElementVNode("label",null,"Go 版本",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.goos),1)]),e.createElementVNode("div",Cr,[s[8]||(s[8]=e.createElementVNode("label",null,"工作区",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.workspace),1)]),e.createElementVNode("div",Ir,[s[9]||(s[9]=e.createElementVNode("label",null,"文件夹",-1)),e.createElementVNode("span",null,e.toDisplayString((o.value.folders||[]).join(", ")),1)])]))]),e.createElementVNode("div",Pr,[e.createElementVNode("button",{class:"btn-secondary",onClick:s[1]||(s[1]=a=>l.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-c27b6ec9"]]),$r={class:"modal-content source-modal"},Mr={class:"modal-header"},Dr={class:"modal-footer"},Rr=U({__name:"SourceModal",emits:["close"],setup(r){return(t,n)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:n[2]||(n[2]=e.withModifiers(o=>t.$emit("close"),["self"]))},[e.createElementVNode("div",$r,[e.createElementVNode("div",Mr,[n[3]||(n[3]=e.createElementVNode("h2",null,"⎔ 源代码管理",-1)),e.createElementVNode("button",{class:"modal-close",onClick:n[0]||(n[0]=o=>t.$emit("close"))},"×")]),n[4]||(n[4]=e.createElementVNode("div",{class:"modal-body"},[e.createElementVNode("p",{style:{color:"var(--text-muted)","text-align":"center","margin-top":"40px"}},[e.createTextVNode(" Git 集成开发中"),e.createElementVNode("br"),e.createElementVNode("br"),e.createTextVNode(" 功能规划："),e.createElementVNode("br"),e.createTextVNode(" · Git 状态查看"),e.createElementVNode("br"),e.createTextVNode(" · 暂存/提交/推送"),e.createElementVNode("br"),e.createTextVNode(" · 分支管理"),e.createElementVNode("br"),e.createTextVNode(" · Diff 对比 ")])],-1)),e.createElementVNode("div",Dr,[e.createElementVNode("button",{class:"btn-secondary",onClick:n[1]||(n[1]=o=>t.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-2e060397"]]),Lr=`# 功能介绍
...
`).split(`
`),o="",l="",s=[];for(;n.length>0;){let a=!1,d=[],i;for(i=0;i<n.length;i++)if(this.rules.other.blockquoteStart.test(n[i]))d.push(n[i]),a=!0;else if(!a)d.push(n[i]);else break;n=n.slice(i);let f=d.join(`
`),g=f.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");o=o?`${o}
${f}`:f,l=l?`${l}
${g}`:g;let B=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(g,s,!0),this.lexer.state.top=B,n.length===0)break;let w=s.at(-1);if((w==null?void 0:w.type)==="code")break;if((w==null?void 0:w.type)==="blockquote"){let T=w,y=T.raw+`
`+n.join(`
`),S=this.blockquote(y);s[s.length-1]=S,o=o.substring(0,o.length-T.raw.length)+S.raw,l=l.substring(0,l.length-T.text.length)+S.text;break}else if((w==null?void 0:w.type)==="list"){let T=w,y=T.raw+`
`+n.join(`
`),S=this.list(y);s[s.length-1]=S,o=o.substring(0,o.length-w.raw.length)+S.raw,l=l.substring(0,l.length-T.raw.length)+S.raw,n=y.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:o,tokens:s,text:l}}}list(r){let t=this.rules.block.list.exec(r);if(t){let n=t[1].trim(),o=n.length>1,l={type:"list",raw:"",ordered:o,start:o?+n.slice(0,-1):"",loose:!1,items:[]};n=o?`\\d{1,9}\\${n.slice(-1)}`:`\\${n}`,this.options.pedantic&&(n=o?n:"[*+-]");let s=this.rules.other.listItemRegex(n),a=!1;for(;r;){let i=!1,f="",g="";if(!(t=s.exec(r))||this.rules.block.hr.test(r))break;f=t[0],r=r.substring(f.length);let B=Co(t[2].split(`
`,1)[0],t[1].length),w=r.split(`
`,1)[0],T=!B.trim(),y=0;if(this.options.pedantic?(y=2,g=B.trimStart()):T?y=t[1].length+1:(y=B.search(this.rules.other.nonSpaceChar),y=y>4?1:y,g=B.slice(y),y+=t[1].length),T&&this.rules.other.blankLine.test(w)&&(f+=w+`
`,r=r.substring(w.length+1),i=!0),!i){let S=this.rules.other.nextBulletRegex(y),P=this.rules.other.hrRegex(y),D=this.rules.other.fencesBeginRegex(y),L=this.rules.other.headingBeginRegex(y),O=this.rules.other.htmlBeginRegex(y),j=this.rules.other.blockquoteBeginRegex(y);for(;r;){let z=r.split(`
`,1)[0],F;if(w=z,this.options.pedantic?(w=w.replace(this.rules.other.listReplaceNesting,"  "),F=w):F=w.replace(this.rules.other.tabCharGlobal,"    "),D.test(w)||L.test(w)||O.test(w)||j.test(w)||S.test(w)||P.test(w))break;if(F.search(this.rules.other.nonSpaceChar)>=y||!w.trim())g+=`
`+F.slice(y);else{if(T||B.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||D.test(B)||L.test(B)||P.test(B))break;g+=`
`+w}T=!w.trim(),f+=z+`
`,r=r.substring(z.length+1),B=F.slice(y)}}l.loose||(a?l.loose=!0:this.rules.other.doubleBlankLine.test(f)&&(a=!0)),l.items.push({type:"list_item",raw:f,task:!!this.options.gfm&&this.rules.other.listIsTask.test(g),loose:!1,text:g,tokens:[]}),l.raw+=f}let d=l.items.at(-1);if(d)d.raw=d.raw.trimEnd(),d.text=d.text.trimEnd();else return;l.raw=l.raw.trimEnd();for(let i of l.items){this.lexer.state.top=!1,i.tokens=this.lexer.blockTokens(i.text,[]);let f=i.tokens[0];if(i.task&&((f==null?void 0:f.type)==="text"||(f==null?void 0:f.type)==="paragraph")){i.text=i.text.replace(this.rules.other.listReplaceTask,""),f.raw=f.raw.replace(this.rules.other.listReplaceTask,""),f.text=f.text.replace(this.rules.other.listReplaceTask,"");for(let B=this.lexer.inlineQueue.length-1;B>=0;B--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[B].src)){this.lexer.inlineQueue[B].src=this.lexer.inlineQueue[B].src.replace(this.rules.other.listReplaceTask,"");break}let g=this.rules.other.listTaskCheckbox.exec(i.raw);if(g){let B={type:"checkbox",raw:g[0]+" ",checked:g[0]!=="[ ]"};i.checked=B.checked,l.loose?i.tokens[0]&&["paragraph","text"].includes(i.tokens[0].type)&&"tokens"in i.tokens[0]&&i.tokens[0].tokens?(i.tokens[0].raw=B.raw+i.tokens[0].raw,i.tokens[0].text=B.raw+i.tokens[0].text,i.tokens[0].tokens.unshift(B)):i.tokens.unshift({type:"paragraph",raw:B.raw,text:B.raw,tokens:[B]}):i.tokens.unshift(B)}}else i.task&&(i.task=!1);if(!l.loose){let g=i.tokens.filter(w=>w.type==="space"),B=g.length>0&&g.some(w=>this.rules.other.anyLine.test(w.raw));l.loose=B}}if(l.loose)for(let i of l.items){i.loose=!0;for(let f of i.tokens)f.type==="text"&&(f.type="paragraph")}return l}}html(r){let t=this.rules.block.html.exec(r);if(t){let n=Ue(t[0]);return{type:"html",block:!0,raw:n,pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:n}}}def(r){let t=this.rules.block.def.exec(r);if(t){let n=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),o=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",l=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:n,raw:K(t[0],`
...
`):[],s={type:"table",raw:K(t[0],`
`),header:[],align:[],rows:[]};if(n.length===o.length){for(let d of o)this.rules.other.tableAlignRight.test(d)?s.align.push("right"):this.rules.other.tableAlignCenter.test(d)?s.align.push("center"):this.rules.other.tableAlignLeft.test(d)?s.align.push("left"):s.align.push(null);for(let d=0;d<n.length;d++)s.header.push({text:n[d],tokens:this.lexer.inline(n[d]),header:!0,align:s.align[d]});for(let d of l)s.rows.push(ze(d,s.header.length).map((i,f)=>({text:i,tokens:this.lexer.inline(i),header:!1,align:s.align[f]})));return s}}lheading(r){let t=this.rules.block.lheading.exec(r);if(t){let n=t[1].trim();return{type:"heading",raw:K(t[0],`
...
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:n,tokens:this.lexer.inline(n)}}}text(r){let t=this.rules.block.text.exec(r);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(r){let t=this.rules.inline.escape.exec(r);if(t)return{type:"escape",raw:t[0],text:t[1]}}tag(r){let t=this.rules.inline.tag.exec(r);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(r){let t=this.rules.inline.link.exec(r);if(t){let n=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(n)){if(!this.rules.other.endAngleBracket.test(n))return;let s=K(n.slice(0,-1),"\\");if((n.length-s.length)%2===0)return}else{let s=So(t[2],"()");if(s===-2)return;if(s>-1){let a=(t[0].indexOf("!")===0?5:4)+t[1].length+s;t[2]=t[2].substring(0,s),t[0]=t[0].substring(0,a).trim(),t[3]=""}}let o=t[2],l="";if(this.options.pedantic){let s=this.rules.other.pedanticHrefTitle.exec(o);s&&(o=s[1],l=s[3])}else l=t[3]?t[3].slice(1,-1):"";return o=o.trim(),this.rules.other.startAngleBracket.test(o)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(n)?o=o.slice(1):o=o.slice(1,-1)),je(t,{href:o&&o.replace(this.rules.inline.anyPunctuation,"$1"),title:l&&l.replace(this.rules.inline.anyPunctuation,"$1")},t[0],this.lexer,this.rules)}}reflink(r,t){let n;if((n=this.rules.inline.reflink.exec(r))||(n=this.rules.inline.nolink.exec(r))){let o=(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal," "),l=t[o.toLowerCase()];if(!l){let s=n[0].charAt(0);return{type:"text",raw:s,text:s}}return je(n,l,n[0],this.lexer,this.rules)}}emStrong(r,t,n=""){let o=this.rules.inline.emStrongLDelim.exec(r);if(!(!o||!o[1]&&!o[2]&&!o[3]&&!o[4]||o[4]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(o[1]||o[3])||!n||this.rules.inline.punctuation.exec(n))){let l=[...o[0]].length-1,s,a,d=l,i=0,f=o[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(f.lastIndex=0,t=t.slice(-1*r.length+l);(o=f.exec(t))!==null;){if(s=o[1]||o[2]||o[3]||o[4]||o[5]||o[6],!s)continue;if(a=[...s].length,o[3]||o[4]){d+=a;continue}else if((o[5]||o[6])&&l%3&&!((l+a)%3)){i+=a;continue}if(d-=a,d>0)continue;a=Math.min(a,a+d+i);let g=[...o[0]][0].length,B=r.slice(0,l+o.index+g+a);if(Math.min(l,a)%2){let T=B.slice(1,-1);return{type:"em",raw:B,text:T,tokens:this.lexer.inlineTokens(T)}}let w=B.slice(2,-2);return{type:"strong",raw:B,text:w,tokens:this.lexer.inlineTokens(w)}}}}codespan(r){let t=this.rules.inline.code.exec(r);if(t){let n=t[2].replace(this.rules.other.newLineCharGlobal," "),o=this.rules.other.nonSpaceChar.test(n),l=this.rules.other.startingSpaceChar.test(n)&&this.rules.other.endingSpaceChar.test(n);return o&&l&&(n=n.substring(1,n.length-1)),{type:"codespan",raw:t[0],text:n}}}br(r){let t=this.rules.inline.br.exec(r);if(t)return{type:"br",raw:t[0]}}del(r,t,n=""){let o=this.rules.inline.delLDelim.exec(r);if(o&&(!o[1]||!n||this.rules.inline.punctuation.exec(n))){let l=[...o[0]].length-1,s,a,d=l,i=this.rules.inline.delRDelim;for(i.lastIndex=0,t=t.slice(-1*r.length+l);(o=i.exec(t))!==null;){if(s=o[1]||o[2]||o[3]||o[4]||o[5]||o[6],!s||(a=[...s].length,a!==l))continue;if(o[3]||o[4]){d+=a;continue}if(d-=a,d>0)continue;a=Math.min(a,a+d);let f=[...o[0]][0].length,g=r.slice(0,l+o.index+f+a),B=g.slice(l,-l);return{type:"del",raw:g,text:B,tokens:this.lexer.inlineTokens(B)}}}}autolink(r){let t=this.rules.inline.autolink.exec(r);if(t){let n,o;return t[2]==="@"?(n=t[1],o="mailto:"+n):(n=t[1],o=n),{type:"link",raw:t[0],text:n,href:o,tokens:[{type:"text",raw:n,text:n}]}}}url(r){var n;let t;if(t=this.rules.inline.url.exec(r)){let o,l;if(t[2]==="@")o=t[0],l="mailto:"+o;else{let s;do s=t[0],t[0]=((n=this.rules.inline._backpedal.exec(t[0]))==null?void 0:n[0])??"";while(s!==t[0]);o=t[0],t[1]==="www."?l="http://"+t[0]:l=t[0]}return{type:"link",raw:t[0],text:o,href:l,tokens:[{type:"text",raw:o,text:o}]}}}inlineText(r){let t=this.rules.inline.text.exec(r);if(t){let n=this.lexer.state.inRawBlock;return{type:"text",raw:t[0],text:t[0],escaped:n}}}},H=class Ve{constructor(t){M(this,"tokens");M(this,"options");M(this,"state");M(this,"inlineQueue");M(this,"tokenizer");this.tokens=[],this.tokens.links=Object.create(null),this.options=t||Z,this.options.tokenizer=this.options.tokenizer||new se,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let n={other:G,block:ae.normal,inline:ne.normal};this.options.pedantic?(n.block=ae.pedantic,n.inline=ne.pedantic):this.options.gfm&&(n.block=ae.gfm,this.options.breaks?n.inline=ne.breaks:n.inline=ne.gfm),this.tokenizer.rules=n}static get rules(){return{block:ae,inline:ne}}static lex(t,n){return new Ve(n).lex(t)}static lexInline(t,n){return new Ve(n).inlineTokens(t)}lex(t){t=t.replace(G.carriageReturn,`
`),this.blockTokens(t,this.tokens);for(let n=0;n<this.inlineQueue.length;n++){let o=this.inlineQueue[n];this.inlineTokens(o.src,o.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(t,n=[],o=!1){var s,a,d;this.tokenizer.lexer=this,this.options.pedantic&&(t=t.replace(G.tabCharGlobal,"    ").replace(G.spaceLine,""));let l=1/0;for(;t;){if(t.length<l)l=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}let i;if((a=(s=this.options.extensions)==null?void 0:s.block)!=null&&a.some(g=>(i=g.call({lexer:this},t,n))?(t=t.substring(i.raw.length),n.push(i),!0):!1))continue;if(i=this.tokenizer.space(t)){t=t.substring(i.raw.length);let g=n.at(-1);i.raw.length===1&&g!==void 0?g.raw+=`
...
`)?"":`
`)+i.raw,g.text+=`
`+i.raw,this.inlineQueue.at(-1).src=g.text):this.tokens.links[i.tag]||(this.tokens.links[i.tag]={href:i.href,title:i.title},n.push(i));continue}if(i=this.tokenizer.table(t)){t=t.substring(i.raw.length),n.push(i);continue}if(i=this.tokenizer.lheading(t)){t=t.substring(i.raw.length),n.push(i);continue}let f=t;if((d=this.options.extensions)!=null&&d.startBlock){let g=1/0,B=t.slice(1),w;this.options.extensions.startBlock.forEach(T=>{w=T.call({lexer:this},B),typeof w=="number"&&w>=0&&(g=Math.min(g,w))}),g<1/0&&g>=0&&(f=t.substring(0,g+1))}if(this.state.top&&(i=this.tokenizer.paragraph(f))){let g=n.at(-1);o&&(g==null?void 0:g.type)==="paragraph"?(g.raw+=(g.raw.endsWith(`
`)?"":`
`)+i.raw,g.text+=`
...
`)?"":`
`)+i.raw,g.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=g.text):n.push(i);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){var f,g,B,w,T;this.tokenizer.lexer=this;let o=t,l=null;if(this.tokens.links){let y=Object.keys(this.tokens.links);if(y.length>0)for(;(l=this.tokenizer.rules.inline.reflinkSearch.exec(o))!==null;)y.includes(l[0].slice(l[0].lastIndexOf("[")+1,-1))&&(o=o.slice(0,l.index)+"["+"a".repeat(l[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(l=this.tokenizer.rules.inline.anyPunctuation.exec(o))!==null;)o=o.slice(0,l.index)+"++"+o.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(l=this.tokenizer.rules.inline.blockSkip.exec(o))!==null;)s=l[2]?l[2].length:0,o=o.slice(0,l.index+s)+"["+"a".repeat(l[0].length-s-2)+"]"+o.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);o=((g=(f=this.options.hooks)==null?void 0:f.emStrongMask)==null?void 0:g.call({lexer:this},o))??o;let a=!1,d="",i=1/0;for(;t;){if(t.length<i)i=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}a||(d=""),a=!1;let y;if((w=(B=this.options.extensions)==null?void 0:B.inline)!=null&&w.some(P=>(y=P.call({lexer:this},t,n))?(t=t.substring(y.raw.length),n.push(y),!0):!1))continue;if(y=this.tokenizer.escape(t)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.tag(t)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.link(t)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(y.raw.length);let P=n.at(-1);y.type==="text"&&(P==null?void 0:P.type)==="text"?(P.raw+=y.raw,P.text+=y.text):n.push(y);continue}if(y=this.tokenizer.emStrong(t,o,d)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.codespan(t)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.br(t)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.del(t,o,d)){t=t.substring(y.raw.length),n.push(y);continue}if(y=this.tokenizer.autolink(t)){t=t.substring(y.raw.length),n.push(y);continue}if(!this.state.inLink&&(y=this.tokenizer.url(t))){t=t.substring(y.raw.length),n.push(y);continue}let S=t;if((T=this.options.extensions)!=null&&T.startInline){let P=1/0,D=t.slice(1),L;this.options.extensions.startInline.forEach(O=>{L=O.call({lexer:this},D),typeof L=="number"&&L>=0&&(P=Math.min(P,L))}),P<1/0&&P>=0&&(S=t.substring(0,P+1))}if(y=this.tokenizer.inlineText(S)){t=t.substring(y.raw.length),y.raw.slice(-1)!=="_"&&(d=y.raw.slice(-1)),a=!0;let P=n.at(-1);(P==null?void 0:P.type)==="text"?(P.raw+=y.raw,P.text+=y.text):n.push(y);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return n}infiniteLoopError(t){let n="Infinite loop on byte: "+t;if(this.options.silent)console.error(n);else throw new Error(n)}},ie=class{constructor(r){M(this,"options");M(this,"parser");this.options=r||Z}space(r){return""}code({text:r,lang:t,escaped:n}){var s;let o=(s=(t||"").match(G.notSpaceStart))==null?void 0:s[0],l=r.replace(G.endingNewline,"")+`
...
`}hr(r){return`<hr>
`}list(r){let t=r.ordered,n=r.start,o="";for(let a=0;a<r.items.length;a++){let d=r.items[a];o+=this.listitem(d)}let l=t?"ol":"ul",s=t&&n!==1?' start="'+n+'"':"";return"<"+l+s+`>
`+o+"</"+l+`>
...
`}strong({tokens:r}){return`<strong>${this.parser.parseInline(r)}</strong>`}em({tokens:r}){return`<em>${this.parser.parseInline(r)}</em>`}codespan({text:r}){return`<code>${q(r,!0)}</code>`}br(r){return"<br>"}del({tokens:r}){return`<del>${this.parser.parseInline(r)}</del>`}link({href:r,title:t,tokens:n}){let o=this.parser.parseInline(n),l=Oe(r);if(l===null)return o;r=l;let s='<a href="'+r+'"';return t&&(s+=' title="'+q(t)+'"'),s+=">"+o+"</a>",s}image({href:r,title:t,text:n,tokens:o}){o&&(n=this.parser.parseInline(o,this.parser.textRenderer));let l=Oe(r);if(l===null)return q(n);r=l;let s=`<img src="${r}" alt="${q(n)}"`;return t&&(s+=` title="${q(t)}"`),s+=">",s}text(r){return"tokens"in r&&r.tokens?this.parser.parseInline(r.tokens):"escaped"in r&&r.escaped?r.text:q(r.text)}},Ee=class{strong({text:r}){return r}em({text:r}){return r}codespan({text:r}){return r}del({text:r}){return r}html({text:r}){return r}text({text:r}){return r}link({text:r}){return""+r}image({text:r}){return""+r}br(){return""}checkbox({raw:r}){return r}},W=class Ne{constructor(t){M(this,"options");M(this,"renderer");M(this,"textRenderer");this.options=t||Z,this.options.renderer=this.options.renderer||new ie,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Ee}static parse(t,n){return new Ne(n).parse(t)}static parseInline(t,n){return new Ne(n).parseInline(t)}parse(t){var o,l;this.renderer.parser=this;let n="";for(let s=0;s<t.length;s++){let a=t[s];if((l=(o=this.options.extensions)==null?void 0:o.renderers)!=null&&l[a.type]){let i=a,f=this.options.extensions.renderers[i.type].call({parser:this},i);if(f!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(i.type)){n+=f||"";continue}}let d=a;switch(d.type){case"space":{n+=this.renderer.space(d);break}case"hr":{n+=this.renderer.hr(d);break}case"heading":{n+=this.renderer.heading(d);break}case"code":{n+=this.renderer.code(d);break}case"table":{n+=this.renderer.table(d);break}case"blockquote":{n+=this.renderer.blockquote(d);break}case"list":{n+=this.renderer.list(d);break}case"checkbox":{n+=this.renderer.checkbox(d);break}case"html":{n+=this.renderer.html(d);break}case"def":{n+=this.renderer.def(d);break}case"paragraph":{n+=this.renderer.paragraph(d);break}case"text":{n+=this.renderer.text(d);break}default:{let i='Token with "'+d.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}parseInline(t,n=this.renderer){var l,s;this.renderer.parser=this;let o="";for(let a=0;a<t.length;a++){let d=t[a];if((s=(l=this.options.extensions)==null?void 0:l.renderers)!=null&&s[d.type]){let f=this.options.extensions.renderers[d.type].call({parser:this},d);if(f!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(d.type)){o+=f||"";continue}}let i=d;switch(i.type){case"escape":{o+=n.text(i);break}case"html":{o+=n.html(i);break}case"link":{o+=n.link(i);break}case"image":{o+=n.image(i);break}case"checkbox":{o+=n.checkbox(i);break}case"strong":{o+=n.strong(i);break}case"em":{o+=n.em(i);break}case"codespan":{o+=n.codespan(i);break}case"br":{o+=n.br(i);break}case"del":{o+=n.del(i);break}case"text":{o+=n.text(i);break}default:{let f='Token with "'+i.type+'" type was not found.';if(this.options.silent)return console.error(f),"";throw new Error(f)}}}return o}},te=(ce=class{constructor(r){M(this,"options");M(this,"block");this.options=r||Z}preprocess(r){return r}postprocess(r){return r}processAllTokens(r){return r}emStrongMask(r){return r}provideLexer(r=this.block){return r?H.lex:H.lexInline}provideParser(r=this.block){return r?W.parse:W.parseInline}},M(ce,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),M(ce,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),ce),Po=class{constructor(...r){M(this,"defaults",pe());M(this,"options",this.setOptions);M(this,"parse",this.parseMarkdown(!0));M(this,"parseInline",this.parseMarkdown(!1));M(this,"Parser",W);M(this,"Renderer",ie);M(this,"TextRenderer",Ee);M(this,"Lexer",H);M(this,"Tokenizer",se);M(this,"Hooks",te);this.use(...r)}walkTokens(r,t){var o,l;let n=[];for(let s of r)switch(n=n.concat(t.call(this,s)),s.type){case"table":{let a=s;for(let d of a.header)n=n.concat(this.walkTokens(d.tokens,t));for(let d of a.rows)for(let i of d)n=n.concat(this.walkTokens(i.tokens,t));break}case"list":{let a=s;n=n.concat(this.walkTokens(a.items,t));break}default:{let a=s;(l=(o=this.defaults.extensions)==null?void 0:o.childTokens)!=null&&l[a.type]?this.defaults.extensions.childTokens[a.type].forEach(d=>{let i=a[d].flat(1/0);n=n.concat(this.walkTokens(i,t))}):a.tokens&&(n=n.concat(this.walkTokens(a.tokens,t)))}}return n}use(...r){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return r.forEach(n=>{let o={...n};if(o.async=this.defaults.async||o.async||!1,n.extensions&&(n.extensions.forEach(l=>{if(!l.name)throw new Error("extension name required");if("renderer"in l){let s=t.renderers[l.name];s?t.renderers[l.name]=function(...a){let d=l.renderer.apply(this,a);return d===!1&&(d=s.apply(this,a)),d}:t.renderers[l.name]=l.renderer}if("tokenizer"in l){if(!l.level||l.level!=="block"&&l.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let s=t[l.level];s?s.unshift(l.tokenizer):t[l.level]=[l.tokenizer],l.start&&(l.level==="block"?t.startBlock?t.startBlock.push(l.start):t.startBlock=[l.start]:l.level==="inline"&&(t.startInline?t.startInline.push(l.start):t.startInline=[l.start]))}"childTokens"in l&&l.childTokens&&(t.childTokens[l.name]=l.childTokens)}),o.extensions=t),n.renderer){let l=this.defaults.renderer||new ie(this.defaults);for(let s in n.renderer){if(!(s in l))throw new Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let a=s,d=n.renderer[a],i=l[a];l[a]=(...f)=>{let g=d.apply(l,f);return g===!1&&(g=i.apply(l,f)),g||""}}o.renderer=l}if(n.tokenizer){let l=this.defaults.tokenizer||new se(this.defaults);for(let s in n.tokenizer){if(!(s in l))throw new Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let a=s,d=n.tokenizer[a],i=l[a];l[a]=(...f)=>{let g=d.apply(l,f);return g===!1&&(g=i.apply(l,f)),g}}o.tokenizer=l}if(n.hooks){let l=this.defaults.hooks||new te;for(let s in n.hooks){if(!(s in l))throw new Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let a=s,d=n.hooks[a],i=l[a];te.passThroughHooks.has(s)?l[a]=f=>{if(this.defaults.async&&te.passThroughHooksRespectAsync.has(s))return(async()=>{let B=await d.call(l,f);return i.call(l,B)})();let g=d.call(l,f);return i.call(l,g)}:l[a]=(...f)=>{if(this.defaults.async)return(async()=>{let B=await d.apply(l,f);return B===!1&&(B=await i.apply(l,f)),B})();let g=d.apply(l,f);return g===!1&&(g=i.apply(l,f)),g}}o.hooks=l}if(n.walkTokens){let l=this.defaults.walkTokens,s=n.walkTokens;o.walkTokens=function(a){let d=[];return d.push(s.call(this,a)),l&&(d=d.concat(l.call(this,a))),d}}this.defaults={...this.defaults,...o}}),this}setOptions(r){return this.defaults={...this.defaults,...r},this}lexer(r,t){return H.lex(r,t??this.defaults)}parser(r,t){return W.parse(r,t??this.defaults)}parseMarkdown(r){return(t,n)=>{let o={...n},l={...this.defaults,...o},s=this.onError(!!l.silent,!!l.async);if(this.defaults.async===!0&&o.async===!1)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof t>"u"||t===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(l.hooks&&(l.hooks.options=l,l.hooks.block=r),l.async)return(async()=>{let a=l.hooks?await l.hooks.preprocess(t):t,d=await(l.hooks?await l.hooks.provideLexer(r):r?H.lex:H.lexInline)(a,l),i=l.hooks?await l.hooks.processAllTokens(d):d;l.walkTokens&&await Promise.all(this.walkTokens(i,l.walkTokens));let f=await(l.hooks?await l.hooks.provideParser(r):r?W.parse:W.parseInline)(i,l);return l.hooks?await l.hooks.postprocess(f):f})().catch(s);try{l.hooks&&(t=l.hooks.preprocess(t));let a=(l.hooks?l.hooks.provideLexer(r):r?H.lex:H.lexInline)(t,l);l.hooks&&(a=l.hooks.processAllTokens(a)),l.walkTokens&&this.walkTokens(a,l.walkTokens);let d=(l.hooks?l.hooks.provideParser(r):r?W.parse:W.parseInline)(a,l);return l.hooks&&(d=l.hooks.postprocess(d)),d}catch(a){return s(a)}}}onError(r,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,r){let o="<p>An error occurred:</p><pre>"+q(n.message+"",!0)+"</pre>";return t?Promise.resolve(o):o}if(t)return Promise.reject(n);throw n}}},Y=new Po;function $(r,t){return Y.parse(r,t)}$.options=$.setOptions=function(r){return Y.setOptions(r),$.defaults=Y.defaults,Te($.defaults),$},$.getDefaults=pe,$.defaults=Z,$.use=function(...r){return Y.use(...r),$.defaults=Y.defaults,Te($.defaults),$},$.walkTokens=function(r,t){return Y.walkTokens(r,t)},$.parseInline=Y.parseInline,$.Parser=W,$.parser=W.parse,$.Renderer=ie,$.TextRenderer=Ee,$.Lexer=H,$.lexer=H.lex,$.Tokenizer=se,$.Hooks=te,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,W.parse,H.lex;const Ao={class:"modal-content help-modal"},$o={class:"modal-header"},Mo={class:"header-actions"},Do={class:"modal-body"},Ro={class:"doc-sidebar"},Lo={class:"doc-sidebar-group"},Fo={class:"doc-sidebar-header"},Go=["onClick"],Oo={class:"doc-sidebar-group"},zo={class:"doc-sidebar-header"},Uo={class:"doc-content"},jo=["innerHTML"],Ho=["innerHTML"],Wo=["innerHTML"],qo=["innerHTML"],Jo=["innerHTML"],Ko=["innerHTML"],Zo=["innerHTML"],Qo={class:"doc-pagination"},Yo=["disabled"],Xo={class:"page-info"},_o=["disabled"],vo=U({__name:"HelpModal",props:{initialDoc:{type:String,default:"getting-started"}},emits:["close","openAbout"],setup(r,{emit:t}){const n=r,o=e.ref(n.initialDoc),l=e.ref(""),s=e.ref(null),a=[{id:"getting-started",title:"快速开始",icon:"home"},{id:"features",title:"功能介绍",icon:"info"},{id:"api",title:"API 文档",icon:"code"},{id:"tools",title:"工具文档",icon:"tool"},{id:"shortcuts",title:"快捷键",icon:"keyboard"},{id:"faq",title:"常见问题",icon:"help"}],d=e.ref(a),i=e.computed(()=>[...d.value,{id:"changelog",title:"更新日志",icon:"activity"}]),f=e.computed(()=>i.value.findIndex(V=>V.id===o.value)),g=e.computed(()=>f.value>0),B=e.computed(()=>f.value<i.value.length-1);function w(){const V=l.value.toLowerCase().trim();if(!V){d.value=a;return}d.value=a.filter(p=>p.title.toLowerCase().includes(V)||p.id.includes(V)),d.value.length>0&&!d.value.find(p=>p.id===o.value)&&(o.value=d.value[0].id)}const T=V=>$(V,{breaks:!0,gfm:!0}).replace(/<table>/g,'<table class="doc-table">'),y=e.computed(()=>T(zr)),S=e.computed(()=>T(Ur)),P=e.computed(()=>T(Lr)),D=e.computed(()=>T(Fr)),L=e.computed(()=>T(Gr)),O=e.computed(()=>T(Or)),j=e.computed(()=>T(jr));function z(){var V;g.value&&(o.value=i.value[f.value-1].id,(V=s.value)==null||V.scrollTo(0,0))}function F(){var V;B.value&&(o.value=i.value[f.value+1].id,(V=s.value)==null||V.scrollTo(0,0))}return e.onMounted(()=>{w()}),(V,p)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:p[3]||(p[3]=e.withModifiers(E=>V.$emit("close"),["self"]))},[e.createElementVNode("div",Ao,[e.createCommentVNode(" 头部 "),e.createElementVNode("div",$o,[e.createElementVNode("h2",null,[e.createVNode(R,{name:"book-open",size:18}),p[4]||(p[4]=e.createTextVNode(" 帮助文档",-1))]),e.createElementVNode("div",Mo,[e.createElementVNode("button",{class:"btn-about",onClick:p[0]||(p[0]=E=>V.$emit("openAbout")),title:"关于 PairCode"},[e.createVNode(R,{name:"info",size:14}),p[5]||(p[5]=e.createTextVNode(" 关于 ",-1))]),e.createElementVNode("button",{class:"modal-close",onClick:p[1]||(p[1]=E=>V.$emit("close"))},"×")])]),e.createCommentVNode(" 主体 "),e.createElementVNode("div",Do,[e.createCommentVNode(" 侧边导航 "),e.createElementVNode("div",Ro,[e.createCommentVNode(" 文档中心分组 "),e.createElementVNode("div",Lo,[e.createElementVNode("div",Fo,[e.createVNode(R,{name:"book",size:14}),p[6]||(p[6]=e.createElementVNode("span",null,"文档中心",-1))]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.value,E=>(e.openBlock(),e.createElementBlock("div",{key:E.id,class:e.normalizeClass(["doc-nav-item",{active:o.value===E.id}]),onClick:b=>o.value=E.id},[e.createVNode(R,{name:E.icon,size:16},null,8,["name"]),e.createElementVNode("span",null,e.toDisplayString(E.title),1)],10,Go))),128))]),e.createCommentVNode(" 更新日志 "),e.createElementVNode("div",Oo,[e.createElementVNode("div",zo,[e.createVNode(R,{name:"clock",size:14}),p[7]||(p[7]=e.createElementVNode("span",null,"其他",-1))]),e.createElementVNode("div",{class:e.normalizeClass(["doc-nav-item",{active:o.value==="changelog"}]),onClick:p[2]||(p[2]=E=>o.value="changelog")},[e.createVNode(R,{name:"activity",size:16}),p[8]||(p[8]=e.createElementVNode("span",null,"更新日志",-1))],2)])]),e.createCommentVNode(" 文档内容 "),e.createElementVNode("div",Uo,[e.createElementVNode("div",{class:"doc-content-inner",ref_key:"contentRef",ref:s},[o.value==="faq"?(e.openBlock(),e.createElementBlock("div",{key:0,class:"doc-markdown",innerHTML:y.value},null,8,jo)):o.value==="getting-started"?(e.openBlock(),e.createElementBlock("div",{key:1,class:"doc-markdown",innerHTML:S.value},null,8,Ho)):o.value==="features"?(e.openBlock(),e.createElementBlock("div",{key:2,class:"doc-markdown",innerHTML:P.value},null,8,Wo)):o.value==="api"?(e.openBlock(),e.createElementBlock("div",{key:3,class:"doc-markdown",innerHTML:D.value},null,8,qo)):o.value==="tools"?(e.openBlock(),e.createElementBlock("div",{key:4,class:"doc-markdown",innerHTML:L.value},null,8,Jo)):o.value==="shortcuts"?(e.openBlock(),e.createElementBlock("div",{key:5,class:"doc-markdown",innerHTML:O.value},null,8,Ko)):o.value==="changelog"?(e.openBlock(),e.createElementBlock("div",{key:6,class:"doc-markdown",innerHTML:j.value},null,8,Zo)):e.createCommentVNode("v-if",!0)],512),e.createCommentVNode(" 底部翻页 "),e.createElementVNode("div",Qo,[e.createElementVNode("button",{class:"page-btn",onClick:z,disabled:!g.value},[e.createVNode(R,{name:"chevron-left",size:14}),p[9]||(p[9]=e.createTextVNode(" 上一页 ",-1))],8,Yo),e.createElementVNode("span",Xo,e.toDisplayString(f.value+1)+" / "+e.toDisplayString(i.value.length),1),e.createElementVNode("button",{class:"page-btn",onClick:F,disabled:!B.value},[p[10]||(p[10]=e.createTextVNode(" 下一页 ",-1)),e.createVNode(R,{name:"chevron-right",size:14})],8,_o)])])])])]))}},[["__scopeId","data-v-203b7be1"]]),el={class:"uc"},nl={class:"uc-line"},tl={class:"uc-cur"},rl={key:0,class:"uc-new"},ol={class:"uc-warn"},ll=["disabled"],al={key:0,class:"uc-prog"},sl={class:"uc-bar"},il={class:"uc-pct"},cl={key:1,class:"uc-plan"},dl={key:2,class:"uc-notes"},pl={class:"uc-pre"},He=U({__name:"UpdateCard",props:{currentVersion:{type:String,default:""}},setup(r){const t=r,n=e.ref("idle"),o=e.ref({}),l=e.ref(""),s=e.ref(!1),a=e.ref(""),d=e.ref(""),i=e.ref({}),f=e.ref(0),g=e.ref(!1),B=e.ref(!1),w=e.ref("");let T=null;const y=["checking","downloading","verifying","extracting","applying","restarting"],S=e.computed(()=>y.includes(n.value)),P=e.computed(()=>{const c=String(t.currentVersion||"").trim();return c?c[0]==="v"||c[0]==="V"?c:"v"+c:"—"}),D=e.computed(()=>n.value==="checking"?"检查中…":s.value?"重新检查":"检查更新"),L=e.computed(()=>d.value||o.value.message||"尚未检查更新"),O=e.computed(()=>{switch(n.value){case"downloading":case"verifying":case"extracting":case"applying":return"package";case"ready":return"check-circle";case"error":return"shield-off";case"available":return"package";default:return"refresh"}}),j=e.computed(()=>n.value==="error"?"var(--danger, #e5534b)":"var(--accent)"),z=e.computed(()=>(((i.value||{}).speedBps||0)/1048576).toFixed(2));function F(c){const u=Number(c||0);return u>=1073741824?(u/1073741824).toFixed(2)+" GB":(u/1048576).toFixed(1)+" MB"}function V(c){c&&(o.value=c,n.value=c.stage||"idle",l.value=c.latest||"",s.value=!!c.hasUpdate,a.value=c.notes||"",d.value=c.error||"",i.value=c.progress||{},f.value=Number(i.value.percent||0),S.value?p():E())}function p(){T||(T=setInterval(async()=>{try{const c=await A.apiGet("/update/status");V(c.state)}catch{}},900))}function E(){T&&(clearInterval(T),T=null)}async function b(){g.value=!0,w.value="",n.value="checking",d.value="";try{const c=await A.apiGet("/update/check");V(c.state),c.error&&(d.value=c.error)}catch(c){d.value="检查更新失败："+((c==null?void 0:c.message)||c),n.value="error"}finally{g.value=!1}}async function h(){w.value="";try{const c=await A.apiPost("/update/download");V(c.state),c.error&&(d.value=c.error),p()}catch(c){d.value="下载失败："+((c==null?void 0:c.message)||c)}}async function k(){try{const c=await A.apiPost("/update/cancel");V(c.state)}catch{}}async function m(){w.value="正在生成替换计划…";try{const c=await A.apiPost("/update/apply",{dryRun:!0,restart:!1}),u=(c.result||{}).plan||{};w.value=`替换预览：将写 ${(u.write||[]).length} 个文件（${F(u.bytes)}），保护名单跳过 ${(u.skip||[]).length} 个（config/ 与 .pair 用户数据），主程序 ${u.mainProgram}`,c.error&&(w.value="预览失败："+c.error)}catch(c){w.value="预览失败："+((c==null?void 0:c.message)||c)}}async function N(c){B.value=!1,w.value=c?"正在安装并重启，页面将在数秒后断开…":"正在安装（不重启）…";try{const u=await A.apiPost("/update/apply",{dryRun:!1,restart:c});if(V(u.state),u.error){w.value="安装失败："+u.error;return}const C=(u.result||{}).plan||{};w.value=c?`已安装 v${l.value}，正在重启（备份：${C.backupPath||"-"}）`:`已安装 v${l.value}（${(C.write||[]).length} 个文件），重启后生效；旧版本备份：${C.backupPath||"-"}`}catch(u){w.value="安装失败："+((u==null?void 0:u.message)||u)}}return e.onMounted(async()=>{try{const c=await A.apiGet("/update/status");V(c.state)}catch{}}),e.onUnmounted(E),(c,u)=>(e.openBlock(),e.createElementBlock("div",el,[e.createCommentVNode(" 主行：状态 + 操作 "),e.createElementVNode("div",nl,[e.createVNode(R,{name:O.value,size:14,color:j.value},null,8,["name","color"]),u[4]||(u[4]=e.createElementVNode("span",{class:"uc-title"},"软件更新",-1)),e.createElementVNode("span",tl,"当前 "+e.toDisplayString(P.value),1),s.value?(e.openBlock(),e.createElementBlock("span",rl,"→ 新版本 v"+e.toDisplayString(l.value),1)):e.createCommentVNode("v-if",!0),e.createElementVNode("span",{class:e.normalizeClass(["uc-state",{"uc-err":!!d.value}])},e.toDisplayString(L.value),3),u[5]||(u[5]=e.createElementVNode("span",{class:"uc-gap"},null,-1)),B.value?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createElementVNode("span",ol,"确认安装 v"+e.toDisplayString(l.value)+" 并重启？",1),e.createElementVNode("button",{class:"uc-btn uc-primary",onClick:u[0]||(u[0]=C=>N(!0))},"确认安装并重启"),e.createElementVNode("button",{class:"uc-btn",onClick:u[1]||(u[1]=C=>B.value=!1)},"取消")],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[!S.value&&n.value!=="ready"?(e.openBlock(),e.createElementBlock("button",{key:0,class:"uc-btn",disabled:g.value,onClick:b},[e.createVNode(R,{name:"refresh",size:12}),e.createTextVNode(" "+e.toDisplayString(D.value),1)],8,ll)):e.createCommentVNode("v-if",!0),n.value==="available"?(e.openBlock(),e.createElementBlock("button",{key:1,class:"uc-btn uc-primary",onClick:h},"下载并安装")):e.createCommentVNode("v-if",!0),S.value?(e.openBlock(),e.createElementBlock("button",{key:2,class:"uc-btn",onClick:k},"取消")):e.createCommentVNode("v-if",!0),n.value==="ready"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:3},[e.createElementVNode("button",{class:"uc-btn",onClick:m},"预览替换清单"),e.createElementVNode("button",{class:"uc-btn uc-primary",onClick:u[2]||(u[2]=C=>B.value=!0)},"立即安装并重启"),e.createElementVNode("button",{class:"uc-btn",onClick:u[3]||(u[3]=C=>N(!1))},"仅安装，稍后重启")],64)):e.createCommentVNode("v-if",!0)],64))]),e.createCommentVNode(" 进度条 "),S.value?(e.openBlock(),e.createElementBlock("div",al,[e.createElementVNode("div",sl,[e.createElementVNode("div",{class:"uc-fill",style:e.normalizeStyle({width:f.value.toFixed(1)+"%"})},null,4)]),e.createElementVNode("span",il,e.toDisplayString(f.value.toFixed(1))+"% ｜ "+e.toDisplayString(F(i.value.downloaded))+" / "+e.toDisplayString(F(i.value.total))+" ｜ "+e.toDisplayString(z.value)+" MB/s",1)])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 替换计划（预览） "),w.value?(e.openBlock(),e.createElementBlock("div",cl,e.toDisplayString(w.value),1)):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 更新说明（折叠） "),s.value&&a.value?(e.openBlock(),e.createElementBlock("details",dl,[e.createElementVNode("summary",null,"更新说明（v"+e.toDisplayString(l.value)+"）",1),e.createElementVNode("pre",pl,e.toDisplayString(a.value),1)])):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-866ba2d8"]]),ml="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='512'%20height='512'%20viewBox='0%200%20512%20512'%3e%3cdefs%3e%3c!--%20背景渐变（深色科技风）%20--%3e%3clinearGradient%20id='bgGrad'%20x1='0'%20y1='0'%20x2='1'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%230a1628'/%3e%3cstop%20offset='100%25'%20stop-color='%230d1f2e'/%3e%3c/linearGradient%3e%3c!--%20左侧尖括号渐变（科技蓝）%20--%3e%3clinearGradient%20id='leftBracket'%20x1='0'%20y1='0'%20x2='0'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%2300d4ff'/%3e%3cstop%20offset='100%25'%20stop-color='%230077b6'/%3e%3c/linearGradient%3e%3c!--%20右侧尖括号渐变（科技绿）%20--%3e%3clinearGradient%20id='rightBracket'%20x1='0'%20y1='0'%20x2='0'%20y2='1'%3e%3cstop%20offset='0%25'%20stop-color='%2300e676'/%3e%3cstop%20offset='100%25'%20stop-color='%2300c853'/%3e%3c/linearGradient%3e%3c!--%20中间连接线（蓝绿渐变）%20--%3e%3clinearGradient%20id='connector'%20x1='0'%20y1='0'%20x2='1'%20y2='0'%3e%3cstop%20offset='0%25'%20stop-color='%2300d4ff'/%3e%3cstop%20offset='50%25'%20stop-color='%2300e5ff'/%3e%3cstop%20offset='100%25'%20stop-color='%2300e676'/%3e%3c/linearGradient%3e%3c!--%20外发光%20--%3e%3cfilter%20id='glow'%3e%3cfeGaussianBlur%20stdDeviation='4'%20result='blur'/%3e%3cfeMerge%3e%3cfeMergeNode%20in='blur'/%3e%3cfeMergeNode%20in='SourceGraphic'/%3e%3c/feMerge%3e%3c/filter%3e%3cfilter%20id='softGlow'%3e%3cfeGaussianBlur%20stdDeviation='8'%20result='blur'/%3e%3cfeMerge%3e%3cfeMergeNode%20in='blur'/%3e%3cfeMergeNode%20in='SourceGraphic'/%3e%3c/feMerge%3e%3c/filter%3e%3c/defs%3e%3c!--%20圆角方形背景（深色科技底）%20--%3e%3crect%20x='32'%20y='32'%20width='448'%20height='448'%20rx='96'%20ry='96'%20fill='url(%23bgGrad)'%20stroke='%231a3a4a'%20stroke-width='2'/%3e%3c!--%20左侧%20%3c%20尖括号（三段式直线%20—%20科技蓝，代表代码输入/开发者）%20--%3e%3cpath%20d='M180%20150%20L96%20256%20L180%20362'%20stroke='url(%23leftBracket)'%20stroke-width='40'%20stroke-linejoin='round'%20fill='none'%20filter='url(%23glow)'/%3e%3c!--%20右侧%20%3e%20尖括号（三段式直线%20—%20科技绿，代表代码输出/AI伙伴）%20--%3e%3cpath%20d='M332%20150%20L416%20256%20L332%20362'%20stroke='url(%23rightBracket)'%20stroke-width='40'%20stroke-linejoin='round'%20fill='none'%20filter='url(%23glow)'/%3e%3c!--%20中间「=」连接线已移除（图标只留%20%3c%20%3e%20尖括号%20+%20中心%20AI%20核心光点）。%20--%3e%3c!--%20中心光点（代表%20AI%20核心%20—%20亮青色）%20--%3e%3ccircle%20cx='256'%20cy='256'%20r='18'%20fill='transparent'%20stroke='%2300e5ff'%20stroke-width='3'%20opacity='0.6'/%3e%3ccircle%20cx='256'%20cy='256'%20r='8'%20fill='%2300e5ff'%20opacity='0.9'%3e%3canimate%20attributeName='opacity'%20values='0.6;1;0.6'%20dur='2s'%20repeatCount='indefinite'/%3e%3c/circle%3e%3c/svg%3e",gl={class:"modal-content about-modal"},kl={class:"modal-header"},hl={class:"modal-body"},fl={class:"about-left-col"},yl={class:"about-hero"},ul={class:"about-logo"},bl=["src"],El={class:"about-version"},xl={class:"about-right-col"},Vl={class:"about-section"},Nl={class:"feature-list"},wl={class:"about-section"},Bl={key:0,class:"sys-info"},Tl={class:"info-row"},Sl={class:"info-row"},Cl={class:"info-row"},Il={class:"info-path"},Pl={class:"info-row"},Al={key:1,class:"loading-info"},$l={class:"about-update"},Ml={class:"modal-footer"},Dl=U({__name:"AboutModal",props:{showHelpBtn:{type:Boolean,default:!0}},emits:["close","openHelp"],setup(r,{emit:t}){const n=e.ref(""),o=e.ref({}),l=e.ref(!0);return e.onMounted(async()=>{try{const s=await A.apiGet("/system/info");o.value=s,s.version&&(n.value=s.version)}catch{}l.value=!1}),(s,a)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:a[3]||(a[3]=e.withModifiers(d=>s.$emit("close"),["self"]))},[e.createElementVNode("div",gl,[e.createElementVNode("div",kl,[e.createElementVNode("h2",null,[e.createVNode(R,{name:"info",size:18}),a[4]||(a[4]=e.createTextVNode(" 关于 PairCode",-1))]),e.createElementVNode("button",{class:"modal-close",onClick:a[0]||(a[0]=d=>s.$emit("close"))},"×")]),e.createElementVNode("div",hl,[e.createCommentVNode(" 左列：Logo + 描述 + 技术栈 "),e.createElementVNode("div",fl,[e.createCommentVNode(" Logo + 标题 "),e.createElementVNode("div",yl,[e.createElementVNode("div",ul,[e.createElementVNode("img",{src:e.unref(ml),class:"about-logo-img",alt:"PairCode"},null,8,bl)]),a[5]||(a[5]=e.createElementVNode("div",{class:"about-title"},"PairCode IDE",-1)),e.createElementVNode("div",El,"版本 "+e.toDisplayString(n.value),1)]),e.createCommentVNode(" 描述 "),a[6]||(a[6]=e.createElementVNode("div",{class:"about-section"},[e.createElementVNode("p",{class:"about-description"}," PairCode IDE 是一款纯 Web 端的 AI 辅助编程集成开发环境， 专为浏览器而设计。无需安装任何桌面客户端或本地 IDE 软件， 打开浏览器即可开始编程。它将 AI 对话能力深度融入编码工作流， 你只需用自然语言描述需求，AI 就能自动理解上下文、读写文件、执行命令、 管理版本控制。从代码生成到项目运维，在同一个浏览器窗口中全部完成。 ")],-1)),e.createCommentVNode(" 技术栈 "),a[7]||(a[7]=e.createStaticVNode('<div class="about-section" data-v-1d7180b5><div class="section-title" data-v-1d7180b5>技术栈</div><div class="tech-stack" data-v-1d7180b5><span class="tech-badge" data-v-1d7180b5>Go</span><span class="tech-badge" data-v-1d7180b5>Vue 3</span><span class="tech-badge" data-v-1d7180b5>WebSocket</span><span class="tech-badge" data-v-1d7180b5>CodeMirror</span><span class="tech-badge" data-v-1d7180b5>插件化工具</span><span class="tech-badge" data-v-1d7180b5>TS 编译器</span><span class="tech-badge" data-v-1d7180b5>MCP</span><span class="tech-badge" data-v-1d7180b5>CodeGraph</span><span class="tech-badge" data-v-1d7180b5>DAP</span></div></div>',1))]),e.createCommentVNode(" 右列：特性 + 系统信息 "),e.createElementVNode("div",xl,[e.createCommentVNode(" 特性亮点 "),e.createElementVNode("div",Vl,[a[18]||(a[18]=e.createElementVNode("div",{class:"section-title"},"主要特性",-1)),e.createElementVNode("ul",Nl,[e.createElementVNode("li",null,[e.createVNode(R,{name:"bot",size:14,color:"var(--accent)"}),a[8]||(a[8]=e.createTextVNode(" AI 对话编程 — 用自然语言与 AI 对话，自动生成与重构代码",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"file",size:14,color:"var(--accent)"}),a[9]||(a[9]=e.createTextVNode(" 智能代码编辑器 — 多语言语法高亮，浏览器中流畅编辑",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"git-branch",size:14,color:"var(--accent)"}),a[10]||(a[10]=e.createTextVNode(" Git 版本控制 — 在对话中完成全部 Git 操作",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"terminal",size:14,color:"var(--accent)"}),a[11]||(a[11]=e.createTextVNode(" 内置终端 — 无需离开浏览器即可执行命令",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"search",size:14,color:"var(--accent)"}),a[12]||(a[12]=e.createTextVNode(" 全局搜索 — 快速搜索文件与代码内容",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"settings",size:14,color:"var(--accent)"}),a[13]||(a[13]=e.createTextVNode(" 自主 Agent 模式 — AI 主动分析项目并自动执行任务",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"grid",size:14,color:"var(--accent)"}),a[14]||(a[14]=e.createTextVNode(" 对话历史管理 — 自动保存、回溯与继续历史对话",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"tool",size:14,color:"var(--accent)"}),a[15]||(a[15]=e.createTextVNode(" Skills / MCP 扩展 — 通过技能市场扩展 IDE 能力",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"code",size:14,color:"var(--accent)"}),a[16]||(a[16]=e.createTextVNode(" 内置调试器 — 支持 Go 程序的断点、单步和变量查看",-1))]),e.createElementVNode("li",null,[e.createVNode(R,{name:"image",size:14,color:"var(--accent)"}),a[17]||(a[17]=e.createTextVNode(" 网页验证 — 打开 URL、截图、分析页面效果",-1))])])]),e.createCommentVNode(" 系统信息 "),e.createElementVNode("div",wl,[a[23]||(a[23]=e.createElementVNode("div",{class:"section-title"},"系统信息",-1)),l.value?(e.openBlock(),e.createElementBlock("div",Al,"加载中...")):(e.openBlock(),e.createElementBlock("div",Bl,[e.createElementVNode("div",Tl,[a[19]||(a[19]=e.createElementVNode("span",{class:"info-label"},"主机名",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.hostname),1)]),e.createElementVNode("div",Sl,[a[20]||(a[20]=e.createElementVNode("span",{class:"info-label"},"操作系统",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.os),1)]),e.createElementVNode("div",Cl,[a[21]||(a[21]=e.createElementVNode("span",{class:"info-label"},"工作区",-1)),e.createElementVNode("span",Il,e.toDisplayString(o.value.workspace),1)]),e.createElementVNode("div",Pl,[a[22]||(a[22]=e.createElementVNode("span",{class:"info-label"},"平台信息",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.goos),1)])]))])])]),e.createCommentVNode(" ★ 软件更新（在线更新：检查 → 下载 → 校验 → 安装重启；数据源 /api/update/*）"),e.createElementVNode("div",$l,[e.createVNode(He,{"current-version":n.value},null,8,["current-version"])]),e.createCommentVNode(" 底部 "),e.createElementVNode("div",Ml,[r.showHelpBtn?(e.openBlock(),e.createElementBlock("button",{key:0,class:"btn-primary",onClick:a[1]||(a[1]=d=>s.$emit("openHelp"))},[e.createVNode(R,{name:"book-open",size:14}),a[24]||(a[24]=e.createTextVNode(" 查看帮助文档 ",-1))])):e.createCommentVNode("v-if",!0),e.createElementVNode("button",{class:"btn-secondary",onClick:a[2]||(a[2]=d=>s.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-1d7180b5"]]),Rl={class:"modal-header"},Ll={class:"modal-title"},Fl={class:"modal-body"},Gl=U({__name:"Modal",props:{maxWidth:{type:String,default:"480px"}},emits:["close"],setup(r,{emit:t}){const n=t,o=e.ref(!0);function l(s){s.key==="Escape"&&n("close")}return e.onMounted(()=>document.addEventListener("keydown",l)),e.onUnmounted(()=>document.removeEventListener("keydown",l)),(s,a)=>(e.openBlock(),e.createBlock(e.Teleport,{to:"body"},[o.value?(e.openBlock(),e.createElementBlock("div",{key:0,class:"modal-overlay",onClick:a[1]||(a[1]=e.withModifiers(d=>s.$emit("close"),["self"]))},[e.createElementVNode("div",{class:"modal-container",style:e.normalizeStyle({maxWidth:r.maxWidth})},[e.createElementVNode("div",Rl,[e.createElementVNode("span",Ll,[e.renderSlot(s.$slots,"title",{},()=>[a[2]||(a[2]=e.createTextVNode("提示",-1))],!0)]),e.createElementVNode("button",{class:"modal-close",onClick:a[0]||(a[0]=d=>s.$emit("close"))},[e.createVNode(R,{name:"close",size:14})])]),e.createElementVNode("div",Fl,[e.renderSlot(s.$slots,"default",{},void 0,!0)])],4)])):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-fce3d7ef"]]),Ol={class:"um"},zl=U({__name:"UpdateModal",emits:["close"],setup(r){const t=e.ref("");return e.onMounted(async()=>{try{const n=await A.apiGet("/system/info");n&&n.version&&(t.value=n.version)}catch{}}),(n,o)=>(e.openBlock(),e.createBlock(Gl,{"max-width":"640px",onClose:o[0]||(o[0]=l=>n.$emit("close"))},{title:e.withCtx(()=>[e.createVNode(R,{name:"download",size:14}),o[1]||(o[1]=e.createTextVNode(" 软件更新 ",-1))]),default:e.withCtx(()=>[e.createElementVNode("div",Ol,[e.createVNode(He,{"current-version":t.value},null,8,["current-version"]),o[2]||(o[2]=e.createElementVNode("div",{class:"um-tips"},[e.createElementVNode("p",null,[e.createTextVNode("· 安装只替换程序与内置资源，"),e.createElementVNode("b",null,"config/ 与 .pair/ 下的用户数据、配置、技能不会被覆盖"),e.createTextVNode("。")]),e.createElementVNode("p",null,"· 「立即安装并重启」会在替换完成后自动重启服务；「仅安装，稍后重启」等你下次重启生效。"),e.createElementVNode("p",null,"· 更新源 / 发布频道 / 自动检查 / 校验开关：设置面板 → 软件更新。")],-1))])]),_:1}))}},[["__scopeId","data-v-6c94c04d"]]),Ul={class:"toast-container"},jl={class:"dlg-box",style:{"max-width":"400px"}},Hl={class:"dlg-title"},Wl={class:"dlg-body"},ql={class:"dlg-actions"},Jl={class:"dlg-box",style:{"max-width":"420px"}},Kl={class:"dlg-title"},Zl={class:"dlg-body",style:{display:"flex","flex-direction":"column",gap:"8px"}},Ql={style:{"font-size":"13px",color:"var(--text-secondary)"}},Yl=["placeholder"],Xl={class:"dlg-actions"},_l={class:"dlg-box",style:{"max-width":"400px"}},vl={class:"dlg-title"},ea={class:"dlg-body",style:{"white-space":"pre-line"}},na=U({__name:"GlobalDialogs",setup(r){const t=e.ref(null);e.watch(()=>x.dialogState.show,l=>{l&&x.dialogState.type==="prompt"&&e.nextTick(()=>{var s,a;(s=t.value)==null||s.focus(),(a=t.value)==null||a.select()})});function n(){if(x.dialogState.type==="prompt"){const l=x.dialogState.inputValue;x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(l)}else if(x.dialogState.type==="confirm"&&x.dialogState.checkboxLabel){const s=x.dialogState.checkboxValue;x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve({confirmed:!0,checked:s})}else x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(!0);x.dialogState.resolve=null}function o(){x.dialogState.type==="confirm"&&x.dialogState.checkboxLabel?(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve({confirmed:!1,checked:x.dialogState.checkboxValue})):x.dialogState.type==="prompt"?(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(null)):(x.dialogState.show=!1,x.dialogState.resolve&&x.dialogState.resolve(!1)),x.dialogState.resolve=null}return(l,s)=>(e.openBlock(),e.createElementBlock(e.Fragment,null,[e.createCommentVNode(" Toast 通知区域 "),e.createElementVNode("div",Ul,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(e.unref(x.dialogState).toasts,a=>(e.openBlock(),e.createElementBlock("div",{key:a.id,class:e.normalizeClass(["toast-item","toast-"+(a.type||"info")])},e.toDisplayString(a.message),3))),128))]),e.createCommentVNode(" Confirm 对话框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="confirm"?(e.openBlock(),e.createElementBlock("div",{key:0,class:"dlg-overlay",onClick:e.withModifiers(o,["self"])},[e.createElementVNode("div",jl,[e.createElementVNode("div",Hl,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",Wl,e.toDisplayString(e.unref(x.dialogState).message),1),e.unref(x.dialogState).checkboxLabel?(e.openBlock(),e.createElementBlock("label",{key:0,class:"dlg-checkbox",onClick:s[1]||(s[1]=e.withModifiers(()=>{},["stop"]))},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":s[0]||(s[0]=a=>e.unref(x.dialogState).checkboxValue=a)},null,512),[[e.vModelCheckbox,e.unref(x.dialogState).checkboxValue]]),e.createElementVNode("span",null,e.toDisplayString(e.unref(x.dialogState).checkboxLabel),1)])):e.createCommentVNode("v-if",!0),e.createElementVNode("div",ql,[e.createElementVNode("button",{class:"dlg-btn",onClick:o},e.toDisplayString(e.unref(x.dialogState).cancelText),1),e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},e.toDisplayString(e.unref(x.dialogState).confirmText),1)])])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" Prompt 对话框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="prompt"?(e.openBlock(),e.createElementBlock("div",{key:1,class:"dlg-overlay",onClick:e.withModifiers(o,["self"])},[e.createElementVNode("div",Jl,[e.createElementVNode("div",Kl,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",Zl,[e.createElementVNode("span",Ql,e.toDisplayString(e.unref(x.dialogState).message),1),e.withDirectives(e.createElementVNode("input",{ref_key:"promptInputRef",ref:t,"onUpdate:modelValue":s[2]||(s[2]=a=>e.unref(x.dialogState).inputValue=a),placeholder:e.unref(x.dialogState).inputPlaceholder,class:"dlg-input",onKeyup:[e.withKeys(n,["enter"]),e.withKeys(o,["escape"])]},null,40,Yl),[[e.vModelText,e.unref(x.dialogState).inputValue]])]),e.createElementVNode("div",Xl,[e.createElementVNode("button",{class:"dlg-btn",onClick:o},e.toDisplayString(e.unref(x.dialogState).cancelText),1),e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},e.toDisplayString(e.unref(x.dialogState).confirmText),1)])])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" Alert 信息框 "),e.unref(x.dialogState).show&&e.unref(x.dialogState).type==="alert"?(e.openBlock(),e.createElementBlock("div",{key:2,class:"dlg-overlay",onClick:e.withModifiers(n,["self"])},[e.createElementVNode("div",_l,[e.createElementVNode("div",vl,e.toDisplayString(e.unref(x.dialogState).title),1),e.createElementVNode("div",ea,e.toDisplayString(e.unref(x.dialogState).message),1),e.createElementVNode("div",{class:"dlg-actions"},[e.createElementVNode("button",{class:"dlg-btn primary",onClick:n},"确定")])])])):e.createCommentVNode("v-if",!0)],64))}},[["__scopeId","data-v-0271e4ae"]]),ta=U({__name:"UiModals",setup(r){const t=e.ref(null);let n=null;function o(){x.showAbout.value=!1,x.showHelp.value=!0,x.helpDocTarget.value="getting-started"}function l(){x.showHelp.value=!1,x.showAbout.value=!0}return e.onMounted(()=>{n=we.mountListSlot(t,"overlay",{isActive:s=>we.isOverlayActive("overlay",s)})}),e.onUnmounted(()=>{n&&(n(),n=null)}),(s,a)=>(e.openBlock(),e.createElementBlock(e.Fragment,null,[e.unref(x.showSettings)?(e.openBlock(),e.createBlock(ur,{key:0,onClose:a[0]||(a[0]=d=>x.showSettings.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showSystem)?(e.openBlock(),e.createBlock(Ar,{key:1,onClose:a[1]||(a[1]=d=>x.showSystem.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showSource)?(e.openBlock(),e.createBlock(Rr,{key:2,onClose:a[2]||(a[2]=d=>x.showSource.value=!1)})):e.createCommentVNode("v-if",!0),e.unref(x.showHelp)?(e.openBlock(),e.createBlock(vo,{key:3,onClose:a[3]||(a[3]=d=>x.showHelp.value=!1),onOpenAbout:l,initialDoc:e.unref(x.helpDocTarget)},null,8,["initialDoc"])):e.createCommentVNode("v-if",!0),e.unref(x.showAbout)?(e.openBlock(),e.createBlock(Dl,{key:4,onClose:a[4]||(a[4]=d=>x.showAbout.value=!1),onOpenHelp:o})):e.createCommentVNode("v-if",!0),e.unref(x.showUpdate)?(e.openBlock(),e.createBlock(zl,{key:5,onClose:a[5]||(a[5]=d=>x.showUpdate.value=!1)})):e.createCommentVNode("v-if",!0),e.createVNode(na),e.createCommentVNode(" ★ overlay 槽位（list 型）：插件注册的浮动层条目叠加渲染（badge/toast/status pill 等） "),e.createElementVNode("div",{ref_key:"overlaySlotEl",ref:t,class:"plugin-overlay-host"},null,512)],64))}},[["__scopeId","data-v-a045ab80"]]);function ra(r){const t=e.createApp(ta);return t.mount(r),()=>{t.unmount()}}return J.mount=ra,Object.defineProperty(J,Symbol.toStringTag,{value:"Module"}),J})({},window.__PAIRCODE_CORE.Vue,window.__PAIRCODE_CORE.uiState,window.__PAIRCODE_CORE.pluginRuntime,window.__PAIRCODE_CORE.api);
