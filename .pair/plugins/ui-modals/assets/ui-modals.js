...
${f}`:f,l=l?`${l}
${g}`:g;let B=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(g,s,!0),this.lexer.state.top=B,n.length===0)break;let w=s.at(-1);if((w==null?void 0:w.type)==="code")break;if((w==null?void 0:w.type)==="blockquote"){let T=w,u=T.raw+`
`+n.join(`
`),S=this.blockquote(u);s[s.length-1]=S,o=o.substring(0,o.length-T.raw.length)+S.raw,l=l.substring(0,l.length-T.text.length)+S.text;break}else if((w==null?void 0:w.type)==="list"){let T=w,u=T.raw+`
`+n.join(`
`),S=this.list(u);s[s.length-1]=S,o=o.substring(0,o.length-w.raw.length)+S.raw,l=l.substring(0,l.length-T.raw.length)+S.raw,n=u.substring(s.at(-1).raw.length).split(`
...
`)?"":`
`)+i.raw,g.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=g.text):n.push(i);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){var f,g,B,w,T;this.tokenizer.lexer=this;let o=t,l=null;if(this.tokens.links){let u=Object.keys(this.tokens.links);if(u.length>0)for(;(l=this.tokenizer.rules.inline.reflinkSearch.exec(o))!==null;)u.includes(l[0].slice(l[0].lastIndexOf("[")+1,-1))&&(o=o.slice(0,l.index)+"["+"a".repeat(l[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(l=this.tokenizer.rules.inline.anyPunctuation.exec(o))!==null;)o=o.slice(0,l.index)+"++"+o.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(l=this.tokenizer.rules.inline.blockSkip.exec(o))!==null;)s=l[2]?l[2].length:0,o=o.slice(0,l.index+s)+"["+"a".repeat(l[0].length-s-2)+"]"+o.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);o=((g=(f=this.options.hooks)==null?void 0:f.emStrongMask)==null?void 0:g.call({lexer:this},o))??o;let a=!1,d="",i=1/0;for(;t;){if(t.length<i)i=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}a||(d=""),a=!1;let u;if((w=(B=this.options.extensions)==null?void 0:B.inline)!=null&&w.some(P=>(u=P.call({lexer:this},t,n))?(t=t.substring(u.raw.length),n.push(u),!0):!1))continue;if(u=this.tokenizer.escape(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.tag(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.link(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(u.raw.length);let P=n.at(-1);u.type==="text"&&(P==null?void 0:P.type)==="text"?(P.raw+=u.raw,P.text+=u.text):n.push(u);continue}if(u=this.tokenizer.emStrong(t,o,d)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.codespan(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.br(t)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.del(t,o,d)){t=t.substring(u.raw.length),n.push(u);continue}if(u=this.tokenizer.autolink(t)){t=t.substring(u.raw.length),n.push(u);continue}if(!this.state.inLink&&(u=this.tokenizer.url(t))){t=t.substring(u.raw.length),n.push(u);continue}let S=t;if((T=this.options.extensions)!=null&&T.startInline){let P=1/0,D=t.slice(1),L;this.options.extensions.startInline.forEach(O=>{L=O.call({lexer:this},D),typeof L=="number"&&L>=0&&(P=Math.min(P,L))}),P<1/0&&P>=0&&(S=t.substring(0,P+1))}if(u=this.tokenizer.inlineText(S)){t=t.substring(u.raw.length),u.raw.slice(-1)!=="_"&&(d=u.raw.slice(-1)),a=!0;let P=n.at(-1);(P==null?void 0:P.type)==="text"?(P.raw+=u.raw,P.text+=u.text):n.push(u);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return n}infiniteLoopError(t){let n="Infinite loop on byte: "+t;if(this.options.silent)console.error(n);else throw new Error(n)}},ie=class{constructor(r){M(this,"options");M(this,"parser");this.options=r||Z}space(r){return""}code({text:r,lang:t,escaped:n}){var s;let o=(s=(t||"").match(G.notSpaceStart))==null?void 0:s[0],l=r.replace(G.endingNewline,"")+`
