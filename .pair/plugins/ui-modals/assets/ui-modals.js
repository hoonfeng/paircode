...
删除后它们仍可继续聊天（配置是完整快照），但在对话面板里会失去模型分组；建议先在「AI 配置」里把它们改选到其他服务商。`),!window.confirm(E))return;const i=H();delete i[N.name];try{await A.saveModels(i),await S(),n("saved")}catch(d){u.value="删除失败: "+(d.message||d)}}function B(N){const f=l.value.find(d=>d.name===N);if(!f)return"";const E=Object.keys(f.modelParams||{}).length,i=[];return f.temperature&&i.push("温度 "+f.temperature),f.thinkingMode&&i.push("思考 "+f.thinkingMode),f.maxTokens>0&&i.push("输出上限 "+f.maxTokens),E&&i.push("模型参数 "+E+" 个"),i.join(" · ")}return(N,f)=>(e.openBlock(),e.createElementBlock("div",nn,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",tn,[e.createElementVNode("span",rn,e.toDisplayString(l.value.length)+" 个服务商",1),e.createElementVNode("button",{class:"pm-btn pm-primary",onClick:P},"+ 新增服务商")]),e.createCommentVNode(" 新增表单（工具栏下方展开，紧邻按钮不跳动） "),s.value==="__new__"?(e.openBlock(),e.createElementBlock("div",on,[f[21]||(f[21]=e.createElementVNode("div",{class:"pm-edit-title"},"新增服务商",-1)),e.createElementVNode("div",ln,[f[14]||(f[14]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[0]||(f[0]=E=>a.value.name=E),placeholder:"如 deepseek"},null,512),[[e.vModelText,a.value.name]])]),e.createElementVNode("div",an,[f[15]||(f[15]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[1]||(f[1]=E=>a.value.baseURL=E),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,a.value.baseURL]])]),e.createElementVNode("div",sn,[e.createElementVNode("span",cn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":f[2]||(f[2]=E=>a.value.protocol=E),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,E=>(e.openBlock(),e.createElementBlock("option",{key:"p"+E,value:E},e.toDisplayString(E||"默认"),9,pn))),128))],8,dn),[[e.vModelSelect,a.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",mn,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",gn,[f[16]||(f[16]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[3]||(f[3]=E=>a.value.contextMaxTokens=E),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,a.value.contextMaxTokens]])]),e.createElementVNode("div",kn,[f[17]||(f[17]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[4]||(f[4]=E=>a.value.temperature=E),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,a.value.temperature]])]),e.createCommentVNode(` ★ 2026-09-25 服务商级生成参数：生成参数唯一来源 = 本页（模型级可逐模型覆盖），
           设置面板的「生成参数」页已移除（选项来自插件 schema modelParamFields）。 `),e.createElementVNode("div",hn,[f[18]||(f[18]=e.createElementVNode("span",{class:"pm-field-label"},"默认思考档位",-1)),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":f[5]||(f[5]=E=>a.value.thinkingMode=E),title:"思考档位（OpenAI reasoning.effort 口径）：空=不下发；模型级可覆盖"},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(V.value,E=>(e.openBlock(),e.createElementBlock("option",{key:"t"+E,value:E},e.toDisplayString(E||"默认（不设）"),9,fn))),128))],512),[[e.vModelSelect,a.value.thinkingMode]])]),e.createElementVNode("div",un,[f[19]||(f[19]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[6]||(f[6]=E=>a.value.maxTokens=E),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,a.value.maxTokens]])]),e.createVNode(Te,{models:m.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:G},null,8,["models","label","placeholder"]),e.createElementVNode("div",yn,[f[20]||(f[20]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),m.value.length?(e.openBlock(),e.createElementBlock("div",bn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(m.value,E=>(e.openBlock(),e.createElementBlock("div",{key:E,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:E},e.toDisplayString(E),9,En),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,i=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:i.name},[i.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:i.hint||i.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":d=>c.value[E][i.name]=d},null,8,Vn),[[e.vModelCheckbox,c.value[E][i.name]]]),e.createTextVNode(" "+e.toDisplayString(i.label),1)],8,xn)):i.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":d=>c.value[E][i.name]=d,title:i.hint||i.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(i.options||[],d=>(e.openBlock(),e.createElementBlock("option",{key:"o"+d,value:d},e.toDisplayString(d===""?i.label+"默认":d),9,wn))),128))],8,Nn)),[[e.vModelSelect,c.value[E][i.name]]]):i.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":d=>c.value[E][i.name]=d,type:"number",min:i.min??0,step:i.step??1,placeholder:i.label,title:i.hint||i.label},null,8,Sn)),[[e.vModelText,c.value[E][i.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":d=>c.value[E][i.name]=d,type:"text",placeholder:i.label,title:i.hint||i.label},null,8,Tn)),[[e.vModelText,c.value[E][i.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",Bn,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",Cn,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:h.value,onClick:j},e.toDisplayString(h.value?"保存中…":"保存服务商"),9,Pn),e.createElementVNode("button",{class:"pm-btn",onClick:U},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 服务商卡片列表（编辑时在卡片位置就地展开表单，不跳顶） "),l.value.length?(e.openBlock(),e.createElementBlock("div",In,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(l.value,E=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:E.name},[s.value===E.name?(e.openBlock(),e.createElementBlock("div",An,[e.createElementVNode("div",Mn,"编辑服务商："+e.toDisplayString(E.name),1),e.createElementVNode("div",$n,[f[22]||(f[22]=e.createElementVNode("span",{class:"pm-field-label"},"服务商名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[7]||(f[7]=i=>a.value.name=i),placeholder:"如 deepseek"},null,512),[[e.vModelText,a.value.name]]),f[23]||(f[23]=e.createElementVNode("span",{class:"pm-hint"},"改名会一并同步引用该服务商的 AI 配置（连接信息不丢）；空=保持原名",-1))]),e.createElementVNode("div",Dn,[f[24]||(f[24]=e.createElementVNode("span",{class:"pm-field-label"},"API URL（基础地址或完整端点）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[8]||(f[8]=i=>a.value.baseURL=i),placeholder:"https://api.deepseek.com/v1（基础地址；旧完整端点亦兼容）"},null,512),[[e.vModelText,a.value.baseURL]])]),e.createElementVNode("div",Ln,[e.createElementVNode("span",Rn,e.toDisplayString(r.protocolLabel),1),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":f[9]||(f[9]=i=>a.value.protocol=i),title:r.protocolHint},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.protocolOptions,i=>(e.openBlock(),e.createElementBlock("option",{key:"p"+i,value:i},e.toDisplayString(i||"默认"),9,Fn))),128))],8,Gn),[[e.vModelSelect,a.value.protocol]]),r.protocolHint?(e.openBlock(),e.createElementBlock("span",On,e.toDisplayString(r.protocolHint),1)):e.createCommentVNode("v-if",!0)]),e.createElementVNode("div",Un,[f[25]||(f[25]=e.createElementVNode("span",{class:"pm-field-label"},"上下文大小（Token）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[10]||(f[10]=i=>a.value.contextMaxTokens=i),type:"number",min:"0",step:"1000",placeholder:"0=不限制（模型级未配置时的默认窗口）"},null,512),[[e.vModelText,a.value.contextMaxTokens]])]),e.createElementVNode("div",zn,[f[26]||(f[26]=e.createElementVNode("span",{class:"pm-field-label"},"默认温度",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[11]||(f[11]=i=>a.value.temperature=i),placeholder:"如 0.3（空=不设；模型级可覆盖）"},null,512),[[e.vModelText,a.value.temperature]])]),e.createElementVNode("div",jn,[f[27]||(f[27]=e.createElementVNode("span",{class:"pm-field-label"},"默认思考档位",-1)),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":f[12]||(f[12]=i=>a.value.thinkingMode=i),title:"思考档位（OpenAI reasoning.effort 口径）：空=不下发；模型级可覆盖"},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(V.value,i=>(e.openBlock(),e.createElementBlock("option",{key:"t"+i,value:i},e.toDisplayString(i||"默认（不设）"),9,Hn))),128))],512),[[e.vModelSelect,a.value.thinkingMode]])]),e.createElementVNode("div",_n,[f[28]||(f[28]=e.createElementVNode("span",{class:"pm-field-label"},"默认输出 Token（最大输出）",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":f[13]||(f[13]=i=>a.value.maxTokens=i),type:"number",min:"0",step:"1024",placeholder:"0=不设（模型级可覆盖）"},null,512),[[e.vModelText,a.value.maxTokens]])]),e.createVNode(Te,{models:m.value,label:r.modelEditor.label||"可用模型（回车或逗号分隔添加；支持整段粘贴）",placeholder:r.modelEditor.placeholder||"输入模型名，回车添加…",onChange:G},null,8,["models","label","placeholder"]),e.createElementVNode("div",Wn,[f[29]||(f[29]=e.createElementVNode("div",{class:"pm-params-title"},"模型参数（每模型独立配置；对话里也可临时切换思考档位）",-1)),m.value.length?(e.openBlock(),e.createElementBlock("div",qn,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(m.value,i=>(e.openBlock(),e.createElementBlock("div",{key:i,class:"pm-param-row"},[e.createElementVNode("span",{class:"pm-param-model",title:i},e.toDisplayString(i),9,Jn),e.createCommentVNode(" ★ 2026-08-21 schema 驱动：按 modelParamFields 动态渲染（checkbox/select/number/text） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.modelParamFields,d=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:d.name},[d.type==="checkbox"?(e.openBlock(),e.createElementBlock("label",{key:0,class:"pm-param-check",title:d.hint||d.label},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":g=>c.value[i][d.name]=g},null,8,Zn),[[e.vModelCheckbox,c.value[i][d.name]]]),e.createTextVNode(" "+e.toDisplayString(d.label),1)],8,Kn)):d.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:1,"onUpdate:modelValue":g=>c.value[i][d.name]=g,title:d.hint||d.label},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(d.options||[],g=>(e.openBlock(),e.createElementBlock("option",{key:"o"+g,value:g},e.toDisplayString(g===""?d.label+"默认":g),9,Xn))),128))],8,Qn)),[[e.vModelSelect,c.value[i][d.name]]]):d.type==="number"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:2,"onUpdate:modelValue":g=>c.value[i][d.name]=g,type:"number",min:d.min??0,step:d.step??1,placeholder:d.label,title:d.hint||d.label},null,8,Yn)),[[e.vModelText,c.value[i][d.name],void 0,{number:!0}]]):e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:3,"onUpdate:modelValue":g=>c.value[i][d.name]=g,type:"text",placeholder:d.label,title:d.hint||d.label},null,8,vn)),[[e.vModelText,c.value[i][d.name]]])],64))),128))]))),128))])):(e.openBlock(),e.createElementBlock("div",et,"添加模型后，可逐模型配置参数（温度/思考/输出/上下文/多模态…）"))]),e.createElementVNode("div",nt,[e.createElementVNode("button",{class:"pm-btn pm-primary",disabled:h.value,onClick:j},e.toDisplayString(h.value?"保存中…":"保存服务商"),9,tt),e.createElementVNode("button",{class:"pm-btn",onClick:U},"取消")])])):(e.openBlock(),e.createElementBlock("div",rt,[e.createElementVNode("div",ot,[e.createElementVNode("span",{class:"pm-name",title:E.name},e.toDisplayString(E.name),9,lt),e.createElementVNode("div",at,[e.createElementVNode("button",{class:"pm-btn pm-small",onClick:i=>R(E)},"编辑",8,st),e.createElementVNode("button",{class:"pm-btn pm-small pm-danger",onClick:i=>I(E)},"删除",8,it)])]),e.createElementVNode("div",{class:"pm-url",title:E.baseURL},e.toDisplayString(E.baseURL||"未配置 API URL"),9,ct),E.protocol?(e.openBlock(),e.createElementBlock("div",{key:0,class:"pm-protocol",title:r.protocolHint},"协议 "+e.toDisplayString(E.protocol),9,dt)):e.createCommentVNode("v-if",!0),e.createElementVNode("div",pt,e.toDisplayString(E.contextMaxTokens>0?"上下文 "+(E.contextMaxTokens/1e3).toFixed(0)+"K Token":"上下文 未限制"),1),e.createElementVNode("div",mt,[E.models.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("span",gt,"（未配置模型）")),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(E.models,i=>(e.openBlock(),e.createElementBlock("span",{key:i,class:"pm-tag"},e.toDisplayString(i),1))),128))]),B(E.name)?(e.openBlock(),e.createElementBlock("div",kt,e.toDisplayString(B(E.name)),1)):e.createCommentVNode("v-if",!0)]))],64))),128))])):s.value!=="__new__"?(e.openBlock(),e.createElementBlock("div",ht,"暂无服务商，点「+ 新增服务商」添加")):e.createCommentVNode("v-if",!0),u.value?(e.openBlock(),e.createElementBlock("div",ft,e.toDisplayString(u.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-2eaed0aa"]]),yt={class:"pm-manager"},bt={class:"mgm-toolbar"},Et={class:"mgm-count"},xt={key:0,class:"mgm-edit"},Vt={class:"mgm-edit-title"},Nt={class:"mgm-field"},wt={class:"mgm-field-label"},St={key:0,class:"mgm-required"},Tt=["onUpdate:modelValue","onChange"],Bt=["value"],Ct=["onUpdate:modelValue","placeholder"],Pt=["onUpdate:modelValue","placeholder"],It={key:3,class:"mgm-field-hint"},At={class:"mgm-edit-actions"},Mt=["disabled"],$t={key:1,class:"mgm-cards"},Dt={class:"mgm-card-head"},Lt=["title"],Rt={key:0,class:"pm-active-badge"},Gt={class:"mgm-ops"},Ft=["disabled","onClick"],Ot=["onClick"],Ut=["onClick"],zt={class:"pm-preview"},jt={class:"pm-snap-row"},Ht={class:"pm-snap-row"},_t={key:2,class:"mgm-empty"},Wt={key:3,class:"mgm-error"},qt=z({__name:"PresetManager",props:{presetFields:{type:Array,default:()=>[]}},emits:["saved"],setup(r,{expose:t,emit:n}){const o=r,l=n,s=e.ref({}),a=e.computed(()=>Object.keys(s.value||{})),m=e.ref(""),c=e.ref(!1),u=e.ref(""),h=e.ref(!1),w=e.ref(""),V=e.ref(""),T=e.ref(null),y=e.computed(()=>T.value&&T.value.providers||[]),S=e.ref({name:"",provider:"",baseURL:"",apiKey:""});function P(i={}){const d={name:"",provider:"",baseURL:"",apiKey:""};for(const g of o.presetFields)g.name in d||(d[g.name]="");return Object.assign(d,i)}function R(i){V.value=i,setTimeout(()=>{V.value===i&&(V.value="")},4e3)}async function G(){try{const[i,d,g]=await Promise.all([A.getAiPresets().catch(()=>({presets:{}})),A.apiGet("/settings").catch(()=>({settings:{}})),A.getModels().catch(()=>null)]);s.value=i&&i.presets||{},m.value=d&&d.settings&&d.settings.preset||"",T.value=g}catch(i){R("加载失败: "+(i.message||i))}}function U(i){const d=T.value||{};return{baseURL:d.providerBaseURLs&&d.providerBaseURLs[i]||"",models:d.models&&d.models[i]||[]}}function H(){const i=window&&window.__PAIRCODE_CORE&&window.__PAIRCODE_CORE.uiState&&window.__PAIRCODE_CORE.uiState.state&&window.__PAIRCODE_CORE.uiState.state.settings||{};let d={};i.preset&&s.value&&s.value[i.preset]&&(d=s.value[i.preset]);const g=d.provider||y.value[0]||"",k=U(g);S.value=P({provider:g,baseURL:d.baseURL||k.baseURL||"",apiKey:d.apiKey||""}),u.value="",c.value=!0}function j(i){const d=s.value&&s.value[i]||{};S.value=P({name:i,provider:d.provider||"",baseURL:d.baseURL||"",apiKey:d.apiKey||""}),u.value=i,c.value=!0}function F(){c.value=!1,u.value=""}function I(i){return i.source==="providers"?y.value||[]:i.options||[]}function B(i){if(i.name==="provider"&&S.value.provider){const d=U(S.value.provider);S.value.baseURL=d.baseURL||""}}e.watch(()=>S.value.provider,(i,d)=>{!c.value||d===""||i!==d&&B({name:"provider"})});async function N(){const i=S.value.name.trim();if(!i){R("请输入配置名称");return}const d=S.value.provider||"";if(!d){R("请选择服务商");return}for(const k of o.presetFields)if(k.required&&!S.value[k.name]){R("请填写"+k.label);return}const g=U(d);S.value.baseURL||(S.value.baseURL=g.baseURL||""),h.value=!0,V.value="";try{const k={provider:d,baseURL:S.value.baseURL,apiKey:S.value.apiKey};for(const p of o.presetFields)p.name!=="provider"&&p.name!=="apiKey"&&(k[p.name]=S.value[p.name]);if(u.value&&u.value!==i){const p={...s.value||{}};p[i]=k,delete p[u.value];const x=await A.saveAiPresets(p);if(!(x&&x.ok)){R(x&&x.error||"保存失败");return}s.value=p,m.value===u.value&&(m.value=i,await A.apiPut("/settings",{settings:{preset:i},pluginSettings:{}}).catch(()=>{}))}else{const p=await A.saveAiPreset("save",i,k);if(!(p&&p.ok)){R(p&&p.error||"保存失败");return}s.value=p.presets||s.value}F(),l("saved")}catch(k){R("保存失败: "+(k.message||k))}finally{h.value=!1}}async function f(i){w.value=i,V.value="";try{const d=await A.saveAiPreset("apply",i);d&&d.ok?(m.value=i,l("saved")):R(d&&d.error||"应用失败")}catch(d){R("应用失败: "+(d.message||d))}finally{w.value=""}}async function E(i){if(confirm("删除配置「"+i+"」？")){V.value="";try{const d=await A.saveAiPreset("delete",i);d&&d.ok?(s.value=d.presets||s.value,m.value===i&&(m.value=""),l("saved")):R(d&&d.error||"删除失败")}catch(d){R("删除失败: "+(d.message||d))}}}return e.onMounted(G),t({load:G}),(i,d)=>(e.openBlock(),e.createElementBlock("div",yt,[e.createCommentVNode(" 工具栏 "),e.createElementVNode("div",bt,[e.createElementVNode("span",Et,e.toDisplayString(a.value.length)+" 个配置",1),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:H,title:"添加一条 AI 配置（服务商 + API Key）"},"＋ 添加新配置")]),e.createCommentVNode(" 添加 / 编辑表单（点击添加/编辑才弹出） "),c.value?(e.openBlock(),e.createElementBlock("div",xt,[e.createElementVNode("div",Vt,e.toDisplayString(u.value?"编辑配置："+u.value:"添加新配置"),1),e.createElementVNode("div",Nt,[d[1]||(d[1]=e.createElementVNode("span",{class:"mgm-field-label"},"配置名称",-1)),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":d[0]||(d[0]=g=>S.value.name=g),type:"text",placeholder:"如：主力 / 写作备用…",onKeydown:e.withKeys(N,["enter"])},null,544),[[e.vModelText,S.value.name]])]),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(r.presetFields,g=>(e.openBlock(),e.createElementBlock("div",{key:g.name,class:"mgm-field"},[e.createElementVNode("span",wt,[e.createTextVNode(e.toDisplayString(g.label),1),g.required?(e.openBlock(),e.createElementBlock("span",St,"*")):e.createCommentVNode("v-if",!0)]),e.createCommentVNode(" select 类型（服务商选择） "),g.type==="select"?e.withDirectives((e.openBlock(),e.createElementBlock("select",{key:0,"onUpdate:modelValue":k=>S.value[g.name]=k,class:"mgm-select",onChange:k=>B(g)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(I(g),k=>(e.openBlock(),e.createElementBlock("option",{key:k,value:k},e.toDisplayString(k),9,Bt))),128))],40,Tt)),[[e.vModelSelect,S.value[g.name]]]):g.type==="password"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" password 类型（API Key） "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":k=>S.value[g.name]=k,type:"password",placeholder:g.placeholder||""},null,8,Ct),[[e.vModelText,S.value[g.name]]])],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" text 兜底 "),e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":k=>S.value[g.name]=k,type:"text",placeholder:g.placeholder||""},null,8,Pt),[[e.vModelText,S.value[g.name]]])],2112)),g.hint?(e.openBlock(),e.createElementBlock("span",It,e.toDisplayString(g.hint),1)):e.createCommentVNode("v-if",!0)]))),128)),e.createElementVNode("div",At,[e.createElementVNode("button",{class:"mgm-btn mgm-primary",disabled:h.value,onClick:N},e.toDisplayString(h.value?"保存中…":"保存配置"),9,Mt),e.createElementVNode("button",{class:"mgm-btn",onClick:F},"取消")])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 配置卡片列表（主视图） "),a.value.length?(e.openBlock(),e.createElementBlock("div",$t,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(a.value,g=>(e.openBlock(),e.createElementBlock("div",{key:g,class:e.normalizeClass(["mgm-card",{"pm-active":g===m.value}])},[e.createElementVNode("div",Dt,[e.createElementVNode("span",{class:"mgm-name",title:g},[e.createTextVNode(e.toDisplayString(g),1),g===m.value?(e.openBlock(),e.createElementBlock("span",Rt,"使用中")):e.createCommentVNode("v-if",!0)],8,Lt),e.createElementVNode("div",Gt,[e.createElementVNode("button",{class:"mgm-btn mgm-small",disabled:w.value===g,onClick:k=>f(g)},e.toDisplayString(w.value===g?"应用中…":"应用"),9,Ft),e.createElementVNode("button",{class:"mgm-btn mgm-small",onClick:k=>j(g)},"编辑",8,Ot),e.createElementVNode("button",{class:"mgm-btn mgm-small mgm-danger",onClick:k=>E(g)},"删除",8,Ut)])]),e.createElementVNode("div",zt,[e.createElementVNode("div",jt,[d[2]||(d[2]=e.createElementVNode("span",null,"服务商",-1)),e.createElementVNode("b",null,e.toDisplayString((s.value[g]||{}).provider||"—"),1)]),e.createElementVNode("div",Ht,[d[3]||(d[3]=e.createElementVNode("span",null,"API Key",-1)),e.createElementVNode("b",null,e.toDisplayString((s.value[g]||{}).apiKey?"已配置":"未配置"),1)])])],2))),128))])):c.value?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",_t,[e.createElementVNode("div",{class:"mgm-empty-box"},[d[4]||(d[4]=e.createElementVNode("div",{class:"mgm-empty-title"},"还没有 AI 配置",-1)),d[5]||(d[5]=e.createElementVNode("div",{class:"mgm-empty-sub"},"添加一条服务商 + API Key，保存后即可在对话面板中选模型。",-1)),e.createElementVNode("button",{class:"mgm-btn mgm-primary",onClick:H},"＋ 添加新配置")])])),V.value?(e.openBlock(),e.createElementBlock("div",Wt,e.toDisplayString(V.value),1)):e.createCommentVNode("v-if",!0)]))}},[["__scopeId","data-v-3e18e523"]]),Jt={class:"modal-content"},Kt={class:"modal-head"},Zt={class:"mh-text"},Qt={class:"mh-title"},Xt={class:"mh-sub"},Yt={class:"modal-body"},vt={key:0,class:"settings-tabs"},er={key:0,class:"settings-tabs-filter-wrap"},nr=["onClick"],tr={class:"st-label"},rr={key:1,class:"settings-tabs-none"},or={class:"settings-content"},lr={key:0},ar={key:0,class:"group-title"},sr=["title"],ir=["title"],cr=["onUpdate:modelValue"],dr=["title"],pr={class:"field-control"},mr=["type","onUpdate:modelValue","placeholder"],gr=["onUpdate:modelValue","min","max","step"],kr=["onUpdate:modelValue","onChange"],hr=["value"],fr={class:"theme-gallery"},ur=["title","onClick"],yr={class:"tg-preview"},br={class:"tg-text"},Er={class:"tg-label"},xr={key:0,class:"tg-desc"},Vr={class:"color-dots"},Nr=["title","onClick"],wr=["onUpdate:modelValue","placeholder"],Sr={class:"slider-row"},Tr=["onUpdate:modelValue","min","max","step"],Br={class:"slider-val"},Cr={class:"color-row"},Pr=["onUpdate:modelValue"],Ir={class:"color-code"},Ar=["value","onInput","placeholder"],Mr=["placeholder"],$r=["onUpdate:modelValue"],Dr={key:0,class:"setting-hint"},Lr={key:0,class:"settings-empty"},Rr=z({__name:"SettingsModal",emits:["close"],setup(r,{emit:t}){const n=t,o=e.ref(""),l=e.ref(""),s=e.computed(()=>{const i=(b.state.pluginSchemas||[]).map(d=>({key:d.key,title:d.title||d.key,groups:m(d.fields||[])}));return i.length&&!o.value&&(o.value=i[0].key),i}),a=e.computed(()=>{const i=l.value.trim().toLowerCase();if(!i)return s.value;const d=s.value.find(k=>k.key===o.value),g=s.value.filter(k=>(k.title||k.key).toLowerCase().includes(i));return d&&!g.includes(d)&&g.unshift(d),g});function m(i){const d=[],g={};for(const k of i){const p=k.group||"";g[p]||(g[p]=[],d.push({title:p,fields:g[p]})),g[p].push(k)}return d}const c=e.ref(null);let u="";async function h(){try{c.value=await A.getModels()}catch{c.value=null}}function w(i){return i?(c.value&&c.value.models||{})[i]||[]:[]}function V(i,d){var g,k,p;if(d.optionsSource==="models"){const x=(g=y[i])==null?void 0:g[d.name],$=w((k=y.ai)==null?void 0:k.provider);return x&&!$.includes(x)?[...$,x]:$}if(d.optionsSource==="providers"){const x=c.value&&c.value.providers||[];if(x.length){const $=(p=y[i])==null?void 0:p[d.name];return $&&!x.includes($)?[...x,$]:x}return d.options||[]}return d.options||[]}function T(i){if(!y.ai)return;const d=y.ai,g=i.linkFields||(i.linkField?[i.linkField]:[]);if(!g.length)return;const k=c.value||{},p=k.providerBaseURLs||{},x=k.providerKeys||{},$=d.provider,Z=p[u];for(const pe of g)if(pe==="apiKey")d[pe]=x[$]||"";else{const Ve=d[pe];(Ve===void 0||Ve===""||Z&&Ve===Z)&&(d[pe]=p[$]||"")}u=$}const y=e.reactive({}),S=e.ref("");function P(i){return Array.isArray(i.swatches)&&i.swatches.length?i.swatches:(i.options||[]).map(d=>({value:d,label:d,colors:[]}))}function R(i){switch(i){case"checkbox":return!1;case"number":return 0;case"tags":return[];default:return""}}function G(){for(const k of Object.keys(y))delete y[k];const i=b.state.settings||{};u=i.provider||"";const d=i.pluginSettings||{};for(const k of b.state.pluginSchemas||[]){y[k.key]={};for(const p of k.fields||[]){let x;if(!(p.type==="project"||p.type==="provider-manager"||p.type==="model-params-manager"||p.type==="preset-manager")){if(p.binding)x=i[p.binding]!==void 0?i[p.binding]:p.default;else{const $=d[k.key]||{};x=$[p.name]!==void 0?$[p.name]:p.default}x===void 0&&(x=R(p.type)),p.type==="checkbox"&&(x=!!x),p.type==="number"&&(x=typeof x=="number"?x:Number(x)||0),p.type==="tags"&&(x=Array.isArray(x)?x:[]),y[k.key][p.name]=x}}}const g=(b.state.pluginSchemas||[]).some(k=>(k.fields||[]).some(p=>p.type==="project"));S.value="",g&&j()}function U(i,d){var k;const g=(k=y[i])==null?void 0:k[d.name];return Array.isArray(g)?g.join(", "):g||""}function H(i,d,g){y[i][d.name]=g.target.value.split(",").map(k=>k.trim()).filter(Boolean)}async function j(){try{const i=await A.getInstructions("project");S.value=i.content||""}catch{}}function F(){var i;G(),(i=b.state.settings)!=null&&i.theme&&b.applyTheme(b.state.settings.theme)}const I=()=>{F()},B=e.ref(0);async function N(){await h(),B.value++}async function f(){try{const i=await A.apiGet("/settings");i&&i.settings&&(b.state.settings=i.settings,await h(),F())}catch{}}const E=async()=>{try{let i={};try{const p=await A.apiGet("/settings");i=p&&p.settings||{}}catch{}const d={...i},g={...i.pluginSettings||{}};let k=!1;for(const p of b.state.pluginSchemas||[]){const x=y[p.key]||{};for(const $ of p.fields||[]){if($.type==="project"){await A.saveInstructions("project",S.value);continue}if($.type==="provider-manager"||$.type==="model-params-manager"||$.type==="preset-manager")continue;const Z=x[$.name];$.binding?($.name==="theme"&&Z!==d[$.binding]&&(k=!0),d[$.binding]=Z):(g[p.key]||(g[p.key]={}),g[p.key][$.name]=Z)}}await A.apiPut("/settings",{settings:d,pluginSettings:g}),b.state.settings=d,k&&b.applyTheme(d.theme),window.$toast("设置已保存","success"),n("close")}catch(i){window.$toast("保存失败: "+i.message,"error")}};return G(),e.onMounted(async()=>{await h(),F()}),(i,d)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:d[3]||(d[3]=e.withModifiers(g=>i.$emit("close"),["self"]))},[e.createElementVNode("div",Jt,[e.createCommentVNode(` ★ 2026-09-24 对齐设计稿 appearance-theme th782（头部 = 标题 + 副标题两行）：
           副标题显示**当前分类名**（真实数据，非装饰文案）。 `),e.createElementVNode("div",Kt,[e.createElementVNode("div",Zt,[e.createElementVNode("div",Qt,[e.createVNode(L,{name:"settings",size:16}),d[4]||(d[4]=e.createTextVNode(" 设置",-1))]),e.createElementVNode("div",Xt,e.toDisplayString((s.value.find(g=>g.key===o.value)||{}).title||"所有分类"),1)]),e.createElementVNode("button",{class:"modal-close",onClick:d[0]||(d[0]=g=>i.$emit("close"))},"×")]),e.createElementVNode("div",Yt,[e.createCommentVNode(" ═══ 纯 schema 驱动：所有配置 tab 由插件 ctx.registerSettings 注册 ═══ "),s.value.length?(e.openBlock(),e.createElementBlock("div",vt,[e.createCommentVNode(" 设计稿 th783：分组标题「设置分类」 "),d[5]||(d[5]=e.createElementVNode("div",{class:"settings-tabs-title"},"设置分类",-1)),s.value.length>6?(e.openBlock(),e.createElementBlock("div",er,[e.withDirectives(e.createElementVNode("input",{"onUpdate:modelValue":d[1]||(d[1]=g=>l.value=g),class:"settings-tabs-filter",type:"text",placeholder:"筛选设置…"},null,512),[[e.vModelText,l.value]])])):e.createCommentVNode("v-if",!0),e.createCommentVNode(" 设计稿 th755-th773：项 32 高 / radius 8 / 前置图标（选中态=check） "),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(a.value,g=>(e.openBlock(),e.createElementBlock("button",{key:g.key,class:e.normalizeClass(["settings-tab",{active:o.value===g.key}]),onClick:k=>o.value=g.key},[e.createVNode(L,{name:o.value===g.key?"check":"chevron-right",size:14},null,8,["name"]),e.createElementVNode("span",tr,e.toDisplayString(g.title),1)],10,nr))),128)),a.value.length===0?(e.openBlock(),e.createElementBlock("div",rr,"无匹配设置")):e.createCommentVNode("v-if",!0)])):e.createCommentVNode("v-if",!0),e.createElementVNode("div",or,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(s.value,g=>(e.openBlock(),e.createElementBlock(e.Fragment,{key:g.key},[o.value===g.key?(e.openBlock(),e.createElementBlock("div",lr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(g.groups,k=>(e.openBlock(),e.createElementBlock("div",{key:k.title||"__main",class:"setting-group"},[k.title?(e.openBlock(),e.createElementBlock("div",ar,e.toDisplayString(k.title),1)):e.createCommentVNode("v-if",!0),(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(k.fields,p=>(e.openBlock(),e.createElementBlock("div",{key:p.name,class:e.normalizeClass(["setting-row",{"row-toggle":p.type==="checkbox"}])},[e.createCommentVNode(" checkbox：label 与开关同行 "),p.type==="checkbox"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:0},[e.createElementVNode("label",{class:"field-label",title:p.hint},e.toDisplayString(p.label),9,sr),e.createElementVNode("label",{class:"pp-switch",title:p.hint},[e.withDirectives(e.createElementVNode("input",{type:"checkbox","onUpdate:modelValue":x=>y[g.key][p.name]=x},null,8,cr),[[e.vModelCheckbox,y[g.key][p.name]]]),d[6]||(d[6]=e.createElementVNode("span",{class:"pp-switch-track"},null,-1))],8,ir)],64)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" 其他类型：label 在上、控件在下、说明文字在控件下方（不挤占输入区） "),e.createElementVNode("label",{class:"field-label",title:p.hint},e.toDisplayString(p.label),9,dr),e.createElementVNode("div",pr,[e.createCommentVNode(" text / password "),p.type==="text"||p.type==="password"?e.withDirectives((e.openBlock(),e.createElementBlock("input",{key:0,class:"field-input",type:p.type==="password"?"password":"text","onUpdate:modelValue":x=>y[g.key][p.name]=x,placeholder:p.placeholder},null,8,mr)),[[e.vModelDynamic,y[g.key][p.name]]]):p.type==="number"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:1},[e.createCommentVNode(" number "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"number","onUpdate:modelValue":x=>y[g.key][p.name]=x,min:p.min,max:p.max,step:p.step},null,8,gr),[[e.vModelText,y[g.key][p.name],void 0,{number:!0}]])],2112)):p.type==="select"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:2},[e.createCommentVNode(" select（optionsSource 驱动动态数据源：models=按服务商模型列表 / providers=服务商列表） "),e.withDirectives(e.createElementVNode("select",{"onUpdate:modelValue":x=>y[g.key][p.name]=x,class:"field-select",onChange:x=>T(p)},[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(V(g.key,p),x=>(e.openBlock(),e.createElementBlock("option",{key:x,value:x},e.toDisplayString(x),9,hr))),128))],40,kr),[[e.vModelSelect,y[g.key][p.name]]])],2112)):p.type==="theme-gallery"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:3},[e.createCommentVNode(` theme-gallery（主题画廊：缩略色卡选择）
                           ★ 值仍是 string 主题 id，binding 直连 AppSettings.theme —— 与 select 同数据模型，
                             仅换一种更直观的呈现（色卡 + 明暗标识）。无联动字段故不调 onSelectChange。 `),e.createElementVNode("div",fr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(P(p),x=>(e.openBlock(),e.createElementBlock("button",{key:x.value,type:"button",class:e.normalizeClass(["tg-item",{active:y[g.key][p.name]===x.value}]),title:x.label,onClick:$=>y[g.key][p.name]=x.value},[e.createCommentVNode(" 设计稿 th584：预览区 48 高（主题代表色横向平铺） "),e.createElementVNode("span",yr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(x.colors,($,Z)=>(e.openBlock(),e.createElementBlock("i",{key:Z,style:e.normalizeStyle({background:$})},null,4))),128))]),e.createElementVNode("span",br,[e.createElementVNode("span",Er,e.toDisplayString(x.label),1),e.createCommentVNode(` ★ 2026-09-25：定位文案（设计稿每张卡 = 预览 + 名称 + 一句定位，
                           ...
                           ★ 值仍是 string，与 select / theme-gallery 同数据模型，仅换呈现形态。 `),e.createElementVNode("div",Vr,[(e.openBlock(!0),e.createElementBlock(e.Fragment,null,e.renderList(P(p),x=>(e.openBlock(),e.createElementBlock("button",{key:x.value,type:"button",class:e.normalizeClass(["cd-item",{active:String(y[g.key][p.name]||"")===x.value}]),title:x.label,onClick:$=>y[g.key][p.name]=x.value},[e.createElementVNode("i",{class:"cd-dot",style:e.normalizeStyle({background:x.colors&&x.colors[0]||"transparent"})},null,4)],10,Nr))),128))])],2112)):p.type==="textarea"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:5},[e.createCommentVNode(" textarea "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":x=>y[g.key][p.name]=x,class:"field-textarea",rows:"4",placeholder:p.placeholder},null,8,wr),[[e.vModelText,y[g.key][p.name]]])],2112)):p.type==="slider"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:6},[e.createCommentVNode(" slider "),e.createElementVNode("div",Sr,[e.withDirectives(e.createElementVNode("input",{type:"range","onUpdate:modelValue":x=>y[g.key][p.name]=x,min:p.min!=null?p.min:0,max:p.max!=null?p.max:100,step:p.step||1},null,8,Tr),[[e.vModelText,y[g.key][p.name],void 0,{number:!0}]]),e.createElementVNode("span",Br,e.toDisplayString(y[g.key][p.name]),1)])],2112)):p.type==="color"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:7},[e.createCommentVNode(" color "),e.createElementVNode("div",Cr,[e.withDirectives(e.createElementVNode("input",{type:"color","onUpdate:modelValue":x=>y[g.key][p.name]=x},null,8,Pr),[[e.vModelText,y[g.key][p.name]]]),e.createElementVNode("code",Ir,e.toDisplayString(y[g.key][p.name]),1)])],2112)):p.type==="tags"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:8},[e.createCommentVNode(" tags（逗号分隔数组） "),e.createElementVNode("input",{type:"text",class:"field-input",value:U(g.key,p),onInput:x=>H(g.key,p,x),placeholder:p.placeholder||"逗号分隔"},null,40,Ar)],2112)):p.type==="project"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:9},[e.createCommentVNode(" project（平台特殊：项目级指令，经 /api/instructions 读写） "),e.withDirectives(e.createElementVNode("textarea",{"onUpdate:modelValue":d[2]||(d[2]=x=>S.value=x),class:"field-textarea",rows:"4",placeholder:p.placeholder},null,8,Mr),[[e.vModelText,S.value]])],2112)):p.type==="provider-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:10},[e.createCommentVNode(" provider-manager（服务商维护面板：CRUD /api/models，独立保存，不参与普通表单） "),e.createVNode(ut,{"model-param-fields":p.modelParamFields||[],"model-editor":p.modelEditor||{},"protocol-label":p.protocolLabel||"LLM 协议","protocol-options":p.protocolOptions||[],"protocol-hint":p.protocolHint||"",onSaved:N},null,8,["model-param-fields","model-editor","protocol-label","protocol-options","protocol-hint"])],2112)):p.type==="preset-manager"?(e.openBlock(),e.createElementBlock(e.Fragment,{key:11},[e.createCommentVNode(" preset-manager（AI 配置预设面板：CRUD /api/ai-presets，独立保存，不参与普通表单） "),(e.openBlock(),e.createBlock(qt,{key:B.value,"preset-fields":p.presetFields||[],onSaved:f},null,8,["preset-fields"]))],2112)):(e.openBlock(),e.createElementBlock(e.Fragment,{key:12},[e.createCommentVNode(" 兜底 text "),e.withDirectives(e.createElementVNode("input",{class:"field-input",type:"text","onUpdate:modelValue":x=>y[g.key][p.name]=x},null,8,$r),[[e.vModelText,y[g.key][p.name]]])],2112))]),p.hint?(e.openBlock(),e.createElementBlock("span",Dr,e.toDisplayString(p.hint),1)):e.createCommentVNode("v-if",!0)],64))],2))),128))]))),128))])):e.createCommentVNode("v-if",!0)],64))),128)),s.value.length?e.createCommentVNode("v-if",!0):(e.openBlock(),e.createElementBlock("div",Lr,"暂无配置项（等待插件注册…）"))])]),e.createCommentVNode(` ★ 2026-09-24 对齐设计稿 th790（底 48：说明 + 信息）：左侧补说明文本，
           与「撤销 / 保存设置」按钮同行（设计稿未画按钮，但 schema 驱动需显式保存）。 `),e.createElementVNode("div",{class:"modal-footer"},[d[7]||(d[7]=e.createElementVNode("span",{class:"mf-note"},"配置项由插件注册，修改后点「保存设置」生效",-1)),e.createElementVNode("button",{class:"btn-secondary",onClick:I},"撤销"),e.createElementVNode("button",{class:"btn-primary",onClick:E},"保存设置")])])]))}},[["__scopeId","data-v-062893bb"]]),Gr={class:"modal-content sys-modal"},Fr={class:"modal-header"},Or={class:"modal-body"},Ur={key:0,class:"loading"},zr={key:1,class:"sys-info"},jr={class:"info-row"},Hr={class:"info-row"},_r={class:"info-row"},Wr={class:"info-row"},qr={class:"info-row"},Jr={class:"info-row"},Kr={class:"modal-footer"},Zr=z({__name:"SystemModal",emits:["close"],setup(r,{emit:t}){const n=e.ref(!0),o=e.ref({});return e.onMounted(async()=>{try{o.value=await A.apiGet("/system/info")}catch{}n.value=!1}),(l,s)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:s[2]||(s[2]=e.withModifiers(a=>l.$emit("close"),["self"]))},[e.createElementVNode("div",Gr,[e.createElementVNode("div",Fr,[s[3]||(s[3]=e.createElementVNode("h2",null,"ℹ 系统信息",-1)),e.createElementVNode("button",{class:"modal-close",onClick:s[0]||(s[0]=a=>l.$emit("close"))},"×")]),e.createElementVNode("div",Or,[n.value?(e.openBlock(),e.createElementBlock("div",Ur,"加载中...")):(e.openBlock(),e.createElementBlock("div",zr,[e.createElementVNode("div",jr,[s[4]||(s[4]=e.createElementVNode("label",null,"主机名",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.hostname),1)]),e.createElementVNode("div",Hr,[s[5]||(s[5]=e.createElementVNode("label",null,"当前目录",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.cwd),1)]),e.createElementVNode("div",_r,[s[6]||(s[6]=e.createElementVNode("label",null,"操作系统",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.os),1)]),e.createElementVNode("div",Wr,[s[7]||(s[7]=e.createElementVNode("label",null,"Go 版本",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.goos),1)]),e.createElementVNode("div",qr,[s[8]||(s[8]=e.createElementVNode("label",null,"工作区",-1)),e.createElementVNode("span",null,e.toDisplayString(o.value.workspace),1)]),e.createElementVNode("div",Jr,[s[9]||(s[9]=e.createElementVNode("label",null,"文件夹",-1)),e.createElementVNode("span",null,e.toDisplayString((o.value.folders||[]).join(", ")),1)])]))]),e.createElementVNode("div",Kr,[e.createElementVNode("button",{class:"btn-secondary",onClick:s[1]||(s[1]=a=>l.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-bb4d0117"]]),Qr={class:"modal-content source-modal"},Xr={class:"modal-header"},Yr={class:"modal-footer"},vr=z({__name:"SourceModal",emits:["close"],setup(r){return(t,n)=>(e.openBlock(),e.createElementBlock("div",{class:"modal-overlay",onClick:n[2]||(n[2]=e.withModifiers(o=>t.$emit("close"),["self"]))},[e.createElementVNode("div",Qr,[e.createElementVNode("div",Xr,[n[3]||(n[3]=e.createElementVNode("h2",null,"⎔ 源代码管理",-1)),e.createElementVNode("button",{class:"modal-close",onClick:n[0]||(n[0]=o=>t.$emit("close"))},"×")]),n[4]||(n[4]=e.createElementVNode("div",{class:"modal-body"},[e.createElementVNode("p",{style:{color:"var(--text-muted)","text-align":"center","margin-top":"40px"}},[e.createTextVNode(" Git 集成开发中"),e.createElementVNode("br"),e.createElementVNode("br"),e.createTextVNode(" 功能规划："),e.createElementVNode("br"),e.createTextVNode(" · Git 状态查看"),e.createElementVNode("br"),e.createTextVNode(" · 暂存/提交/推送"),e.createElementVNode("br"),e.createTextVNode(" · 分支管理"),e.createElementVNode("br"),e.createTextVNode(" · Diff 对比 ")])],-1)),e.createElementVNode("div",Yr,[e.createElementVNode("button",{class:"btn-secondary",onClick:n[1]||(n[1]=o=>t.$emit("close"))},"关闭")])])]))}},[["__scopeId","data-v-bc520229"]]),eo=`# 功能介绍
...
`+n.join(`
`),S=this.blockquote(y);s[s.length-1]=S,o=o.substring(0,o.length-T.raw.length)+S.raw,l=l.substring(0,l.length-T.text.length)+S.text;break}else if((V==null?void 0:V.type)==="list"){let T=V,y=T.raw+`
`+n.join(`
`),S=this.list(y);s[s.length-1]=S,o=o.substring(0,o.length-V.raw.length)+S.raw,l=l.substring(0,l.length-T.raw.length)+S.raw,n=y.substring(s.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:o,tokens:s,text:l}}}list(r){let t=this.rules.block.list.exec(r);if(t){let n=t[1].trim(),o=n.length>1,l={type:"list",raw:"",ordered:o,start:o?+n.slice(0,-1):"",loose:!1,items:[]};n=o?`\\d{1,9}\\${n.slice(-1)}`:`\\${n}`,this.options.pedantic&&(n=o?n:"[*+-]");let s=this.rules.other.listItemRegex(n),a=!1;for(;r;){let c=!1,u="",h="";if(!(t=s.exec(r))||this.rules.block.hr.test(r))break;u=t[0],r=r.substring(u.length);let w=qo(t[2].split(`
