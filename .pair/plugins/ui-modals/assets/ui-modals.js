  ...
  const _sfc_main$8 = {
    ...
    setup(__props, { emit: __emit }) {
      ...
      function startEdit(p) {
        ...
        for (const m2 of editModels.value) if (!params[m2]) params[m2] = { temperature: "", thinkingMode: "", maxTokens: 0, contextMaxTokens: 0 };
        editParams.value = params;
        error.value = "";
      }
      function onModelsChange(list) {
        const params = { ...editParams.value };
        for (const m2 of list) if (!params[m2]) params[m2] = { temperature: "", thinkingMode: "", maxTokens: 0, contextMaxTokens: 0 };
        for (const m2 of Object.keys(params)) if (!list.includes(m2)) delete params[m2];
        editParams.value = params;
      ...
      async function saveModelParams(providerName) {
        ...
        const clean = {};
        for (const [m2, cfg] of Object.entries(editParams.value)) {
          const c = cfg || {};
          const out = {};
          if (c.temperature !== "" && c.temperature !== void 0 && c.temperature !== null) out.temperature = c.temperature;
          ...
          if (Object.keys(out).length) clean[m2] = out;
        }
...
（AI tab 将不再可选该服务商）`)) return;
            ...
            vue.createElementVNode("div", _hoisted_9$6, [
              ...
              editModels.value.length ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10$6, [
                (vue.openBlock(true), vue.createElementBlock(
                  vue.Fragment,
                  null,
                  vue.renderList(editModels.value, (m2) => {
                    return vue.openBlock(), vue.createElementBlock("div", {
                      ...
                      vue.withDirectives(vue.createElementVNode("select", {
                        "onUpdate:modelValue": ($event) => editParams.value[m2].thinkingMode = $event,
                        title: "思考档位（OpenAI 定义）"
                      }, [
                        (vue.openBlock(), vue.createElementBlock(
                          vue.Fragment,
                          null,
                          vue.renderList(THINK_TIERS, (th) => {
                            return vue.createElementVNode("option", {
                              key: "k" + th.v,
                              value: th.v
                      ...
                      vue.withDirectives(vue.createElementVNode("input", {
                        "onUpdate:modelValue": ($event) => editParams.value[m2].maxTokens = $event,
                        type: "number",
                        min: "0",
                        step: "1024",
                      ...
                      vue.withDirectives(vue.createElementVNode("input", {
                        "onUpdate:modelValue": ($event) => editParams.value[m2].contextMaxTokens = $event,
                        type: "number",
                        min: "0",
                        step: "4096",
                        placeholder: "上下文",
                    ...
                    editingName.value === p.name ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_22$3, [
                      ...
                      vue.createElementVNode("div", _hoisted_28$2, [
                        ...
                        vue.withDirectives(vue.createElementVNode(
                          "input",
                          {
                            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => editForm.value.contextMaxTokens = $event),
                            type: "number",
                            min: "0",
                            step: "1000",
                            placeholder: "0=不限制（模型级未配置时的默认窗口）"
  ...
  const SettingsModal = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-06c99ce4"]]);
