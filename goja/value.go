...
import (
	...
	"github.com/hoonfeng/paircode/goja/ftoa"
...
// NewString creates a string Value without requiring a Runtime.
func NewString(s string) Value {
	return newStringValue(s)
}

// NewFloat creates a float64 Value without requiring a Runtime.
func NewFloat(f float64) Value {
	return floatToValue(f)
}

// NewBoolean creates a boolean Value without requiring a Runtime.
