...
import (
	...
	"github.com/hoonfeng/paircode/goja/token"
...
func (c *compiler) compileLabeledForInOfStatement(into ast.ForInto, source ast.Expression, body ast.Statement, iter, needResult bool, label unistring.String, asyncIter bool) {
	c.block = &block{
		typ:        blockLoopEnum,
		outer:      c.block,
		label:      label,
...
func (c *compiler) compileLabeledForInStatement(v *ast.ForInStatement, needResult bool, label unistring.String) {
	c.compileLabeledForInOfStatement(v.Into, v.Source, v.Body, false, needResult, label, false)
}
...
func (c *compiler) compileLabeledForOfStatement(v *ast.ForOfStatement, needResult bool, label unistring.String) {
	c.compileLabeledForInOfStatement(v.Into, v.Source, v.Body, true, needResult, label, v.Await)
}
