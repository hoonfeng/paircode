...
// ★ 2026-09：TestMessageStore_ListConversationsExcludesSubAgent 已随子 Agent 实现
//   删除——不再有成员子会话（conv_sub_*）与 IsSubAgentConvID 过滤，会话列表
//   不再做前缀屏蔽。列表语义由上方 TestMessageStore_ListConversations 覆盖。
