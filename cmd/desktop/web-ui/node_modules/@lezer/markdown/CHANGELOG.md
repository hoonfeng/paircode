...
Allow starting indented tables directly below paragraphs.

### New features

`Line.markers` is now public, since it may be necessary to access it in block parsers that cover multiple lines.
