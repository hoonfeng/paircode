// ═══════════════════════════════════════════════════════════════
// tool-codegraph-extra — 独立插件二进制（codegraph-extra 工具组）
//
...
//	exit 0（协议错误 exit 2）
//
// ★ 2026-08-16 第四轮：实现随插件外置——cmd/plugins/tool-codegraph-extra/impl/ 自持
//
...
import (
	"github.com/hoonfeng/paircode/cmd/plugins/tool-codegraph-extra/impl"
	"github.com/hoonfeng/paircode/cmd/plugins/tool-codegraph-extra/toolbin"
)
