// ═══════════════════════════════════════════════════════════════
// tool-project-info — 独立插件二进制（project-info 工具组）
//
...
//	exit 0（协议错误 exit 2）
//
// ★ 2026-08-16 第四轮：实现随插件外置——cmd/plugins/tool-project-info/impl/ 自持
//
...
import (
	"github.com/hoonfeng/paircode/cmd/plugins/tool-project-info/impl"
	"github.com/hoonfeng/paircode/cmd/plugins/tool-project-info/toolbin"
)
