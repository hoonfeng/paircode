...
import (
	...
	"github.com/hoonfeng/paircode/plugins-src/plugins/tool-verify/memory"
	. "github.com/hoonfeng/paircode/plugins-src/plugins/tool-verify/toolbin"
	"github.com/hoonfeng/paircode/plugins-src/plugins/tool-verify/verify"
)
