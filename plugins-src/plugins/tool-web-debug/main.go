// ═══════════════════════════════════════════════════════════════
// tool-web-debug — 独立插件二进制（web-debug 工具组）
//
...
//	exit 0（协议错误 exit 2）
//
// ★ 2026-08-16 第四轮：实现随插件外置——plugins-src/plugins/tool-web-debug/impl/ 自持
//
...
import (
	"github.com/hoonfeng/paircode/plugins-src/plugins/tool-web-debug/impl"
	"github.com/hoonfeng/paircode/plugins-src/plugins/tool-web-debug/toolbin"
)
