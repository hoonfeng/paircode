(function() {
  ...
  __vite_style__.textContent = "\n.shell-root[data-v-4a3de2c5] {\n  width: 100%;\n  height: 100%;\n  background: var(--bg-primary, #0d1117);\n  color: var(--text-primary, #e6edf3);\n}\n.shell-host[data-v-4a3de2c5],\n.plugin-slot-host[data-v-4a3de2c5] {\n  width: 100%;\n  height: 100%;\n}\n.shell-empty[data-v-4a3de2c5] {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.shell-empty-card[data-v-4a3de2c5] {\n  max-width: 440px;\n  text-align: center;\n  padding: 32px;\n  border: 1px solid var(--border-color, #30363d);\n  border-radius: 8px;\n  background: var(--bg-secondary, #161b22);\n}\n.shell-brand[data-v-4a3de2c5] {\n  font-size: 22px;\n  font-weight: 700;\n  letter-spacing: 0.5px;\n  color: var(--accent, #58a6ff);\n}\n.shell-title[data-v-4a3de2c5] {\n  font-size: 13px;\n  color: var(--text-secondary, #8b949e);\n  margin: 6px 0 16px;\n}\n.shell-msg[data-v-4a3de2c5] {\n  font-size: 13px;\n  margin-bottom: 10px;\n}\n.shell-hint[data-v-4a3de2c5] {\n  font-size: 12px;\n  color: var(--text-muted, #6e7681);\n  line-height: 1.6;\n}\n.shell-hint code[data-v-4a3de2c5] {\n  font-family: var(--font-code, monospace);\n  font-size: 11px;\n  background: var(--bg-tertiary, #21262d);\n  padding: 1px 4px;\n  border-radius: 3px;\n}\n/*$vite$:1*/";
...
`], ...formatTraceEntry(entry));
  ...
  **/
  ...
  const _hoisted_1 = { class: "shell-root" };
  const _hoisted_2 = {
    key: 0,
    class: "shell-empty"
  };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", _hoisted_1, [
          !unref(slot).owner.value ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[0] || (_cache[0] = [
            createStaticVNode('<div class="shell-empty-card" data-v-4a3de2c5><div class="shell-brand" data-v-4a3de2c5>PairCode</div><div class="shell-title" data-v-4a3de2c5>本地 AI 结对编程 IDE</div><div class="shell-msg" data-v-4a3de2c5>正在装载 UI 插件（ui-app）…</div><div class="shell-hint" data-v-4a3de2c5> 未检测到 UI 插件占用 app-root 槽位。请确认 <code data-v-4a3de2c5>.pair/plugins/ui-app</code> 已安装，且其 client 半已在插件面板批准。 </div></div>', 1)
          ])])) : (openBlock(), createElementBlock("div", {
            key: 1,
            ref: unref(slot).hostRef,
            class: "plugin-slot-host plugin-slot-app-root shell-host"
          }, null, 512))
        ]);
      };
    }
  };
  const ShellApp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4a3de2c5"]]);
